...
public abstract class GetRouterRegistrationsResponse {
    ...
    public static GetRouterRegistrationsResponse newInstance() throws IOException {
    ...
    @Public
    @Unstable
    public abstract void setRouters(List<RouterState> routers) throws IOException;
