...
public class GetSafeModeRequestPBImpl extends GetSafeModeRequest implements PBRecord {
    ...
    private FederationProtocolPBTranslator<GetSafeModeRequestProto, Builder, GetSafeModeRequestProtoOrBuilder> translator = new FederationProtocolPBTranslator<>(GetSafeModeRequestProto.class);
