...
public class GetNamenodeRegistrationsResponsePBImpl extends GetNamenodeRegistrationsResponse implements PBRecord {
    ...
    public GetNamenodeRegistrationsResponsePBImpl(GetNamenodeRegistrationsResponseProto proto) {
    ...
    @Override
    public void setNamenodeMemberships(List<MembershipState> records) throws IOException {
