...
public class GetSafeModeResponsePBImpl extends GetSafeModeResponse implements PBRecord {
    ...
    private FederationProtocolPBTranslator<GetSafeModeResponseProto, Builder, GetSafeModeResponseProtoOrBuilder> translator = new FederationProtocolPBTranslator<>(GetSafeModeResponseProto.class);
