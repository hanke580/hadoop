...
public class StateStoreService extends CompositeService {
     ...
     */
    private <T extends RecordStore<?>> void addRecordStore(final Class<T> clazz) throws ReflectiveOperationException {
     ...
     */
    public <T extends RecordStore<?>> T getRegisteredRecordStore(final Class<T> recordStoreClass) {
