...
public abstract class MountTable extends BaseRecord {
     ...
     */
    public static MountTable newInstance(final String src, final Map<String, String> destinations, long dateCreated, long dateModified) throws IOException {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder(17, 31).append(this.getSourcePath()).append(this.getDestinations()).append(this.isReadOnly()).append(this.getDestOrder()).append(this.isFaultTolerant()).toHashCode();
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof MountTable) {
            ...
            return new EqualsBuilder().append(this.getSourcePath(), other.getSourcePath()).append(this.getDestinations(), other.getDestinations()).append(this.isReadOnly(), other.isReadOnly()).append(this.getDestOrder(), other.getDestOrder()).append(this.isFaultTolerant(), other.isFaultTolerant()).isEquals();
        }
        return false;
    }
