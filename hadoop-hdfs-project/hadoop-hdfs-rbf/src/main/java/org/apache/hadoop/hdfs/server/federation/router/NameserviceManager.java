...
public interface NameserviceManager {
     ...
     */
    DisableNameserviceResponse disableNameservice(DisableNameserviceRequest request) throws IOException;
     ...
     * @throws IOException If it cannot perform the operation.
     */
    EnableNameserviceResponse enableNameservice(EnableNameserviceRequest request) throws IOException;
     ...
     * @throws IOException If it cannot perform the operation.
     */
    GetDisabledNameservicesResponse getDisabledNameservices(GetDisabledNameservicesRequest request) throws IOException;
}
