 ...
 */
public class DisableNameserviceResponsePBImpl extends DisableNameserviceResponse implements PBRecord {

    private FederationProtocolPBTranslator<DisableNameserviceResponseProto, Builder, DisableNameserviceResponseProtoOrBuilder> translator = new FederationProtocolPBTranslator<>(DisableNameserviceResponseProto.class);

    public DisableNameserviceResponsePBImpl() {
    }

    public DisableNameserviceResponsePBImpl(DisableNameserviceResponseProto proto) {
