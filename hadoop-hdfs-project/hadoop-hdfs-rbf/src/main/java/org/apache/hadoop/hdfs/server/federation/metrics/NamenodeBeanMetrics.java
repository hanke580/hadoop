...
public class NamenodeBeanMetrics implements FSNamesystemMBean, NameNodeMXBean, NameNodeStatusMXBean {
    ...
    public NamenodeBeanMetrics(Router router) {
        ...
        this.dnReportTimeOut = conf.getTimeDuration(RBFConfigKeys.DN_REPORT_TIME_OUT, RBFConfigKeys.DN_REPORT_TIME_OUT_MS_DEFAULT, TimeUnit.MILLISECONDS);
        long dnCacheExpire = conf.getTimeDuration(RBFConfigKeys.DN_REPORT_CACHE_EXPIRE, RBFConfigKeys.DN_REPORT_CACHE_EXPIRE_MS_DEFAULT, TimeUnit.MILLISECONDS);
        this.dnCache = CacheBuilder.newBuilder().expireAfterWrite(dnCacheExpire, TimeUnit.MILLISECONDS).build(new CacheLoader<DatanodeReportType, String>() {
    ...
    public long getPendingReplicationBlocks() {
        try {
            ...
            LOG.debug("Failed to get number of blocks pending replica", e.getMessage());
        }
        return 0;
    }
    ...
    public long getPendingDeletionBlocks() {
        try {
            ...
            LOG.debug("Failed to get number of blocks pending deletion", e.getMessage());
        }
        return 0;
    }
    ...
    private String getNodesImpl(final DatanodeReportType type) {
        ...
        try {
            ...
            DatanodeInfo[] datanodes = rpcServer.getDatanodeReport(type, false, dnReportTimeOut);
    ...
    public int getNumDecomLiveDataNodes() {
        try {
            ...
            LOG.debug("Failed to get the number of live decommissioned datanodes", e.getMessage());
        }
        return 0;
    }
    ...
    public int getNumDecomDeadDataNodes() {
        try {
            ...
            LOG.debug("Failed to get the number of dead decommissioned datanodes", e.getMessage());
        }
        return 0;
    }
    ...
    public int getNumDecommissioningDataNodes() {
        try {
            ...
            LOG.debug("Failed to get number of decommissioning nodes", e.getMessage());
        }
        return 0;
    }
    ...
    public int getNumInMaintenanceDeadDataNodes() {
        try {
            ...
            LOG.debug("Failed to get number of dead in maintenance nodes", e.getMessage());
        }
        return 0;
    }
    ...
    public int getNumEnteringMaintenanceDataNodes() {
        try {
            ...
            LOG.debug("Failed to get number of entering maintenance nodes", e.getMessage());
        }
        return 0;
    }
    ...
    public boolean isSecurityEnabled() {
        try {
            ...
            LOG.debug("Failed to get security status.", e.getMessage());
        }
        return false;
    }
