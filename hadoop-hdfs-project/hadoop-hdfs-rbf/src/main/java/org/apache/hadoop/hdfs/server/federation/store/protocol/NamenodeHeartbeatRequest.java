...
public abstract class NamenodeHeartbeatRequest {
    ...
    public static NamenodeHeartbeatRequest newInstance(MembershipState namenode) throws IOException {
    ...
    @Private
    @Unstable
    public abstract MembershipState getNamenodeMembership() throws IOException;

    @Private
    @Unstable
    public abstract void setNamenodeMembership(MembershipState report) throws IOException;
}
