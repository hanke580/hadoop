...
public class MockNamenode {
    ...
    public MockNamenode(final String nsIdentifier, final Configuration conf) throws IOException {
     ...
     */
    private static HdfsFileStatus getMockHdfsFileStatus(final String filename, final String type) {
        if (type == null) {
            return null;
        }
