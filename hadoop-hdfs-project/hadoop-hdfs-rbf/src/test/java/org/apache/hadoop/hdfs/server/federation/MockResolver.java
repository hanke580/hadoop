...
public class MockResolver implements ActiveNamenodeResolver, FileSubclusterResolver {
    ...
    private Map<String, List<? extends FederationNamenodeContext>> resolver = new HashMap<>();
   ...
   */
    ...
    @Override
    public synchronized List<? extends FederationNamenodeContext> getNamenodesForNameserviceId(String nameserviceId) {
