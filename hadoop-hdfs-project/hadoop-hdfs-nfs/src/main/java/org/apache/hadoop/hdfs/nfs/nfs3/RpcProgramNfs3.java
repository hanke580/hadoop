...
public class RpcProgramNfs3 extends RpcProgram implements Nfs3Interface {
    ...
    public static final FsPermission umask = new FsPermission((short) DEFAULT_UMASK);
    ...
    public RpcProgramNfs3(NfsConfiguration config, DatagramSocket registrationSocket, boolean allowInsecurePorts) throws IOException {
        ...
        superuser = config.get(NfsConfigKeys.NFS_SUPERUSER_KEY, NfsConfigKeys.NFS_SUPERUSER_DEFAULT);
    ...
    public static RpcProgramNfs3 createRpcProgramNfs3(NfsConfiguration config, DatagramSocket registrationSocket, boolean allowInsecurePorts) throws IOException {
