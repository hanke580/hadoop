...
public class WriteManager {
    ...
    WriteManager(IdMappingServiceProvider iug, final NfsConfiguration config, boolean aixCompatMode) {
        this.iug = iug;
        this.config = config;
    ...
    void handleCommit(DFSClient dfsClient, FileHandle fileHandle, long commitOffset, Channel channel, int xid, Nfs3FileAttributes preOpAttr, int namenodeId) {
    ...
    Nfs3FileAttributes getFileAttr(DFSClient client, FileHandle dirHandle, String fileName, int namenodeId) throws IOException {
