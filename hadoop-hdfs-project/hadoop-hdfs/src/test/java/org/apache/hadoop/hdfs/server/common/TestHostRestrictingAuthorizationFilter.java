...
public class TestHostRestrictingAuthorizationFilter {
   ...
   */
    ...
    public void testAcceptAll() throws Exception {
        ...
        Mockito.when(request.getRequestURI()).thenReturn(new StringBuffer(WebHdfsFileSystem.PATH_PREFIX + "/user" + "/ubuntu/foo").toString());
   ...
   */
    ...
    public void testAcceptGETFILECHECKSUM() throws Exception {
        ...
        Mockito.when(request.getRemoteAddr()).thenReturn(null);
        Mockito.when(request.getMethod()).thenReturn("GET");
        Mockito.when(request.getRequestURI()).thenReturn(new StringBuffer(WebHdfsFileSystem.PATH_PREFIX + "/user" + "/ubuntu/").toString());
   ...
   */
    ...
    public void testRuleAllowedGet() throws Exception {
        ...
        Mockito.when(request.getRequestURI()).thenReturn(new StringBuffer(WebHdfsFileSystem.PATH_PREFIX + "/user" + "/ubuntu/foo?" + queryString).toString());
   ...
   */
    ...
    public void testRejectsGETs() throws Exception {
        ...
        Mockito.when(request.getRequestURI()).thenReturn(new StringBuffer(WebHdfsFileSystem.PATH_PREFIX + "/user" + "/ubuntu/?" + queryString).toString());
        Mockito.when(request.getQueryString()).thenReturn(queryString);
        Mockito.when(request.getRemoteAddr()).thenReturn("192.168.1.2");
        HttpServletResponse response = Mockito.mock(HttpServletResponse.class);
        FilterChain chain = new FilterChain() {
   ...
   */
    ...
    public void testUnexpectedInputMissingOpParameter() throws Exception {
        ...
        Mockito.when(request.getRemoteAddr()).thenReturn(null);
        Mockito.when(request.getMethod()).thenReturn("GET");
        Mockito.when(request.getRequestURI()).thenReturn(new StringBuffer(WebHdfsFileSystem.PATH_PREFIX + "/IAmARandomRequest/").toString());
