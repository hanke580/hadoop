...
public class TestInMemoryLevelDBAliasMapClient {
    ...
    public void setUp() throws IOException {
        ...
        levelDBAliasMapServer = new InMemoryLevelDBAliasMapServer(InMemoryAliasMap::init, BPID);
    ...
    public FileRegion generateRandomFileRegion(int seed) {
        ...
        ProvidedStorageLocation providedStorageLocation = new ProvidedStorageLocation(path, seed + 3, seed + 4, nonce);
