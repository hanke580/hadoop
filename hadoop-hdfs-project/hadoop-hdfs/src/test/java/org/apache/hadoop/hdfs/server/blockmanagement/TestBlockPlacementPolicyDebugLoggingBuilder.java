...
public class TestBlockPlacementPolicyDebugLoggingBuilder extends BaseReplicationPolicyTest {
    ...
    DatanodeDescriptor[] getDatanodeDescriptors(Configuration conf) {
        final String[] racks = { "/d1/r1/n1", "/d1/r1/n2", "/d1/r2/n3" };
    ...
    public void testChooseRandomDynamicallyChangeLogger() throws Exception {
        BlockPlacementPolicyDefault repl = spy((BlockPlacementPolicyDefault) replicator);
        GenericTestUtils.setLogLevel(BlockPlacementPolicy.LOG, org.slf4j.event.Level.INFO);
        ...
        doAnswer(new Answer() {
            ...
            public Object answer(InvocationOnMock invocationOnMock) throws Throwable {
                GenericTestUtils.setLogLevel(BlockPlacementPolicy.LOG, org.slf4j.event.Level.DEBUG);
                return dataNodes[0];
            }
