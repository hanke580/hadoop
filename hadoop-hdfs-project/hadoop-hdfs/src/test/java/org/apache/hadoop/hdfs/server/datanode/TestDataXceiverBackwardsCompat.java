...
public class TestDataXceiverBackwardsCompat {
    ...
    public class NullDataNode extends DataNode {
        ...
        public NullDataNode(Configuration conf, OutputStream out, int port) throws Exception {
            ...
            doReturn(pair).when(saslClient).socketSend(any(Socket.class), any(OutputStream.class), any(InputStream.class), any(DataEncryptionKeyFactory.class), any(), any(DatanodeID.class), any());
    ...
    public void testBackwardsCompat() throws Exception {
        ...
        doReturn(mockBlockReceiver).when(xceiver).getBlockReceiver(any(ExtendedBlock.class), any(StorageType.class), any(), anyString(), any(), any(BlockConstructionStage.class), anyLong(), anyLong(), anyLong(), anyString(), any(DatanodeInfo.class), any(DataNode.class), any(DataChecksum.class), any(CachingStrategy.class), ArgumentCaptor.forClass(Boolean.class).capture(), anyBoolean(), any());
