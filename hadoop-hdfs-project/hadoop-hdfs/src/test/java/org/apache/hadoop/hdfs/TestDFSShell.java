...
public class TestDFSShell {
    ...
    public void testMoveWithTargetPortEmpty() throws Exception {
        ...
        try {
            cluster = new MiniDFSCluster.Builder(conf).format(true).numDataNodes(2).nameNodePort(ServerSocketUtil.waitForPort(HdfsClientConfigKeys.DFS_NAMENODE_RPC_PORT_DEFAULT, 60)).waitSafeMode(true).build();
