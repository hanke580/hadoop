...
public class ExternalDatasetImpl implements FsDatasetSpi<ExternalVolumeImpl> {
    ...
    @Override
    public void removeVolumes(Collection<StorageLocation> volumes, boolean clearFailure) {
    ...
    @Override
    public ReplicaHandler createTemporary(StorageType t, String i, ExtendedBlock b, boolean isTransfer) throws IOException {
        return new ReplicaHandler(new ExternalReplicaInPipeline(), null);
    }

    @Override
    public ReplicaHandler createRbw(StorageType storageType, String id, ExtendedBlock b, boolean tf) throws IOException {
        return new ReplicaHandler(new ExternalReplicaInPipeline(), null);
    }
    ...
    @Override
    public Replica recoverClose(ExtendedBlock b, long newGS, long expectedBlkLen) throws IOException {
        return null;
    }
    ...
    public Map<DatanodeStorage, BlockListAsLongs> getBlockReports(String bpid) {
        final Map<DatanodeStorage, BlockListAsLongs> result = new HashMap<DatanodeStorage, BlockListAsLongs>();
