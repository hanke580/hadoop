...
public class MiniQJMHACluster {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(MiniQJMHACluster.class);
    ...
    private MiniQJMHACluster(Builder builder) throws IOException {
        ...
        while (true) {
            try {
                ...
                journalCluster = new MiniJournalCluster.Builder(conf).baseDir(builder.baseDir).format(true).build();
    ...
    private Configuration initHAConf(URI journalURI, Builder builder, int basePort) {
        ...
        HATestUtil.setFailoverConfigurations(conf, NAMESERVICE, nns, ConfiguredFailoverProxyProvider.class);
        return conf;
    }
