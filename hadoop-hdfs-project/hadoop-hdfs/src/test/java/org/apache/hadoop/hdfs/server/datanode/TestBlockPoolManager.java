...
public class TestBlockPoolManager {
    ...
    public void setupBPM() {
        bpm = new BlockPoolManager(mockDN) {
            ...
            @Override
            protected BPOfferService createBPOS(final String nameserviceId, List<String> nnIds, List<InetSocketAddress> nnAddrs, List<InetSocketAddress> lifelineNnAddrs) {
                ...
                try {
                    ...
                    }).when(bpos).refreshNNList(Mockito.anyString(), Mockito.<List<String>>any(), Mockito.<ArrayList<InetSocketAddress>>any(), Mockito.<ArrayList<InetSocketAddress>>any());
                } catch (IOException e) {
