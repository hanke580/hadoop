...
public class MiniDFSNNTopology {
    ...
    public static MiniDFSNNTopology simpleSingleNN(int nameNodePort, int nameNodeHttpPort) {
        return new MiniDFSNNTopology().addNameservice(new MiniDFSNNTopology.NSConf(null).addNN(new MiniDFSNNTopology.NNConf(null).setHttpPort(nameNodeHttpPort).setIpcPort(nameNodePort)));
    }
    ...
    public static MiniDFSNNTopology simpleHATopology(int nnCount, int basePort) {
        ...
        for (int i = 0; i < nnCount; i++) {
            ns.addNN(new MiniDFSNNTopology.NNConf("nn" + i).setIpcPort(basePort++).setHttpPort(basePort++));
        }
        MiniDFSNNTopology topology = new MiniDFSNNTopology().addNameservice(ns);
        return topology;
    }
    ...
    public static MiniDFSNNTopology simpleFederatedTopology(int numNameservices) {
        ...
        for (int i = 1; i <= numNameservices; i++) {
            topology.addNameservice(new MiniDFSNNTopology.NSConf("ns" + i).addNN(new MiniDFSNNTopology.NNConf(null)));
        }
    ...
    public static MiniDFSNNTopology simpleFederatedTopology(String nameservicesIds) {
        ...
        for (String nsId : nsIds) {
            topology.addNameservice(new MiniDFSNNTopology.NSConf(nsId).addNN(new MiniDFSNNTopology.NNConf(null)));
        }
        topology.setFederation(true);
        return topology;
    }
