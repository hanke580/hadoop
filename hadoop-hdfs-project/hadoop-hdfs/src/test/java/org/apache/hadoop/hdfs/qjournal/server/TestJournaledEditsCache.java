...
public class TestJournaledEditsCache {
    ...
    public void testCacheAboveCapacity() throws Exception {
        ...
        assertTxnCountAndContents(EDITS_CAPACITY + 1, EDITS_CAPACITY, thirdCapacity * 5);
    }
    ...
    public void testCacheSingleAdditionAboveCapacity() throws Exception {
        ...
        assertTxnCountAndContents(EDITS_CAPACITY * 2 + 1, 5, EDITS_CAPACITY * 2 + 5);
    }
    ...
    public void testCacheWithFutureLayoutVersion() throws Exception {
        ...
        assertArrayEquals(getHeaderForLayoutVersion(futureVersion), buffers.get(0).array());
