...
public class TestQuotaCounts {
    ...
    public void testBuildConstEnumCounters() throws Exception {
        QuotaCounts qc = new QuotaCounts.Builder().nameSpace(HdfsConstants.QUOTA_RESET).storageSpace(HdfsConstants.QUOTA_RESET).build();
    ...
    public void testAdd() throws Exception {
        ...
        QuotaCounts qc2 = new QuotaCounts.Builder().nameSpace(1).storageSpace(512).typeSpaces(5).build();
        qc1.add(qc2);
    ...
    public void testNegation() throws Exception {
        QuotaCounts qc = new QuotaCounts.Builder().nameSpace(HdfsConstants.QUOTA_RESET).storageSpace(HdfsConstants.QUOTA_RESET).typeSpaces(HdfsConstants.QUOTA_RESET).build();
        qc = qc.negation();
        assertEquals(1, qc.getNameSpace());
