...
public class TestDFSInputStreamBlockLocations {
    ...
    public void setup() throws IOException {
        ...
        dfsCluster = new MiniDFSCluster.Builder(conf).numDataNodes(NUM_DATA_NODES).racks(RACKS).build();
    ...
    public void testRead() throws Exception {
        ...
        try {
            ...
            DataNode deadNode = getdataNodeFromHostName(dfsCluster, deadNodeInfo.getHostName());
            // Shutdown and wait for datanode to be marked dead
            DatanodeRegistration reg = InternalDataNodeTestUtils.getDNRegistrationForBP(dfsCluster.getDataNodes().get(0), poolId);
