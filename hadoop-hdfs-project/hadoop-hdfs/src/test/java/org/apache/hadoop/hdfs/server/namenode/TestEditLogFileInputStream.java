...
public class TestEditLogFileInputStream {
    ...
    public void testByteStringLog() throws Exception {
        ...
        EditLogInputStream elis = EditLogFileInputStream.fromByteString(bytes, HdfsServerConstants.INVALID_TXID, HdfsServerConstants.INVALID_TXID, true);
    ...
    public void testScanEditThatFailedDuringPreAllocate() throws Exception {
        ...
        os.close();
        FSEditLogLoader.EditLogValidation val = EditLogFileInputStream.scanEditLog(editLog, 1234, false);
