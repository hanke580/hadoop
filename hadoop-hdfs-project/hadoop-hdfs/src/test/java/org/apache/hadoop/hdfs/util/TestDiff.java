...
public class TestDiff {
    ...
    static boolean hasIdenticalElements(final List<INode> expected, final List<INode> computed) {
        if (expected == null) {
    ...
    static void modify(INode inode, final List<INode> current, Diff<byte[], INode> diff) {
        ...
        final INodeDirectory newinode = new INodeDirectory(oldinode, false, oldinode.getFeatures());
