...
public class BlockManager implements BlockStatsMXBean {
    ...
    private void dumpBlockMeta(Block block, PrintWriter out) {
        ...
        chooseSourceDatanodes(blockInfo, containingNodes, containingLiveReplicasNodes, numReplicas, new ArrayList<Byte>(), new ArrayList<Byte>(), LowRedundancyBlocks.LEVEL);
    ...
    BlockReconstructionWork scheduleReconstruction(BlockInfo block, int priority) {
        ...
        final DatanodeDescriptor[] srcNodes = chooseSourceDatanodes(block, containingNodes, liveReplicaNodes, numReplicas, liveBlockIndices, liveBusyBlockIndices, priority);
        ...
        if (block.isStriped()) {
            ...
            return new ErasureCodingWork(getBlockPoolId(), block, bc, newSrcNodes, containingNodes, liveReplicaNodes, additionalReplRequired, priority, newIndices, busyIndices);
        } else {
