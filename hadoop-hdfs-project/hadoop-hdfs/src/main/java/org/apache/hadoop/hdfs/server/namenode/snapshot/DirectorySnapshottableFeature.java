...
public class DirectorySnapshottableFeature extends DirectoryWithSnapshotFeature {
     ...
     */
    public Snapshot addSnapshot(INodeDirectory snapshotRoot, SnapshotManager snapshotManager, String name, final LeaseManager leaseManager, long now) throws SnapshotException {
        ...
        final Snapshot s = ((Snapshot) org.zlab.ocov.tracker.Runtime.update(new Snapshot(id, name, snapshotRoot), 11));
    ...
    public Snapshot removeSnapshot(INode.ReclaimContext reclaimContext, INodeDirectory snapshotRoot, String snapshotName, long now, SnapshotManager snapshotManager) throws SnapshotException {
        ...
        if (i < 0) {
            ...
            if (!snapshotManager.isSnapshotDeletionOrdered() && !snapshotManager.isImageLoaded()) {
                return null;
            }
