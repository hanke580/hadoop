...
public class INodesInPath {
    ...
    public static INodesInPath replace(INodesInPath iip, int pos, INode inode) {
        ...
        inodes[pos] = inode;
        return ((INodesInPath) org.zlab.ocov.tracker.Runtime.update(new INodesInPath(inodes, iip.path, iip.isRaw, iip.isSnapshot, iip.snapshotId), 90));
    }
    ...
    public static INodesInPath append(INodesInPath iip, INode child, byte[] childName) {
        ...
        return ((INodesInPath) org.zlab.ocov.tracker.Runtime.update(new INodesInPath(inodes, path, iip.isRaw, iip.isSnapshot, iip.snapshotId), 91));
    }
