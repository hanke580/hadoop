...
public class NetworkTopologyServlet extends DfsServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        List<Node> leaves = bm.getDatanodeManager().getNetworkTopology().getLeaves(NodeBase.ROOT);
     ...
     */
    protected void printTopology(PrintStream stream, List<Node> leaves, String format) throws BadFormatException, IOException {
        if (leaves.isEmpty()) {
    ...
    protected void printJsonFormat(PrintStream stream, Map<String, TreeSet<String>> tree, ArrayList<String> racks) throws IOException {
    ...
    protected void printTextFormat(PrintStream stream, Map<String, TreeSet<String>> tree, ArrayList<String> racks) {
        for (String r : racks) {
