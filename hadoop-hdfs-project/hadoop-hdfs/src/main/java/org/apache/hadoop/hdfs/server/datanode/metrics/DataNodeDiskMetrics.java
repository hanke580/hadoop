...
public class DataNodeDiskMetrics {
    ...
    public DataNodeDiskMetrics(DataNode dn, long diskOutlierDetectionIntervalMs, Configuration conf) {
        ...
        minOutlierDetectionDisks = conf.getLong(DFSConfigKeys.DFS_DATANODE_MIN_OUTLIER_DETECTION_DISKS_KEY, DFSConfigKeys.DFS_DATANODE_MIN_OUTLIER_DETECTION_DISKS_DEFAULT);
        lowThresholdMs = conf.getLong(DFSConfigKeys.DFS_DATANODE_SLOWDISK_LOW_THRESHOLD_MS_KEY, DFSConfigKeys.DFS_DATANODE_SLOWDISK_LOW_THRESHOLD_MS_DEFAULT);
        slowDiskDetector = new OutlierDetector(minOutlierDetectionDisks, lowThresholdMs);
        shouldRun = true;
    ...
    private void addDiskStat(Map<String, Map<DiskOp, Double>> diskStats, String disk, DiskOp diskOp, double latency) {
