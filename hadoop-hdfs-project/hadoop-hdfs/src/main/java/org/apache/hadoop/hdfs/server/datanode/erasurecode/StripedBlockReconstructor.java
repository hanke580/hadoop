    ...
    private void reconstructTargets(int toReconstructLen) throws IOException {
        ...
        if (isValidationEnabled()) {
            ...
            try {
                ...
                getDatanode().getMetrics().incrECReconstructionValidateTime(validateEnd - start);
            } catch (InvalidDecodingException e) {
                long validateFailedEnd = Time.monotonicNow();
                getDatanode().getMetrics().incrECReconstructionValidateTime(validateFailedEnd - start);
