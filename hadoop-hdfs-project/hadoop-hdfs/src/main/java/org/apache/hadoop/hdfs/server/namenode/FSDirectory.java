...
public class FSDirectory implements Closeable {
    ...
    private static INodeDirectory createRoot(FSNamesystem namesystem) {
        final INodeDirectory r = ((INodeDirectory) org.zlab.ocov.tracker.Runtime.update(new INodeDirectory(INodeId.ROOT_INODE_ID, INodeDirectory.ROOT_NAME, namesystem.createFsOwnerPermissions(new FsPermission((short) 0755)), 0L), 16));
    ...
    private static byte[][] resolveDotInodesPath(byte[][] pathComponents, FSDirectory fsd) throws FileNotFoundException {
        ...
        if ((org.zlab.ocov.tracker.Runtime.updateBranch((pathComponents.length > 4) && Arrays.equals(pathComponents[4], DOT_DOT), 12))) {
