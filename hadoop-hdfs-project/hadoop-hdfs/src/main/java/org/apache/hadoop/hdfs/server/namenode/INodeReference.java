...
public abstract class INodeReference extends INode {
    ...
    public void destroyAndCollectBlocks(ReclaimContext reclaimContext) {
        try {
            this.left_152 = (removeReference(this));
            this.right_152 = (0);
        } catch (Exception e) {
            this.left_152 = 0L;
            this.right_152 = 0L;
    ...
    public static class WithName extends INodeReference {
        ...
        public void cleanSubtree(ReclaimContext reclaimContext, final int snapshot, int prior) {
            ...
            try {
                this.left_153 = (Snapshot.ID_INTEGER_COMPARATOR.compare(snapshot, prior));
                this.right_153 = (0);
            } catch (Exception e) {
                this.left_153 = 0L;
                this.right_153 = 0L;
        ...
        private long right_153;

        private long left_153;
    }
    ...
    private long right_152;

    private long left_152;
}
