...
public class BlockRecoveryWorker {
    ...
    private static void logRecoverBlock(String who, RecoveringBlock rb) {
        ...
        LOG.info("BlockRecoveryWorker: " + who + " calls recoverBlock(" + block + ", targets=[" + Joiner.on(", ").join(targets) + "]" + ", newGenerationStamp=" + rb.getNewGenerationStamp() + ", newBlock=" + rb.getNewBlock() + ")");
    }
