...
class FSEditLogAsync extends FSEditLog implements Runnable {
    ...
    FSEditLogAsync(Configuration conf, NNStorage storage, List<URI> editsDirs) {
        ...
        cache.disableCache();
        int editPendingQSize = conf.getInt(DFSConfigKeys.DFS_NAMENODE_EDITS_ASYNC_LOGGING_PENDING_QUEUE_SIZE, DFSConfigKeys.DFS_NAMENODE_EDITS_ASYNC_LOGGING_PENDING_QUEUE_SIZE_DEFAULT);
