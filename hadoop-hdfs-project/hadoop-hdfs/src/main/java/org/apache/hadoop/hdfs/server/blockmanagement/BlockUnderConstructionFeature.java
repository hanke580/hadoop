...
public class BlockUnderConstructionFeature {
    ...
    public BlockUnderConstructionFeature(Block blk, BlockUCState state, DatanodeStorageInfo[] targets) {
    ...
    public void setExpectedLocations(Block block, DatanodeStorageInfo[] targets) {
        ...
        for (int i = 0; i < targets.length; i++) {
            ...
            if (targets[i] != null) {
                replicas[offset++] = new ReplicaUnderConstruction(block, targets[i], ReplicaState.RBW);
            }
        }
    }
