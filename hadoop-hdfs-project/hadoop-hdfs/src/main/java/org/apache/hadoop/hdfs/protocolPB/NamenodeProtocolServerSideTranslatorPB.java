...
public class NamenodeProtocolServerSideTranslatorPB implements NamenodeProtocolPB {
    ...
    public GetBlocksResponseProto getBlocks(RpcController unused, GetBlocksRequestProto request) throws ServiceException {
        ...
        try {
            blocks = impl.getBlocks(dnInfo, request.getSize(), request.getMinBlockSize(), request.getTimeInterval(), request.hasStorageType() ? PBHelperClient.convertStorageType(request.getStorageType()) : null);
        } catch (IOException e) {
    ...
    @Override
    public IsRollingUpgradeResponseProto isRollingUpgrade(RpcController controller, IsRollingUpgradeRequestProto request) throws ServiceException {
    ...
    @Override
    public GetNextSPSPathResponseProto getNextSPSPath(RpcController controller, GetNextSPSPathRequestProto request) throws ServiceException {
        try {
