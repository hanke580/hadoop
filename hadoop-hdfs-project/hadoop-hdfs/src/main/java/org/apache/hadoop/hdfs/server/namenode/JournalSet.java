...
public class JournalSet implements JournalManager {
    ...
    private class JournalSetOutputStream extends EditLogOutputStream {
        ...
        public void write(final FSEditLogOp op) throws IOException {
            ...
            assert lastJournalledTxId < op.txid : "TxId order violation for op=" + op + ", lastJournalledTxId=" + lastJournalledTxId;
    ...
    public synchronized RemoteEditLogManifest getEditLogManifest(long fromTxId) {
        ...
        while (true) {
            List<RemoteEditLog> logGroup = logsByStartTxId.getOrDefault(curStartTxId, Collections.emptyList());
            if (logGroup.isEmpty()) {
