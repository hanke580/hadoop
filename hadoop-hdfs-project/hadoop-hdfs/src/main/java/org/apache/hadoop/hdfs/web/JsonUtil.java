...
public class JsonUtil {
    ...
    public static Map<String, Object> getEcPolicyAsMap(final ErasureCodingPolicy ecPolicy) {
        ...
        builder.put("name", ecPolicy.getName()).put("cellSize", ecPolicy.getCellSize()).put("numDataUnits", ecPolicy.getNumDataUnits()).put("numParityUnits", ecPolicy.getNumParityUnits()).put("codecName", ecPolicy.getCodecName()).put("id", ecPolicy.getId()).put("extraOptions", ecPolicy.getSchema().getExtraOptions());
    ...
    private static Map<String, Object> toJsonMap(final QuotaUsage quotaUsage, boolean includeFileAndDirectoryCount) {
        final Map<String, Object> m = new TreeMap<>();
    ...
    private static Object toJsonMap(SnapshottableDirectoryStatus snapshottableDirectoryStatus) {
        ...
        m.put("parentFullPath", DFSUtilClient.bytes2String(snapshottableDirectoryStatus.getParentFullPath()));
        m.put("dirStatus", toJsonMap(snapshottableDirectoryStatus.getDirStatus()));
        return m;
    }

    private static Map<String, Object> toJsonMap(final BlockLocation blockLocation) throws IOException {
