...
public abstract class BlockListAsLongs implements Iterable<BlockReportReplica> {
     ...
     */
    public static BlockListAsLongs decodeBuffer(final int numBlocks, final ByteString blocksBuf, final int maxDataLength) {
     ...
     * @return BlockListAsLongs
     */
    public static BlockListAsLongs decodeBuffers(final int numBlocks, final List<ByteString> blocksBufs, final int maxDataLength) {
    ...
    private static class BufferDecoder extends BlockListAsLongs {
        ...
        BufferDecoder(final int numBlocks, final int numFinalized, final ByteString buf, final int maxDataLength) {
