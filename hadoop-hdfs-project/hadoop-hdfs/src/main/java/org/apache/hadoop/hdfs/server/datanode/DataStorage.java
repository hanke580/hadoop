...
public class DataStorage extends Storage {
     ...
     */
    public static boolean createStorageID(StorageDirectory sd, boolean regenerateStorageIds) {
    ...
    private StorageDirectory loadStorageDirectory(DataNode datanode, NamespaceInfo nsInfo, File dataDir, StartupOption startOpt, List<Callable<StorageDirectory>> callables) throws IOException {
    ...
    public VolumeBuilder prepareVolume(DataNode datanode, File volume, List<NamespaceInfo> nsInfos) throws IOException {
        ...
        StorageDirectory sd = loadStorageDirectory(datanode, nsInfos.get(0), volume, StartupOption.HOTSWAP, null);
        ...
        for (NamespaceInfo nsInfo : nsInfos) {
            ...
            final List<StorageDirectory> dirs = bpStorage.loadBpStorageDirectories(nsInfo, bpDataDirs, StartupOption.HOTSWAP, null, datanode.getConf());
    ...
    private List<StorageDirectory> loadBlockPoolSliceStorage(DataNode datanode, NamespaceInfo nsInfo, Collection<StorageLocation> dataDirs, StartupOption startOpt, ExecutorService executor) throws IOException {
        ...
        for (StorageLocation dataDir : dataDirs) {
            ...
            try {
                ...
                final List<StorageDirectory> dirs = bpStorage.recoverTransitionRead(nsInfo, bpDataDirs, startOpt, sdCallables, datanode.getConf());
