...
public class RamDiskReplicaLruTracker extends RamDiskReplicaTracker {
    ...
    private static class RamDiskReplicaLru extends RamDiskReplica {
        ...
        private RamDiskReplicaLru(String bpid, long blockId, FsVolumeImpl ramDiskVolume, long lockedBytesReserved) {
    ...
    @Override
    synchronized void addReplica(final String bpid, final long blockId, final FsVolumeImpl transientVolume, long lockedBytesReserved) {
        Map<Long, RamDiskReplicaLru> map = replicaMaps.get(bpid);
        if (map == null) {
            map = new HashMap<>();
            replicaMaps.put(bpid, map);
        }
        RamDiskReplicaLru ramDiskReplicaLru = new RamDiskReplicaLru(bpid, blockId, transientVolume, lockedBytesReserved);
