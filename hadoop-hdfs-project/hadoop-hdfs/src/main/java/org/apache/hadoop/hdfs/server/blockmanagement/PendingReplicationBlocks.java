   ...
   */
    class PendingReplicationMonitor implements Runnable {
        ...
        void pendingReplicationCheck() {
            synchronized (pendingReplications) {
                Iterator<Map.Entry<BlockInfo, PendingBlockInfo>> iter = pendingReplications.entrySet().iterator();
   ...
   */
    ...
    void metaSave(PrintWriter out) {
        synchronized (pendingReplications) {
            ...
            for (Map.Entry<BlockInfo, PendingBlockInfo> entry : pendingReplications.entrySet()) {
                PendingBlockInfo pendingBlock = entry.getValue();
