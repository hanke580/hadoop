...
public class Snapshot implements Comparable<byte[]> {
    ...
    static public class Root extends INodeDirectory {
        ...
        public boolean metadataEquals(INodeDirectoryAttributes other) {
            return other != null && getQuotaCounts().equals(other.getQuotaCounts()) && getPermissionLong() == other.getPermissionLong() && // Acl feature maintains a reference counted map, thereby
            ...
            getAclFeature() == other.getAclFeature() && Objects.equals(getXAttrFeature(), other.getXAttrFeature());
        }
