...
public class BlockPoolTokenSecretManager extends SecretManager<BlockTokenIdentifier> {
     ...
     *                StorageType[], String[])}
     */
    public void checkAccess(BlockTokenIdentifier id, String userId, ExtendedBlock block, AccessMode mode, StorageType[] storageTypes, String[] storageIds) throws InvalidToken {
     ...
     * StorageType[])}
     */
    public void checkAccess(BlockTokenIdentifier id, String userId, ExtendedBlock block, AccessMode mode, StorageType[] storageTypes) throws InvalidToken {
