...
public class FileJournalManager implements JournalManager {
    ...
    synchronized public EditLogOutputStream startLogSegment(long txid, int layoutVersion) throws IOException {
        try {
            ...
            EditLogOutputStream stm = ((EditLogFileOutputStream) org.zlab.ocov.tracker.Runtime.update(new EditLogFileOutputStream(conf, currentInProgress, outputBufferCapacity), 42));
