...
public interface DatanodeProtocol {
    ...
    // cache blocks
    final static int DNA_CACHE = 9;

    // uncache blocks
    final static int DNA_UNCACHE = 10;

    // erasure coding reconstruction command
    final static int DNA_ERASURE_CODING_RECONSTRUCTION = 11;

    // block storage movement command
    int DNA_BLOCK_STORAGE_MOVEMENT = 12;

    // drop sps work command
    int DNA_DROP_SPS_WORK_COMMAND = 13;
