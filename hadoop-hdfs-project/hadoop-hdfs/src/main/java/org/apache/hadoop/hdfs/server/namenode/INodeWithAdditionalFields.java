...
public abstract class INodeWithAdditionalFields extends INode implements LinkedElement {
    ...
    enum PermissionStatusFormat implements LongBitFormat.Enum {
        ...
        MODE(null, 16), GROUP(MODE.BITS, 24), USER(GROUP.BITS, 24);
        ...
        static PermissionStatus toPermissionStatus(long id, SerialNumberManager.StringTable stringTable) {
            ...
            return new PermissionStatus(SerialNumberManager.USER.getString(uid, stringTable), SerialNumberManager.GROUP.getString(gid, stringTable), new FsPermission(getMode(id)));
        }
