...
public abstract class ReservedSpaceCalculator {
    ...
    long getReservedFromConf(String key, long defaultValue) {
        return conf.getLong(key + "." + StringUtils.toLowerCase(storageType.toString()), conf.getLongBytes(key, defaultValue));
    }
    ...
    public static class ReservedSpaceCalculatorAbsolute extends ReservedSpaceCalculator {
        ...
        public ReservedSpaceCalculatorAbsolute(Configuration conf, DF usage, StorageType storageType) {
            ...
            this.reservedBytes = getReservedFromConf(DFS_DATANODE_DU_RESERVED_KEY, DFS_DATANODE_DU_RESERVED_DEFAULT);
        }
    ...
    public static class ReservedSpaceCalculatorPercentage extends ReservedSpaceCalculator {
        ...
        public ReservedSpaceCalculatorPercentage(Configuration conf, DF usage, StorageType storageType) {
            super(conf, usage, storageType);
            this.reservedPct = getReservedFromConf(DFS_DATANODE_DU_RESERVED_PERCENTAGE_KEY, DFS_DATANODE_DU_RESERVED_PERCENTAGE_DEFAULT);
        }
    ...
    public static class ReservedSpaceCalculatorConservative extends ReservedSpaceCalculator {
        ...
        @Override
        long getReserved() {
            return Math.max(getReservedBytes(), getPercentage(getUsage().getCapacity(), getReservedPct()));
        }
    }
    ...
    public static class ReservedSpaceCalculatorAggressive extends ReservedSpaceCalculator {
        ...
        @Override
        long getReserved() {
            return Math.min(getReservedBytes(), getPercentage(getUsage().getCapacity(), getReservedPct()));
        }
    }
