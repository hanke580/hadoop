...
public class ECAdmin extends Configured implements Tool {
    ...
    private static class AddECPoliciesCommand implements AdminHelper.Command {
        ...
        public int run(Configuration conf, List<String> args) throws IOException {
            ...
            try {
                ...
                if (policies.size() > 0) {
                    AddErasureCodingPolicyResponse[] responses = dfs.addErasureCodingPolicies(policies.toArray(new ErasureCodingPolicy[policies.size()]));
    ...
    private static class GetECPolicyCommand implements AdminHelper.Command {
        ...
        public String getLongUsage() {
            final TableListing listing = AdminHelper.getOptionDescriptionListing();
            listing.addRow("<path>", "The path of the file/directory for getting the erasure coding " + "policy");
    ...
    private static class SetECPolicyCommand implements AdminHelper.Command {
        ...
        public String getLongUsage() {
            TableListing listing = AdminHelper.getOptionDescriptionListing();
            listing.addRow("<path>", "The path of the file/directory to set " + "the erasure coding policy");
            listing.addRow("<policy>", "The name of the erasure coding policy");
    ...
    private static class UnsetECPolicyCommand implements AdminHelper.Command {
        ...
        public String getLongUsage() {
            TableListing listing = AdminHelper.getOptionDescriptionListing();
            listing.addRow("<path>", "The path of the directory " + "from which the erasure coding policy will be unset.");
            ...
            try {
                ...
                if (codecs.isEmpty()) {
                    ...
                    for (Map.Entry<String, String> codec : codecs.entrySet()) {
                        if (codec != null) {
                            System.out.println("\t" + codec.getKey().toUpperCase() + " [" + codec.getValue().toUpperCase() + "]");
                        }
                    }
                }
            } catch (IOException e) {
