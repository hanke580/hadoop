...
public class BackupImage extends FSImage {
    ...
    private synchronized void applyEdits(long firstTxId, int numTxns, byte[] data) throws IOException {
        ...
        try {
            ...
            FSEditLogLoader logLoader = ((FSEditLogLoader) org.zlab.ocov.tracker.Runtime.update(new FSEditLogLoader(getNamesystem(), lastAppliedTxId), 61, firstTxId, numTxns, data));
    ...
    private boolean tryConvergeJournalSpool() throws IOException {
        ...
        synchronized (this) {
            ...
            try {
                ...
                FSEditLogLoader loader = ((FSEditLogLoader) org.zlab.ocov.tracker.Runtime.update(new FSEditLogLoader(getNamesystem(), lastAppliedTxId), 159));
