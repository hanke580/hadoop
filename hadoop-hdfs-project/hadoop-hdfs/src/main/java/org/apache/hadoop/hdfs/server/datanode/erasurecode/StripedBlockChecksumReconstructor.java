...
public abstract class StripedBlockChecksumReconstructor extends StripedReconstructor implements Closeable {
    ...
    protected StripedBlockChecksumReconstructor(ErasureCodingWorker worker, StripedReconstructionInfo stripedReconInfo, DataOutputBuffer checksumWriter, long requestedBlockLength) throws IOException {
    ...
    public void reconstruct() throws IOException {
        ...
        while (requestedLen > 0 && getPositionInBlock() < maxTargetLength) {
            ...
            checksumDataLen += checksumWithTargetOutput(getBufferArray(targetBuffer), toReconstructLen);
    ...
    private long checksumWithTargetOutput(byte[] outputData, int toReconstructLen) throws IOException {
