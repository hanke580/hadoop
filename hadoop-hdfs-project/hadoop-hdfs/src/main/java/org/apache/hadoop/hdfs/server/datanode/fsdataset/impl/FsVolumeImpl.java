...
public class FsVolumeImpl implements FsVolumeSpi {
    ...
    FsVolumeImpl(FsDatasetImpl dataset, String storageID, File currentDir, Configuration conf, StorageType storageType, DF usage) throws IOException {
        ...
        this.reserved = new ReservedSpaceCalculator.Builder(conf).setUsage(usage).setStorageType(storageType).build();
    }
