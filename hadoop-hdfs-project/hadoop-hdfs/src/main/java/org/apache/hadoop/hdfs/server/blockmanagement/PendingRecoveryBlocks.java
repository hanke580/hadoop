...
class PendingRecoveryBlocks {
    ...
    synchronized boolean add(BlockInfo block) {
        ...
        BlockRecoveryAttempt recoveryAttempt = recoveryTimeouts.getElement(new BlockRecoveryAttempt(block));
        if (recoveryAttempt == null) {
            BlockRecoveryAttempt newAttempt = new BlockRecoveryAttempt(block, curTime + recoveryTimeoutInterval);
            ...
            LOG.info("Block recovery attempt for " + block + " rejected, as the " + "previous attempt times out in " + timeoutIn + " seconds.");
        }
        return added;
    }
