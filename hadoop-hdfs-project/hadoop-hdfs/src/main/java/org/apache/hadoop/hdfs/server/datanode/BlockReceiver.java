...
class BlockReceiver implements Closeable {
    ...
    private Checksum computePartialChunkCrc(long blkoff, long ckoff) throws IOException {
        ...
        final Checksum partialCrc = ((org.apache.hadoop.util.DataChecksum) org.zlab.ocov.tracker.Runtime.update(DataChecksum.newDataChecksum(diskChecksum.getChecksumType(), diskChecksum.getBytesPerChecksum()), 5));
