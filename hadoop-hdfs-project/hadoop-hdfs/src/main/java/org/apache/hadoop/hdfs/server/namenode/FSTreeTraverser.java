...
public abstract class FSTreeTraverser {
     ...
     * @throws InterruptedException
     */
    protected INode traverseDirInt(final long startId, INode curr, List<byte[]> startAfters, final TraverseInfo traverseInfo) throws IOException, InterruptedException {
