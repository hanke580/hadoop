...
public class Balancer {
   ...
   */
     ...
     */
    static private int doBalance(Collection<URI> namenodes, final BalancerParameters p, Configuration conf) throws IOException, InterruptedException {
    ...
    static int run(Collection<URI> namenodes, final BalancerParameters p, Configuration conf) throws IOException, InterruptedException {
        ...
        while (serviceRunning) {
            try {
                ...
                LOG.warn("Encounter exception while do balance work. Already tried {} times", exceptionsSinceLastBalance, e);
            }
