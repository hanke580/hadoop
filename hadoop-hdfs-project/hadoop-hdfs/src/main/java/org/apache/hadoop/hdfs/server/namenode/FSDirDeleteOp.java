...
class FSDirDeleteOp {
     ...
     * @throws IOException
     */
    static BlocksMapUpdateInfo delete(FSNamesystem fsn, FSPermissionChecker pc, String src, boolean recursive, boolean logRetryCache) throws IOException {
    ...
    static void deleteForEditLog(FSDirectory fsd, INodesInPath iip, long mtime) throws IOException {
        ...
        FSNamesystem fsn = fsd.getFSNamesystem();
        BlocksMapUpdateInfo collectedBlocks = ((BlocksMapUpdateInfo) org.zlab.ocov.tracker.Runtime.update(new BlocksMapUpdateInfo(), 125));
    ...
    private static boolean unprotectedDelete(FSDirectory fsd, INodesInPath iip, ReclaimContext reclaimContext, long mtime) {
        ...
        org.zlab.ocov.tracker.Runtime.update(targetNode, 126);
