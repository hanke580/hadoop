...
public class NameNodeResourceChecker {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(NameNodeResourceChecker.class.getName());
    ...
    public NameNodeResourceChecker(Configuration conf) throws IOException {
        ...
        duReserved = conf.getLongBytes(DFSConfigKeys.DFS_NAMENODE_DU_RESERVED_KEY, DFSConfigKeys.DFS_NAMENODE_DU_RESERVED_DEFAULT);
        ...
        Collection<URI> localEditDirs = FSNamesystem.getNamespaceEditsDirs(conf).stream().filter(input -> {
