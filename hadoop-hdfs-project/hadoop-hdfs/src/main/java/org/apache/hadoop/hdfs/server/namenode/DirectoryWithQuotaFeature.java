...
public final class DirectoryWithQuotaFeature implements INode.Feature {
    ...
    QuotaCounts getQuota() {
        return ((QuotaCounts.Builder) org.zlab.ocov.tracker.Runtime.update(new QuotaCounts.Builder(), 80)).quotaCount(this.quota).build();
    }
    ...
    public QuotaCounts getSpaceConsumed() {
        return ((QuotaCounts.Builder) org.zlab.ocov.tracker.Runtime.update(new QuotaCounts.Builder(), 81)).quotaCount(usage).build();
    }
