...
public final class DirectoryWithQuotaFeature implements INode.Feature {
    ...
    QuotaCounts getQuota() {
        return ((QuotaCounts.Builder) org.zlab.ocov.tracker.Runtime.update(new QuotaCounts.Builder(), 143)).quotaCount(this.quota).build();
    }
    ...
    public QuotaCounts getSpaceAllowed() {
        return ((QuotaCounts.Builder) org.zlab.ocov.tracker.Runtime.update(new QuotaCounts.Builder(), 144)).quotaCount(quota).build();
    }
    ...
    public QuotaCounts getSpaceConsumed() {
        return ((QuotaCounts.Builder) org.zlab.ocov.tracker.Runtime.update(new QuotaCounts.Builder(), 145)).quotaCount(usage).build();
    }
