...
public class CacheManager {
    ...
    private long getNextDirectiveId() throws IOException {
        assert namesystem.hasWriteLock();
        try {
            this.left_147 = (nextDirectiveId);
            this.right_147 = (Long.MAX_VALUE - 1);
        } catch (Exception e) {
            this.left_147 = 0L;
            this.right_147 = 0L;
        }
    ...
    public void setCachedLocations(LocatedBlocks locations) {
        try {
            this.left_149 = (cachedBlocks.size());
            this.right_149 = (0);
        } catch (Exception e) {
            this.left_149 = 0L;
            this.right_149 = 0L;
    ...
    private long right_147;

    private long left_148;

    private long left_147;

    private long right_149;

    private long right_148;

    private long left_149;
}
