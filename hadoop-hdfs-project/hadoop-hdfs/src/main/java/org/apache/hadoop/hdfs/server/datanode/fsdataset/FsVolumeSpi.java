...
public interface FsVolumeSpi extends Checkable<FsVolumeSpi.VolumeCheckContext, VolumeCheckResult> {
    ...
    public static class ScanInfo implements Comparable<ScanInfo> {
        ...
        public ScanInfo(long blockId, File blockFile, File metaFile, FsVolumeSpi vol) {
            ...
            String condensedVolPath = (vol == null || vol.getBaseURI() == null) ? null : getCondensedPath(new File(vol.getBaseURI()).getAbsolutePath());
        ...
        public File getBlockFile() {
            return (blockSuffix == null) ? null : new File(new File(volume.getBaseURI()).getAbsolutePath(), blockSuffix);
        }
     ...
     * @throws IOException
     */
    void compileReport(String bpid, Collection<ScanInfo> report, ReportCompiler reportCompiler) throws InterruptedException, IOException;
