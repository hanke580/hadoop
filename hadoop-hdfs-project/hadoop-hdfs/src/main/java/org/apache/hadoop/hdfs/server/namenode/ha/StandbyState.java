...
public class StandbyState extends HAState {
    ...
    public void setState(HAContext context, HAState s) throws ServiceFailedException {
        if (s == NameNode.ACTIVE_STATE || (!isObserver && s == NameNode.OBSERVER_STATE) || (isObserver && s == NameNode.STANDBY_STATE)) {
    ...
    public void checkOperation(HAContext context, OperationCategory op) throws StandbyException {
        ...
        String msg = "Operation category " + op + " is not supported in state " + context.getState() + faq;
