...
public abstract class BlockInfo extends Block implements LightWeightGSet.LinkedElement {
    ...
    BlockInfo getPrevious(int index) {
        ...
        assert info == null || info.getClass().getName().startsWith(BlockInfo.class.getName()) : "BlockInfo is expected at " + (index * 3 + 1);
        return info;
    }
    ...
    BlockInfo getNext(int index) {
        ...
        assert info == null || info.getClass().getName().startsWith(BlockInfo.class.getName()) : "BlockInfo is expected at " + (index * 3 + 2);
        return info;
    }
    ...
    BlockInfo listInsert(BlockInfo head, DatanodeStorageInfo storage) {
        ...
        org.zlab.ocov.tracker.Runtime.update(this, 187);
        if (head != null) {
