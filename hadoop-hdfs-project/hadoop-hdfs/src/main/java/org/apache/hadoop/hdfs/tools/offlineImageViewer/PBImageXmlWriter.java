...
public final class PBImageXmlWriter {
    ...
    private void dumpXattrs(INodeSection.XAttrFeatureProto xattrs) {
        ...
        for (INodeSection.XAttrCompactProto xattr : xattrs.getXAttrsList()) {
            ...
            o(SECTION_NAME, SerialNumberManager.XATTR.getString(XATTR_NAME_MASK & (encodedName >> XATTR_NAME_OFFSET), stringTable));
    ...
    private void dumpINodeReference(INodeReferenceSection.INodeReference r) {
        ...
        o(INODE_REFERENCE_SECTION_REFERRED_ID, r.getReferredId()).o(SECTION_NAME, r.getName().toStringUtf8()).o(INODE_REFERENCE_SECTION_DST_SNAPSHOT_ID, r.getDstSnapshotId()).o(INODE_REFERENCE_SECTION_LAST_SNAPSHOT_ID, r.getLastSnapshotId());
        out.print("</" + INODE_REFERENCE_SECTION_REF + ">\n");
    }
    ...
    private void dumpAcls(AclFeatureProto aclFeatureProto) {
        ImmutableList<AclEntry> aclEntryList = FSImageFormatPBINode.Loader.loadAclEntries(aclFeatureProto, stringTable);
    ...
    private void dumpINodeSymlink(INodeSymlink s) {
        o(INODE_SECTION_PERMISSION, dumpPermission(s.getPermission())).o(INODE_SECTION_TARGET, s.getTarget().toStringUtf8()).o(INODE_SECTION_MTIME, s.getModificationTime()).o(INODE_SECTION_ATIME, s.getAccessTime());
    }
