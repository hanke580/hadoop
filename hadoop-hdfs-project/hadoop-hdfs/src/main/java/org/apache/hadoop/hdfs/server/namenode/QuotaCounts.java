...
public class QuotaCounts {
    ...
    public QuotaCounts negation() {
        QuotaCounts ret = ((org.apache.hadoop.hdfs.server.namenode.QuotaCounts.Builder) org.zlab.ocov.tracker.Runtime.update(new QuotaCounts.Builder().quotaCount(this), 7)).build();
        org.zlab.ocov.tracker.Runtime.update(ret, 6);
        ret.nsSsCounts = modify(ret.nsSsCounts, ec -> ec.negation());
        org.zlab.ocov.tracker.Runtime.update(ret, 8);
