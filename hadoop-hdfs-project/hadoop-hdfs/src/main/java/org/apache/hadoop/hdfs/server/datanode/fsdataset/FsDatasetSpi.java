...
public interface FsDatasetSpi<V extends FsVolumeSpi> extends FSDatasetMBean {
     ...
     */
    ReplicaHandler createTemporary(StorageType storageType, ExtendedBlock b, boolean isTransfer) throws IOException;
     ...
     * @throws IOException if an error occurs
     */
    ReplicaHandler createRbw(StorageType storageType, ExtendedBlock b, boolean allowLazyPersist) throws IOException;
     ...
     */
    ReplicaInPipelineInterface convertTemporaryToRbw(ExtendedBlock temporary) throws IOException;
     ...
     */
    void checkBlock(ExtendedBlock b, long minLength, ReplicaState state) throws ReplicaNotFoundException, UnexpectedReplicaStateException, FileNotFoundException, EOFException, IOException;
     ...
     * @throws IOException
     */
    HdfsBlocksMetadata getHdfsBlocksMetadata(String bpid, long[] blockIds) throws IOException;
     ...
     */
    void submitBackgroundSyncFileRangeRequest(final ExtendedBlock block, final ReplicaOutputStreams outs, final long offset, final long nbytes, final int flags);
     ...
     */
    ReplicaInfo moveBlockAcrossStorage(final ExtendedBlock block, StorageType targetStorageType) throws IOException;
