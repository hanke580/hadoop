...
class ParameterParser {
    ...
    long blockSize() {
        return ((BlockSizeParam) org.zlab.ocov.tracker.Runtime.update(new BlockSizeParam(param(BlockSizeParam.NAME)), 25)).getValue(conf);
    }

    short replication() {
        return ((ReplicationParam) org.zlab.ocov.tracker.Runtime.update(new ReplicationParam(param(ReplicationParam.NAME)), 26)).getValue(conf);
    }
