...
class ReplicaMap {
    ...
    private final Map<String, LightWeightResizableGSet<Block, ReplicaInfo>> map = new HashMap<>();
    ...
    ReplicaInfo get(String bpid, long blockId) {
        ...
        try (AutoCloseableLock l = readLock.acquire()) {
            ...
            return m != null ? m.get(((Block) org.zlab.ocov.tracker.Runtime.update(new Block(blockId), 129))) : null;
        }
    }
    ...
    void mergeAll(ReplicaMap other) {
        other.map.forEach((bp, replicaInfos) -> {
