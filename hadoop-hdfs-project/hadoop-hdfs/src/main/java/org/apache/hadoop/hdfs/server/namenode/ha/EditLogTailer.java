...
public class EditLogTailer {
    ...
    public EditLogTailer(FSNamesystem namesystem, Configuration conf) {
        ...
        long maxSleepTimeMsTemp = conf.getTimeDuration(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_BACKOFF_MAX_KEY, DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_BACKOFF_MAX_DEFAULT, TimeUnit.MILLISECONDS);
        if (maxSleepTimeMsTemp > 0 && maxSleepTimeMsTemp < sleepTimeMs) {
            LOG.warn(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_BACKOFF_MAX_KEY + " was configured to be " + maxSleepTimeMsTemp + " ms, but this is less than " + DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY + ". Disabling backoff when tailing edit logs.");
            maxSleepTimeMs = 0;
        } else {
