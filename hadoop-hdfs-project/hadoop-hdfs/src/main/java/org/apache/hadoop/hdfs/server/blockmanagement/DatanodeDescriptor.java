...
public class DatanodeDescriptor extends DatanodeInfo {
    ...
    private final Map<String, DatanodeStorageInfo> storageMap = new HashMap<>();
   ...
   */
    ...
    public class LeavingServiceStatus {
        ...
        synchronized void set(int underRepBlocks, int outOfServiceOnlyRep, int underRepInOpenFiles) {
