...
public class SlowPeerTracker {
    ...
    public SlowPeerTracker(Configuration conf, Timer timer) {
        ...
        this.reportValidityMs = conf.getTimeDuration(DFSConfigKeys.DFS_DATANODE_OUTLIERS_REPORT_INTERVAL_KEY, DFSConfigKeys.DFS_DATANODE_OUTLIERS_REPORT_INTERVAL_DEFAULT, TimeUnit.MILLISECONDS) * 3;
    }
    ...
    public void addReport(String slowNode, String reportingNode) {
        ...
        if (nodeEntries == null) {
            ...
            allReports.putIfAbsent(slowNode, new ConcurrentHashMap<String, Long>());
    ...
    public static class ReportForJson {
        ...
        public ReportForJson(@JsonProperty("SlowNode") String slowNode, @JsonProperty("ReportingNodes") SortedSet<String> reportingNodes) {
    ...
    private Collection<ReportForJson> getJsonReports(int numNodes) {
        ...
        final PriorityQueue<ReportForJson> topNReports = new PriorityQueue<>(allReports.size(), new Comparator<ReportForJson>() {
