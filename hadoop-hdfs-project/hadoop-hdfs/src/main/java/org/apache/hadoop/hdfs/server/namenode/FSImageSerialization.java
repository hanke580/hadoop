...
public class FSImageSerialization {
    ...
    private static void writePermissionStatus(INodeAttributes inode, DataOutput out) throws IOException {
        ...
        org.zlab.ocov.tracker.Runtime.update(p, 33);
    ...
    static INodeFile readINodeUnderConstruction(DataInput in, FSNamesystem fsNamesys, int imgVersion) throws IOException {
        ...
        if ((org.zlab.ocov.tracker.Runtime.updateBranch(numBlocks, 0, ">", 12))) {
            blk.readFields(in);
            blocksContiguous[i] = new BlockInfoContiguous(blk, blockReplication);
    ...
    public static void writeString(String str, DataOutput out) throws IOException {
        DeprecatedUTF8 ustr = TL_DATA.get().U_STR;
        ustr.set(str);
        org.zlab.ocov.tracker.Runtime.update(ustr, 34);
        ustr.write(out);
    }
    ...
    static long readLong(DataInput in) throws IOException {
        ...
        uLong.readFields(in);
        org.zlab.ocov.tracker.Runtime.update(uLong, 35);
        return uLong.get();
    }
    ...
    static void writeLong(long value, DataOutputStream out) throws IOException {
        LongWritable uLong = TL_DATA.get().U_LONG;
        uLong.set(value);
        org.zlab.ocov.tracker.Runtime.update(uLong, 36);
        uLong.write(out);
    }
    ...
    static boolean readBoolean(DataInput in) throws IOException {
        ...
        org.zlab.ocov.tracker.Runtime.update(uBoolean, 37);
        return uBoolean.get();
    }
    ...
    static int readInt(DataInput in) throws IOException {
        ...
        uInt.readFields(in);
        org.zlab.ocov.tracker.Runtime.update(uInt, 38);
        return uInt.get();
    }
    ...
    static void writeInt(int value, DataOutputStream out) throws IOException {
        IntWritable uInt = TL_DATA.get().U_INT;
        uInt.set(value);
        org.zlab.ocov.tracker.Runtime.update(uInt, 39);
        uInt.write(out);
    }
    ...
    static short readShort(DataInput in) throws IOException {
        ...
        org.zlab.ocov.tracker.Runtime.update(uShort, 40);
        return uShort.get();
    }
    ...
    static void writeShort(short value, DataOutputStream out) throws IOException {
        ShortWritable uShort = TL_DATA.get().U_SHORT;
        uShort.set(value);
        org.zlab.ocov.tracker.Runtime.update(uShort, 41);
        uShort.write(out);
    }
    ...
    public static CacheDirectiveInfo readCacheDirectiveInfo(DataInput in) throws IOException {
        CacheDirectiveInfo.Builder builder = ((CacheDirectiveInfo.Builder) org.zlab.ocov.tracker.Runtime.update(new CacheDirectiveInfo.Builder(), 42));
        ...
        if ((flags & 0x8) != 0) {
            ...
            org.zlab.ocov.tracker.Runtime.update(builder, 43);
        }
        if ((flags & ~0xF) != 0) {
    ...
    public static void writeCacheDirectiveInfo(ContentHandler contentHandler, CacheDirectiveInfo directive) throws SAXException {
        ...
        if (directive.getExpiration() != null) {
            XMLUtils.addSaxString(contentHandler, "EXPIRATION", "" + directive.getExpiration().getAbsoluteMillis());
        }
    }
    ...
    public static void writeCachePoolInfo(DataOutputStream out, CachePoolInfo info) throws IOException {
        ...
        int flags = (hasOwner ? 0x1 : 0) | (hasGroup ? 0x2 : 0) | (hasMode ? 0x4 : 0) | (hasLimit ? 0x8 : 0) | (hasMaxRelativeExpiry ? 0x10 : 0) | (hasDefaultReplication ? 0x20 : 0);
        writeInt(flags, out);
        if (hasOwner) {
    ...
    public static void writeErasureCodingPolicy(DataOutputStream out, ErasureCodingPolicy ecPolicy) throws IOException {
