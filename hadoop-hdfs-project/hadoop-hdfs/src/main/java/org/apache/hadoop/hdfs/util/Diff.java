    ...
    public void combinePosterior(final Diff<K, E> posterior, final Processor<E> deletedProcesser) {
        ...
        for (; c != null || d != null; ) {
            ...
            if (cmp < 0) {
                ...
                final UndoInfo<E> ui = ((org.apache.hadoop.hdfs.util.Diff.UndoInfo) org.zlab.ocov.tracker.Runtime.update(delete(d), 2));
                ...
                final UndoInfo<E> ui = ((org.apache.hadoop.hdfs.util.Diff.UndoInfo) org.zlab.ocov.tracker.Runtime.update(modify(d, c), 3));
                if (deletedProcesser != null) {
                    deletedProcesser.process(ui.trashed);
                }
                c = createdIterator.hasNext() ? createdIterator.next() : null;
