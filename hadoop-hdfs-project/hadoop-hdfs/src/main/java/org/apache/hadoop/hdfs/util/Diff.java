...
public class Diff<K, E extends Diff.Element<K>> {
    ...
    public List<E> getCreatedUnmodifiable() {
        return created != null ? Collections.unmodifiableList(created) : Collections.<E>emptyList();
    }
    ...
    public List<E> getDeletedUnmodifiable() {
        return deleted != null ? Collections.unmodifiableList(deleted) : Collections.<E>emptyList();
    }
