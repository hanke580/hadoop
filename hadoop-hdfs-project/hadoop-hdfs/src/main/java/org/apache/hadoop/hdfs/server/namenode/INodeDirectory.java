...
public class INodeDirectory extends INodeWithAdditionalFields implements INodeDirectoryAttributes {
    ...
    void setQuota(BlockStoragePolicySuite bsps, long nsQuota, long ssQuota, StorageType type) {
        ...
        if (quota != null) {
            ...
            DirectoryWithQuotaFeature.Builder builder = ((DirectoryWithQuotaFeature.Builder) org.zlab.ocov.tracker.Runtime.update(new DirectoryWithQuotaFeature.Builder(), 116)).nameSpaceQuota(nsQuota);
            if (type != null) {
    ...
    public void removeSnapshottableFeature() {
        ...
        this.removeFeature(s);
        if ((org.zlab.ocov.tracker.Runtime.updateBranch(s.getDiffs().asList().size() > 0, 39))) {
    ...
    public QuotaCounts computeQuotaUsage(BlockStoragePolicySuite bsps, byte blockStoragePolicyId, boolean useCache, int lastSnapshotId) {
        ...
        QuotaCounts counts = ((QuotaCounts.Builder) org.zlab.ocov.tracker.Runtime.update(new QuotaCounts.Builder(), 118)).build();
        org.zlab.ocov.tracker.Runtime.update(counts, 117);
    ...
    public void destroyAndCollectBlocks(ReclaimContext reclaimContext) {
        reclaimContext.quotaDelta().add(((QuotaCounts.Builder) org.zlab.ocov.tracker.Runtime.update(new QuotaCounts.Builder(), 119)).nameSpace(1).build());
        final DirectoryWithSnapshotFeature sf = getDirectoryWithSnapshotFeature();
        if (sf != null) {
