...
public class INodeDirectory extends INodeWithAdditionalFields implements INodeDirectoryAttributes {
    ...
    void setQuota(BlockStoragePolicySuite bsps, long nsQuota, long ssQuota, StorageType type) {
        ...
        if (quota != null) {
            ...
            DirectoryWithQuotaFeature.Builder builder = ((DirectoryWithQuotaFeature.Builder) org.zlab.ocov.tracker.Runtime.update(new DirectoryWithQuotaFeature.Builder(), 47)).nameSpaceQuota(nsQuota);
            if (type != null) {
     ...
     */
    public Snapshot addSnapshot(SnapshotManager snapshotManager, String name, final LeaseManager leaseManager, long mtime) throws SnapshotException {
        return getDirectorySnapshottableFeature().addSnapshot(this, snapshotManager, name, leaseManager, mtime);
    }
     ...
     */
    public Snapshot removeSnapshot(ReclaimContext reclaimContext, String snapshotName, long mtime, SnapshotManager snapshotManager) throws SnapshotException {
        return getDirectorySnapshottableFeature().removeSnapshot(reclaimContext, this, snapshotName, mtime, snapshotManager);
    }
    ...
    public void removeSnapshottableFeature() {
        ...
        this.removeFeature(s);
        if ((org.zlab.ocov.tracker.Runtime.updateBranch(s.getDiffs().asList().size(), 0, ">", 17))) {
    ...
    public QuotaCounts computeQuotaUsage(BlockStoragePolicySuite bsps, byte blockStoragePolicyId, boolean useCache, int lastSnapshotId) {
        ...
        QuotaCounts counts = ((QuotaCounts.Builder) org.zlab.ocov.tracker.Runtime.update(new QuotaCounts.Builder(), 49)).build();
        org.zlab.ocov.tracker.Runtime.update(counts, 48);
    ...
    protected ContentSummaryComputationContext computeDirectoryContentSummary(ContentSummaryComputationContext summary, int snapshotId) throws AccessControlException {
    ...
    public void undoRename4DstParent(final BlockStoragePolicySuite bsps, final INode deletedChild, int latestSnapshotId) {
        ...
        org.zlab.ocov.tracker.Runtime.update(deletedChild, 50);
     ...
     */
    public void cleanSubtreeRecursively(ReclaimContext reclaimContext, final int snapshot, int prior, final Map<INode, INode> excludedNodes) {
    ...
    public void destroyAndCollectBlocks(ReclaimContext reclaimContext) {
        reclaimContext.quotaDelta().add(((QuotaCounts.Builder) org.zlab.ocov.tracker.Runtime.update(new QuotaCounts.Builder(), 51)).nameSpace(1).build());
        final DirectoryWithSnapshotFeature sf = getDirectoryWithSnapshotFeature();
        if (sf != null) {
    ...
    public void cleanSubtree(ReclaimContext reclaimContext, final int snapshotId, int priorSnapshotId) {
        ...
        if (sf != null) {
            ...
            if (sf.getDiffs().isEmpty() && !(sf instanceof DirectorySnapshottableFeature) && getDirectoryWithSnapshotFeature() != null) {
            ...
            if (priorSnapshotId == Snapshot.NO_SNAPSHOT_ID && snapshotId == Snapshot.CURRENT_STATE_ID) {
                ...
                org.zlab.ocov.tracker.Runtime.update(current, 52);
