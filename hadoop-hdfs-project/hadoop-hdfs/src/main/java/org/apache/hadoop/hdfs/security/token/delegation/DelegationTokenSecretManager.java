...
public class DelegationTokenSecretManager extends AbstractDelegationTokenSecretManager<DelegationTokenIdentifier> {
    ...
    public synchronized void loadSecretManagerState(SecretManagerState state, Counter counter) throws IOException {
    ...
    public synchronized void addPersistedDelegationToken(DelegationTokenIdentifier identifier, long expiryTime) throws IOException {
        ...
        this.left_3 = (identifier.getSequenceNumber());
        this.right_3 = (this.delegationTokenSequenceNumber);
            ...
            try {
                ...
                synchronized (noInterruptsLock) {
                    if (Thread.currentThread().isInterrupted()) {
                        // leave flag set so secret monitor exits.
                        return;
                    }
