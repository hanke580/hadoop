...
public class FSImageFormat {
    ...
    public static class Loader implements AbstractLoader {
        ...
        public void load(File curFile) throws IOException {
            ...
            DigestInputStream fin = new DigestInputStream(Files.newInputStream(curFile.toPath()), digester);
        ...
        INode loadINode(final byte[] localName, boolean isSnapshotINode, DataInput in, Counter counter) throws IOException {
            ...
            if ((org.zlab.ocov.tracker.Runtime.updateBranch(numBlocks >= 0, 32))) {
                // file
                // read blocks
                ...
                if (NameNodeLayoutVersion.supports(LayoutVersion.Feature.SNAPSHOT, imgVersion)) {
                    ...
                    if (isSnapshotINode) {
                        ...
                        if (underConstruction) {
                            ...
                            if ((org.zlab.ocov.tracker.Runtime.updateBranch(blocks.length > 0, 33))) {
                ...
                INodeFile file = new INodeFile(inodeId, localName, permissions, modificationTime, atime, (BlockInfoContiguous[]) blocks, replication, blockSize);
                if (underConstruction) {
                ...
                if ((org.zlab.ocov.tracker.Runtime.updateBranch(nsQuota >= 0 || dsQuota >= 0, 34))) {
        ...
        public INodeFileAttributes loadINodeFileAttributes(DataInput in) throws IOException {
            ...
            return new INodeFileAttributes.SnapshotCopy(name, permissions, null, modificationTime, accessTime, replication, null, preferredBlockSize, (byte) 0, null, BlockType.CONTIGUOUS);
        }
        ...
        private void loadFilesUnderConstruction(DataInput in, boolean supportSnapshot, Counter counter) throws IOException {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (oldnode.numBlocks() > 0) {
                    ...
                    BlockInfo info = namesystem.getBlockManager().addBlockCollectionWithCheck(ucBlock, oldnode);
