...
public class FsImageValidation {
    ...
    private FSNamesystem loadImage(Configuration conf) throws IOException {
        ...
        if (fsImageFile.isDirectory()) {
            ...
            final FSImage fsImage = ((FSImage) org.zlab.ocov.tracker.Runtime.update(new FSImage(conf), 38));
            namesystem = ((FSNamesystem) org.zlab.ocov.tracker.Runtime.update(new FSNamesystem(conf, fsImage, true), 39));
            ...
            final FSImage fsImage = ((FSImage) org.zlab.ocov.tracker.Runtime.update(new FSImage(conf), 40));
            namesystem = ((FSNamesystem) org.zlab.ocov.tracker.Runtime.update(new FSNamesystem(conf, fsImage, true), 41));
