...
public class FsImageValidation {
    ...
    private FSNamesystem loadImage(Configuration conf) throws IOException {
        ...
        if (fsImageFile.isDirectory()) {
            ...
            final FSImage fsImage = ((FSImage) org.zlab.ocov.tracker.Runtime.update(new FSImage(conf), 97));
            namesystem = ((FSNamesystem) org.zlab.ocov.tracker.Runtime.update(new FSNamesystem(conf, fsImage, true), 98));
            ...
            final FSImage fsImage = ((FSImage) org.zlab.ocov.tracker.Runtime.update(new FSImage(conf), 99));
            namesystem = ((FSNamesystem) org.zlab.ocov.tracker.Runtime.update(new FSNamesystem(conf, fsImage, true), 100));
