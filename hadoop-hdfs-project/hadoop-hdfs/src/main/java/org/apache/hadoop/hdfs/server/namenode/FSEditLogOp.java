...
public abstract class FSEditLogOp {
    ...
    static abstract class AddCloseOp extends FSEditLogOp implements BlockListUpdatingOp {
        ...
        private static int right_15;

        private static int left_15;
    }
    ...
    static class TruncateOp extends FSEditLogOp {
        ...
        TruncateOp setTruncateBlock(Block truncateBlock) {
            this.truncateBlock = truncateBlock == null ? null : new Block(truncateBlock);
            return this;
        }
    ...
    static class CreateSnapshotOp extends FSEditLogOp {
        ...
        void readFields(DataInputStream in, int logVersion) throws IOException {
            ...
            if (NameNodeLayoutVersion.supports(NameNodeLayoutVersion.Feature.SNAPSHOT_MODIFICATION_TIME, logVersion)) {
