...
public abstract class FSEditLogOp {
    ...
    public static class OpInstanceCache {
        ...
        private static final ThreadLocal<OpInstanceCacheMap> CACHE = new ThreadLocal<OpInstanceCacheMap>() {
    ...
    private static void appendRpcIdsToString(final StringBuilder builder, final byte[] clientId, final int callId) {
        builder.append(", RpcClientId=").append(ClientId.toString(clientId)).append(", RpcCallId=").append(callId);
    }
    ...
    static abstract class AddCloseOp extends FSEditLogOp implements BlockListUpdatingOp {
        ...
        public void writeFields(DataOutputStream out, int logVersion) throws IOException {
            ...
            if (this.opCode == OP_ADD) {
                ...
                if (NameNodeLayoutVersion.supports(NameNodeLayoutVersion.Feature.ERASURE_CODING, logVersion)) {
        ...
        public String stringifyMembers() {
            ...
            builder.append("[length=").append(length).append(", inodeId=").append(inodeId).append(", path=").append(path).append(", replication=").append(replication).append(", mtime=").append(mtime).append(", atime=").append(atime).append(", blockSize=").append(blockSize).append(", blocks=").append(Arrays.toString(blocks)).append(", permissions=").append(permissions).append(", aclEntries=").append(aclEntries).append(", clientName=").append(clientName).append(", clientMachine=").append(clientMachine).append(", overwrite=").append(overwrite);
            if (this.opCode == OP_ADD) {
                appendRpcIdsToString(builder, rpcClientId, rpcCallId);
            }
            builder.append(", storagePolicyId=").append(storagePolicyId).append(", erasureCodingPolicyId=").append(erasureCodingPolicyId).append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
        ...
        protected void toXml(ContentHandler contentHandler) throws SAXException {
            ...
            if (this.opCode == OP_ADD) {
                ...
                XMLUtils.addSaxString(contentHandler, "ERASURE_CODING_POLICY_ID", Byte.toString(erasureCodingPolicyId));
        ...
        private static long right_156;

        private static long left_156;
    }
    ...
    static class AppendOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("AppendOp ").append("[path=").append(path).append(", clientName=").append(clientName).append(", clientMachine=").append(clientMachine).append(", newBlock=").append(newBlock).append("]");
            return builder.toString();
        }
    ...
    static class SetReplicationOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SetReplicationOp [path=").append(path).append(", replication=").append(replication).append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class ConcatDeleteOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("ConcatDeleteOp [length=").append(length).append(", trg=").append(trg).append(", srcs=").append(Arrays.toString(srcs)).append(", timestamp=").append(timestamp);
            appendRpcIdsToString(builder, rpcClientId, rpcCallId);
        ...
        private long left_157;

        private long right_158;

        private long right_157;

        private long left_158;
    }
    ...
    static class RenameOldOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("RenameOldOp [length=").append(length).append(", src=").append(src).append(", dst=").append(dst).append(", timestamp=").append(timestamp);
            appendRpcIdsToString(builder, rpcClientId, rpcCallId);
            builder.append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class DeleteOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("DeleteOp [length=").append(length).append(", path=").append(path).append(", timestamp=").append(timestamp);
            appendRpcIdsToString(builder, rpcClientId, rpcCallId);
            builder.append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class MkdirOp extends FSEditLogOp {
        ...
        void readFields(DataInputStream in, int logVersion) throws IOException {
            ...
            try {
                this.left_159 = (-17);
                this.right_159 = (logVersion);
            } catch (Exception e) {
                this.left_159 = 0L;
                this.right_159 = 0L;
            }
            try {
                this.left_160 = (logVersion);
                this.right_160 = (-17);
            } catch (Exception e) {
                this.left_160 = 0L;
                this.right_160 = 0L;
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("MkdirOp [length=").append(length).append(", inodeId=").append(inodeId).append(", path=").append(path).append(", timestamp=").append(timestamp).append(", permissions=").append(permissions).append(", aclEntries=").append(aclEntries).append(", opCode=").append(opCode).append(", txid=").append(txid).append(", xAttrs=").append(xAttrs).append("]");
            return builder.toString();
        }
        ...
        private long left_160;

        private long right_160;

        private long left_159;

        private long right_159;
    }
    ...
    static class SetGenstampV1Op extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SetGenstampOp [GenStamp=").append(genStampV1).append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class SetGenstampV2Op extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SetGenstampV2Op [GenStampV2=").append(genStampV2).append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class AllocateBlockIdOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("AllocateBlockIdOp [blockId=").append(blockId).append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class SetPermissionsOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SetPermissionsOp [src=").append(src).append(", permissions=").append(permissions).append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class SetOwnerOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SetOwnerOp [src=").append(src).append(", username=").append(username).append(", groupname=").append(groupname).append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class SetNSQuotaOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SetNSQuotaOp [src=").append(src).append(", nsQuota=").append(nsQuota).append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class ClearNSQuotaOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("ClearNSQuotaOp [src=").append(src).append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class SetQuotaOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SetQuotaOp [src=").append(src).append(", nsQuota=").append(nsQuota).append(", dsQuota=").append(dsQuota).append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class SetQuotaByStorageTypeOp extends FSEditLogOp {
        ...
        public void internal$writeFields57(DataOutputStream out) throws IOException {
            FSImageSerialization.writeString(src, out);
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SetTypeQuotaOp [src=").append(src).append(", storageType=").append(type).append(", dsQuota=").append(dsQuota).append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class TimesOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("TimesOp [length=").append(length).append(", path=").append(path).append(", mtime=").append(mtime).append(", atime=").append(atime).append(", opCode=").append(opCode).append(", txid=").append(txid);
            builder.append("]");
            return builder.toString();
        }
    ...
    static class SymlinkOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SymlinkOp [length=").append(length).append(", inodeId=").append(inodeId).append(", path=").append(path).append(", value=").append(value).append(", mtime=").append(mtime).append(", atime=").append(atime).append(", permissionStatus=").append(permissionStatus);
            appendRpcIdsToString(builder, rpcClientId, rpcCallId);
            builder.append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class RenameOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("RenameOp [length=").append(length).append(", src=").append(src).append(", dst=").append(dst).append(", timestamp=").append(timestamp).append(", options=").append(Arrays.toString(options));
            appendRpcIdsToString(builder, rpcClientId, rpcCallId);
            builder.append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class TruncateOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("TruncateOp [src=").append(src).append(", clientName=").append(clientName).append(", clientMachine=").append(clientMachine).append(", newLength=").append(newLength).append(", timestamp=").append(timestamp).append(", truncateBlock=").append(truncateBlock).append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    }
    ...
    static class ReassignLeaseOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("ReassignLeaseOp [leaseHolder=").append(leaseHolder).append(", path=").append(path).append(", newHolder=").append(newHolder).append(", opCode=").append(opCode).append(", txid=").append(txid);
            builder.append("]");
            return builder.toString();
        }
    ...
    static class GetDelegationTokenOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("GetDelegationTokenOp [token=").append(token).append(", expiryTime=").append(expiryTime).append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class RenewDelegationTokenOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("RenewDelegationTokenOp [token=").append(token).append(", expiryTime=").append(expiryTime).append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class CancelDelegationTokenOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("CancelDelegationTokenOp [token=").append(token).append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class UpdateMasterKeyOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("UpdateMasterKeyOp [key=").append(key).append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class LogSegmentOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("LogSegmentOp [opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class InvalidOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("InvalidOp [opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
    ...
    static class CreateSnapshotOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("CreateSnapshotOp [snapshotRoot=").append(snapshotRoot).append(", snapshotName=").append(snapshotName).append(", mtime=").append(mtime);
            appendRpcIdsToString(builder, rpcClientId, rpcCallId);
            builder.append("]");
            return builder.toString();
        }
    ...
    static class DeleteSnapshotOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("DeleteSnapshotOp [snapshotRoot=").append(snapshotRoot).append(", snapshotName=").append(snapshotName).append(", mtime=").append(mtime);
            appendRpcIdsToString(builder, rpcClientId, rpcCallId);
            builder.append("]");
            return builder.toString();
        }
    ...
    static class RenameSnapshotOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("RenameSnapshotOp [snapshotRoot=").append(snapshotRoot).append(", snapshotOldName=").append(snapshotOldName).append(", snapshotNewName=").append(snapshotNewName).append(", mtime=").append(mtime);
            appendRpcIdsToString(builder, rpcClientId, rpcCallId);
            builder.append("]");
            return builder.toString();
        }
    ...
    static class AddCacheDirectiveInfoOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("AddCacheDirectiveInfo [").append("id=" + directive.getId() + ",").append("path=" + directive.getPath().toUri().getPath() + ",").append("replication=" + directive.getReplication() + ",").append("pool=" + directive.getPool() + ",").append("expiration=" + directive.getExpiration().getMillis());
            appendRpcIdsToString(builder, rpcClientId, rpcCallId);
            builder.append("]");
            return builder.toString();
        }
    ...
    static class AddCachePoolOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("AddCachePoolOp [").append("poolName=" + info.getPoolName() + ",").append("ownerName=" + info.getOwnerName() + ",").append("groupName=" + info.getGroupName() + ",").append("mode=" + Short.toString(info.getMode().toShort()) + ",").append("limit=" + Long.toString(info.getLimit()));
            appendRpcIdsToString(builder, rpcClientId, rpcCallId);
            builder.append("]");
            return builder.toString();
        }
    ...
    static class AddErasureCodingPolicyOp extends FSEditLogOp {
        ...
        protected void toXml(ContentHandler contentHandler) throws SAXException {
            ...
            XMLUtils.addSaxString(contentHandler, "DATAUNITS", Integer.toString(ecPolicy.getNumDataUnits()));
            XMLUtils.addSaxString(contentHandler, "PARITYUNITS", Integer.toString(ecPolicy.getNumParityUnits()));
    ...
    static class SetStoragePolicyOp extends FSEditLogOp {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append("SetStoragePolicyOp [path=").append(path).append(", policyId=").append(policyId).append(", opCode=").append(opCode).append(", txid=").append(txid).append("]");
            return builder.toString();
        }
