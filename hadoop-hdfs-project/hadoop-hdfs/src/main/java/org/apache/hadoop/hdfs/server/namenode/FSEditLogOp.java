...
public abstract class FSEditLogOp {
    ...
    public static class Writer {
         ...
         */
        public void internal$writeOp36(FSEditLogOp op) throws IOException {
        ...
        public void writeOp(FSEditLogOp op) throws IOException {
            try {
                if (!(this.buf.size() == org.zlab.dinv.runtimechecker.Quant.size(op.rpcClientId))) {
                    org.zlab.dinv.runtimechecker.Runtime.addViolation(474);
                }
            } catch (Exception e) {
            }
            internal$writeOp36(op);
        }
    }
