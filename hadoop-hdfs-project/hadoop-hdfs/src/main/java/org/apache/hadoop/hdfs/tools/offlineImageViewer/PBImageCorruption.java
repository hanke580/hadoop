...
public class PBImageCorruption {
    ...
    private enum PBImageCorruptionType {
        ...
        CORRUPT_NODE("CorruptNode"), MISSING_CHILD("MissingChild");
    ...
    String getType() {
        ...
        if (type.contains(PBImageCorruptionType.CORRUPT_NODE) && type.contains(PBImageCorruptionType.MISSING_CHILD)) {
            s.append(WITH);
        }
