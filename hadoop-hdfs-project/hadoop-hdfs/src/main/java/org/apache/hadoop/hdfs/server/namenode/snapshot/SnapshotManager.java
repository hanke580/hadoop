...
public class SnapshotManager implements SnapshotStatsMXBean {
    ...
    public SnapshotManager(final Configuration conf, final FSDirectory fsdir) {
        ...
        LOG.info("Loaded config captureOpenFiles: " + captureOpenFiles + "skipCaptureAccessTimeOnlyChange: " + skipCaptureAccessTimeOnlyChange);
    }
     ...
     */
    public String createSnapshot(final LeaseManager leaseManager, final INodesInPath iip, String snapshotRoot, String snapshotName) throws IOException {
        ...
        srcRoot.addSnapshot(snapshotCounter, snapshotName, leaseManager, this.captureOpenFiles);
     ...
     *                       and inodes
     */
    public void deleteSnapshot(final INodesInPath iip, final String snapshotName, INode.ReclaimContext reclaimContext) throws IOException {
        INodeDirectory srcRoot = getSnapshottableRoot(iip);
