...
class Checkpointer extends Daemon {
    ...
    void doCheckpoint() throws IOException {
        ...
        if (!manifest.getLogs().isEmpty()) {
            ...
            if ((org.zlab.ocov.tracker.Runtime.updateBranch(firstRemoteLog.getStartTxId(), lastApplied + 1, ">", 21))) {
        ...
        try {
            ...
            if ((org.zlab.ocov.tracker.Runtime.updateBranch(backupNode.namesystem.getBlocksTotal(), 0, ">", 22))) {
