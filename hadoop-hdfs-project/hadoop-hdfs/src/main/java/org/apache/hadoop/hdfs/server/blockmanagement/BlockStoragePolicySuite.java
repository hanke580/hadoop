...
public class BlockStoragePolicySuite {
    ...
    public static BlockStoragePolicySuite createDefaultSuite() {
        ...
        policies[providedId] = new BlockStoragePolicy(providedId, HdfsConstants.PROVIDED_STORAGE_POLICY_NAME, new StorageType[] { StorageType.PROVIDED, StorageType.DISK }, new StorageType[] { StorageType.PROVIDED, StorageType.DISK }, new StorageType[] { StorageType.PROVIDED, StorageType.DISK });
