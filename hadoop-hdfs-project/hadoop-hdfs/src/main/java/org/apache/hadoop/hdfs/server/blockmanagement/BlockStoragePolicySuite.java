...
public class BlockStoragePolicySuite {
    ...
    public static BlockStoragePolicySuite createDefaultSuite() {
        ...
        policies[lazyPersistId] = ((BlockStoragePolicy) org.zlab.ocov.tracker.Runtime.update(new // Cannot be changed on regular files, but inherited.
        ...
        new StorageType[] { StorageType.DISK }, true), 181));
