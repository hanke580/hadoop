...
public class ClientNamenodeProtocolServerSideTranslatorPB implements ClientNamenodeProtocolPB {
    ...
    public CreateResponseProto create(RpcController controller, CreateRequestProto req) throws ServiceException {
        try {
            HdfsFileStatus result = server.create(req.getSrc(), PBHelperClient.convert(req.getMasked()), req.getClientName(), PBHelperClient.convertCreateFlag(req.getCreateFlag()), req.getCreateParent(), (short) req.getReplication(), req.getBlockSize(), PBHelperClient.convertCryptoProtocolVersions(req.getCryptoProtocolVersionList()));
            if (result != null) {
    ...
    public AddBlockResponseProto addBlock(RpcController controller, AddBlockRequestProto req) throws ServiceException {
        try {
            ...
            return AddBlockResponseProto.newBuilder().setBlock(PBHelperClient.convert(result)).build();
        } catch (IOException e) {
            throw new ServiceException(e);
        }
    }
    ...
    public GetAdditionalDatanodeResponseProto getAdditionalDatanode(RpcController controller, GetAdditionalDatanodeRequestProto req) throws ServiceException {
        try {
            ...
            return GetAdditionalDatanodeResponseProto.newBuilder().setBlock(PBHelperClient.convert(result)).build();
        } catch (IOException e) {
            throw new ServiceException(e);
        }
    }
    ...
    public ReportBadBlocksResponseProto reportBadBlocks(RpcController controller, ReportBadBlocksRequestProto req) throws ServiceException {
        try {
            ...
            server.reportBadBlocks(PBHelperClient.convertLocatedBlock(bl.toArray(new LocatedBlockProto[bl.size()])));
        } catch (IOException e) {
            throw new ServiceException(e);
        }
    ...
    public MkdirsResponseProto mkdirs(RpcController controller, MkdirsRequestProto req) throws ServiceException {
        try {
            boolean result = server.mkdirs(req.getSrc(), PBHelperClient.convert(req.getMasked()), req.getCreateParent());
    ...
    public UpdateBlockForPipelineResponseProto updateBlockForPipeline(RpcController controller, UpdateBlockForPipelineRequestProto req) throws ServiceException {
        try {
            LocatedBlockProto result = PBHelperClient.convert(server.updateBlockForPipeline(PBHelperClient.convert(req.getBlock()), req.getClientName()));
