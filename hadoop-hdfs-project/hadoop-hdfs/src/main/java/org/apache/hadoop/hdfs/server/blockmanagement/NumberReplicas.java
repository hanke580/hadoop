...
public class NumberReplicas {
    ...
    NumberReplicas(int live, int readonly, int decommissioned, int decommissioning, int corrupt, int excess, int stale, int maintenanceNotForRead, int maintenanceForRead) {
        set(live, readonly, decommissioned, decommissioning, corrupt, excess, stale, maintenanceNotForRead, maintenanceForRead);
    }

    void set(int live, int readonly, int decommissioned, int decommissioning, int corrupt, int excess, int stale, int maintenanceNotForRead, int maintenanceForRead) {
        liveReplicas = live;
