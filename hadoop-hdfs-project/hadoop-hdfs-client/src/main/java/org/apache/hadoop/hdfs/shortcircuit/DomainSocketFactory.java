...
public class DomainSocketFactory {
    ...
    public DomainSocketFactory(ShortCircuitConf conf) {
        ...
        if (feature == null) {
            ...
            if (conf.getDomainSocketPath().isEmpty()) {
                throw new HadoopIllegalArgumentException(feature + " is enabled but " + HdfsClientConfigKeys.DFS_DOMAIN_SOCKET_PATH_KEY + " is not set.");
        ...
        pathMap = CacheBuilder.newBuilder().expireAfterWrite(pathExpireSeconds, TimeUnit.SECONDS).build();
    }
     ...
     */
    public PathInfo getPathInfo(InetSocketAddress addr, ShortCircuitConf conf) throws IOException {
