...
public class ReplaceDatanodeOnFailure {
    ...
    private static final Condition CONDITION_DEFAULT = new Condition() {
        ...
        public boolean satisfy(final short replication, final DatanodeInfo[] existings, final int n, final boolean isAppend, final boolean isHflushed) {
            return replication >= 3 && (n <= (replication / 2) || isAppend || isHflushed);
        }
    };
    ...
    private interface Condition {
         ...
         */
        boolean satisfy(short replication, DatanodeInfo[] existings, int nExistings, boolean isAppend, boolean isHflushed);
    }
