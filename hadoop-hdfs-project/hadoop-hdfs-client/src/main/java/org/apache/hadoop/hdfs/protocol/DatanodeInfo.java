...
public class DatanodeInfo extends DatanodeID implements Node {
    ...
    public enum AdminStates {
        ...
        NORMAL("In Service"), DECOMMISSION_INPROGRESS("Decommission In Progress"), DECOMMISSIONED("Decommissioned"), ENTERING_MAINTENANCE("Entering Maintenance"), IN_MAINTENANCE("In Maintenance");
    ...
    public static class DatanodeInfoBuilder {
        ...
        public DatanodeInfoBuilder setAdminState(DatanodeInfo.AdminStates adminState) {
            this.adminState = adminState;
            return this;
        }
