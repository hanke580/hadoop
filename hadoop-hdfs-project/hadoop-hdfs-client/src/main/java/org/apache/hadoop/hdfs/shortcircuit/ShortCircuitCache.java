...
public class ShortCircuitCache implements Closeable {
            ...
            try {
                ...
                while (!evictable.isEmpty()) {
                    ...
                    if (evictionTimeMs + maxNonMmappedEvictableLifespanMs >= curMs)
                        break;
                    ShortCircuitReplica replica = (ShortCircuitReplica) evictable.get(eldestKey);
    ...
    public interface CacheVisitor {
        ...
        void visit(int numOutstandingMmaps, Map<ExtendedBlockId, ShortCircuitReplica> replicas, Map<ExtendedBlockId, InvalidToken> failedLoads, LinkedMap evictable, LinkedMap evictableMmapped);
    }
