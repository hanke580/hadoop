...
public class LocatedBlock {
    ...
    private static class ProvidedLastComparator implements Comparator<DatanodeInfoWithStorage>, Serializable {
        ...
        public int compare(DatanodeInfoWithStorage dns1, DatanodeInfoWithStorage dns2) {
            if (StorageType.PROVIDED.equals(dns1.getStorageType()) && !StorageType.PROVIDED.equals(dns2.getStorageType())) {
                return 1;
            }
            if (!StorageType.PROVIDED.equals(dns1.getStorageType()) && StorageType.PROVIDED.equals(dns2.getStorageType())) {
                return -1;
    ...
    public LocatedBlock(ExtendedBlock b, DatanodeInfo[] locs, String[] storageIDs, StorageType[] storageTypes, long startOffset, boolean corrupt, DatanodeInfo[] cachedLocs) {
        this(b, convert(locs, storageIDs, storageTypes), storageIDs, storageTypes, startOffset, corrupt, null == cachedLocs || 0 == cachedLocs.length ? EMPTY_LOCS : cachedLocs);
    }
