...
public class BlockMetadataHeader {
     ...
     */
    public static DataChecksum readDataChecksum(FileInputStream inputStream, int bufSize, File metaFile) throws IOException {
    ...
    public static DataChecksum readDataChecksum(final DataInputStream metaIn, final Object name) throws IOException {
        ...
        org.zlab.ocov.tracker.Runtime.update(header, 139, metaIn, name);
    ...
    private static BlockMetadataHeader readHeader(short version, DataInputStream in) throws IOException {
        ...
        org.zlab.ocov.tracker.Runtime.update(checksum, 132, version, in);
    ...
    public static void writeHeader(DataOutputStream out, DataChecksum checksum) throws IOException {
        writeHeader(out, ((BlockMetadataHeader) org.zlab.ocov.tracker.Runtime.update(new BlockMetadataHeader(VERSION, checksum), 138, out, checksum)));
    }
