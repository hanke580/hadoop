...
public abstract class Event {
    ...
    public static class CloseEvent extends Event {
        ...
        public String toString() {
            return "CloseEvent [path=" + path + ", fileSize=" + fileSize + ", timestamp=" + timestamp + "]";
        }
    }
    ...
    public static class CreateEvent extends Event {
        ...
        public String toString() {
            ...
            content.append("CreateEvent [INodeType=").append(iNodeType).append(", path=").append(path).append(", ctime=").append(ctime).append(", replication=").append(replication).append(", ownerName=").append(ownerName).append(", groupName=").append(groupName).append(", perms=").append(perms).append(", ");
            if (symlinkTarget != null) {
                content.append("symlinkTarget=").append(symlinkTarget).append(", ");
            }
            content.append("overwrite=").append(overwrite).append(", defaultBlockSize=").append(defaultBlockSize).append(", erasureCoded=").append(erasureCoded).append("]");
    ...
    public static class MetadataUpdateEvent extends Event {
        ...
        public String toString() {
            StringBuilder content = new StringBuilder();
            content.append("MetadataUpdateEvent [path=").append(path).append(", metadataType=").append(metadataType);
            switch(metadataType) {
                case TIMES:
                    content.append(", mtime=").append(mtime).append(", atime=").append(atime);
                    break;
                case REPLICATION:
                    content.append(", replication=").append(replication);
                    break;
                case OWNER:
                    content.append(", ownerName=").append(ownerName).append(", groupName=").append(groupName);
                    break;
                case PERMS:
                ...
                case ACLS:
                    ...
                    break;
                case XATTRS:
                    content.append(", xAttrs=").append(xAttrs).append(", xAttrsRemoved=").append(xAttrsRemoved);
                    break;
                default:
                    break;
            }
    ...
    public static class RenameEvent extends Event {
        ...
        @InterfaceStability.Unstable
        public String toString() {
            return "RenameEvent [srcPath=" + srcPath + ", dstPath=" + dstPath + ", timestamp=" + timestamp + "]";
        }
    }
    ...
    public static class TruncateEvent extends Event {
        ...
        @InterfaceStability.Unstable
        public String toString() {
            return "TruncateEvent [path=" + path + ", fileSize=" + fileSize + ", timestamp=" + timestamp + "]";
        }
    }
}
