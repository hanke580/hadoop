...
public class AddErasureCodingPolicyResponse {
    ...
    public AddErasureCodingPolicyResponse(ErasureCodingPolicy policy, String errorMsg) {
        this.policy = policy;
        this.errorMsg = errorMsg;
        this.succeed = false;
    }

    public AddErasureCodingPolicyResponse(ErasureCodingPolicy policy, HadoopIllegalArgumentException e) {
