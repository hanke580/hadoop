...
public class SnapshotDiffReportGenerator {
     ...
     */
    public static final Comparator<DiffReportListingEntry> INODE_COMPARATOR = new Comparator<DiffReportListingEntry>() {

        @Override
        public int compare(DiffReportListingEntry left, DiffReportListingEntry right) {
   ...
   */
    static class ChildrenDiff {
        ...
        ChildrenDiff(List<DiffReportListingEntry> createdList, List<DiffReportListingEntry> deletedList) {
    ...
    public SnapshotDiffReportGenerator(String snapshotRoot, String fromSnapshot, String toSnapshot, boolean isFromEarlier, List<DiffReportListingEntry> mlist, List<DiffReportListingEntry> clist, List<DiffReportListingEntry> dlist) {
    ...
    private List<DiffReportEntry> generateReport(DiffReportListingEntry modified) {
        List<DiffReportEntry> diffReportList = new ChunkedArrayList<>();
