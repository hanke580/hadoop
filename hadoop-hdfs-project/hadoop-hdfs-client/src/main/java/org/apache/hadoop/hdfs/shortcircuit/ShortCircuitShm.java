...
public class ShortCircuitShm {
    ...
    synchronized public final Slot registerSlot(int slotIdx, ExtendedBlockId blockId) throws InvalidRequestException {
        ...
        try {
            this.left_84 = (slotIdx);
            this.right_84 = (slots.length);
        } catch (Exception e) {
            this.left_84 = 0L;
            this.right_84 = 0L;
        }
    ...
    private long right_84;

    private long right_83;

    private long left_84;

    private long right_82;

    private long left_83;

    private long left_82;
}
