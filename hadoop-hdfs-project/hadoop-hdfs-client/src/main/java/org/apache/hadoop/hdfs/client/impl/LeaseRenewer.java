...
public class LeaseRenewer {
     ...
     */
    public static LeaseRenewer getInstance(final String authority, final UserGroupInformation ugi, final DFSClient dfsc) {
    ...
    @VisibleForTesting
    public static void setLeaseRenewerGraceDefault(long leaseRenewerGraceDefault) {
