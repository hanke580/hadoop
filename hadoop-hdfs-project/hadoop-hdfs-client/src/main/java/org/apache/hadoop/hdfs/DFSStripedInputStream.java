...
public class DFSStripedInputStream extends DFSInputStream {
    ...
    DFSStripedInputStream(DFSClient dfsClient, String src, boolean verifyChecksum, ErasureCodingPolicy ecPolicy, LocatedBlocks locatedBlocks) throws IOException {
        ...
        ErasureCoderOptions coderOptions = new ErasureCoderOptions(dataBlkNum, parityBlkNum);
        decoder = CodecUtil.createRawDecoder(dfsClient.getConfiguration(), ecPolicy.getCodecName(), coderOptions);
    ...
    public synchronized void seek(long targetPos) throws IOException {
        try {
            this.left_77 = (targetPos);
            this.right_77 = (getFileLength());
        } catch (Exception e) {
            this.left_77 = 0L;
            this.right_77 = 0L;
        }
        ...
        try {
            this.left_79 = (targetPos);
            this.right_79 = (blockEnd);
        } catch (Exception e) {
            this.left_79 = 0L;
            this.right_79 = 0L;
        }
    ...
    private long right_79;

    private long right_78;

    private long right_77;

    private long left_78;

    private long right_76;

    private long left_77;

    private long left_79;

    private long left_76;

    private long right_81;

    private long right_80;

    private long left_81;

    private long left_80;
}
