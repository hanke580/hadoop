...
public final class ReencryptionStatus {
    ...
    public static final BatchedListEntries<ZoneReencryptionStatus> EMPTY_LIST = new BatchedListEntries<>(Lists.newArrayList(), false);
     ...
     */
    private boolean addZoneIfNecessary(final Long zoneId, final String name, final ReencryptionInfoProto reProto) {
    ...
    public void updateZoneStatus(final Long zoneId, final String zonePath, final ReencryptionInfoProto reProto) {
