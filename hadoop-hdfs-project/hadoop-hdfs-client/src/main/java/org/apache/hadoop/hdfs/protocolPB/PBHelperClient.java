...
public class PBHelperClient {
    ...
    public static CachePoolInfoProto convert(CachePoolInfo info) {
        ...
        org.zlab.ocov.tracker.Runtime.update(builder, 144);
        ...
        if (info.getMaxRelativeExpiryMs() != null) {
            ...
            org.zlab.ocov.tracker.Runtime.update(builder, 145);
        }
        return builder.build();
    }
    ...
    public static CacheDirectiveInfoProto convert(CacheDirectiveInfo info) {
        ...
        if (info.getExpiration() != null) {
            ...
            org.zlab.ocov.tracker.Runtime.update(builder, 146);
        }
        return builder.build();
    }
    ...
    public static CacheDirectiveInfo convert(CacheDirectiveInfoProto proto) {
        CacheDirectiveInfo.Builder builder = ((CacheDirectiveInfo.Builder) org.zlab.ocov.tracker.Runtime.update(new CacheDirectiveInfo.Builder(), 147));
        if (proto.hasId()) {
    ...
    public static QuotaUsage convert(QuotaUsageProto qu) {
        ...
        QuotaUsage.Builder builder = ((QuotaUsage.Builder) org.zlab.ocov.tracker.Runtime.update(new QuotaUsage.Builder(), 148));
