...
public class PBHelperClient {
    ...
    public static Token<BlockTokenIdentifier> convert(TokenProto blockToken) {
        return (Token<BlockTokenIdentifier>) ShadedProtobufHelper.tokenFromProto(blockToken);
    }
    ...
    public static List<AclEntry> convertAclEntry(List<AclEntryProto> aclSpec) {
        ...
        for (AclEntryProto e : aclSpec) {
            ...
            org.zlab.ocov.tracker.Runtime.update(builder, 197);
            if (e.hasName()) {
    ...
    public static CachePoolInfoProto convert(CachePoolInfo info) {
        ...
        org.zlab.ocov.tracker.Runtime.update(builder, 198);
        ...
        if (info.getMaxRelativeExpiryMs() != null) {
            ...
            org.zlab.ocov.tracker.Runtime.update(builder, 199);
        }
        return builder.build();
    }
    ...
    public static CacheDirectiveInfoProto convert(CacheDirectiveInfo info) {
        ...
        if (info.getExpiration() != null) {
            ...
            org.zlab.ocov.tracker.Runtime.update(builder, 200);
        }
        return builder.build();
    }
    ...
    public static CacheDirectiveInfo convert(CacheDirectiveInfoProto proto) {
        CacheDirectiveInfo.Builder builder = ((CacheDirectiveInfo.Builder) org.zlab.ocov.tracker.Runtime.update(new CacheDirectiveInfo.Builder(), 201));
        if (proto.hasId()) {
        ...
        if (proto.hasExpiration()) {
            ...
            org.zlab.ocov.tracker.Runtime.update(builder, 202);
        }
        return builder.build();
    }
    ...
    public static SnapshotStatus[] convert(HdfsProtos.SnapshotListingProto sdlp) {
        if (sdlp == null) {
            return null;
        }
    ...
    public static SnapshotStatus convert(HdfsProtos.SnapshotStatusProto sdirStatusProto) {
        if (sdirStatusProto == null) {
            return null;
        }
        final HdfsFileStatusProto status = sdirStatusProto.getDirStatus();
    ...
    public static QuotaUsage convert(QuotaUsageProto qu) {
        ...
        QuotaUsage.Builder builder = ((QuotaUsage.Builder) org.zlab.ocov.tracker.Runtime.update(new QuotaUsage.Builder(), 203));
    ...
    public static HdfsProtos.SnapshotListingProto convert(SnapshotStatus[] status) {
        if (status == null) {
            return null;
        }
