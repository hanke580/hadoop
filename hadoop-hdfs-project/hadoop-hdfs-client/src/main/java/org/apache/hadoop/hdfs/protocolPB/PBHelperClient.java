...
public class PBHelperClient {
    ...
    public static CacheDirectiveInfo convert(CacheDirectiveInfoProto proto) {
        CacheDirectiveInfo.Builder builder = ((CacheDirectiveInfo.Builder) org.zlab.ocov.tracker.Runtime.update(new CacheDirectiveInfo.Builder(), 155));
        if (proto.hasId()) {
        ...
        if (proto.hasExpiration()) {
            ...
            org.zlab.ocov.tracker.Runtime.update(builder, 156);
        }
        return builder.build();
    }
