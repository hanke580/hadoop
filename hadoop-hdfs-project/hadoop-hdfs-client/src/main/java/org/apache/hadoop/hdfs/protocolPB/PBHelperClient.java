...
public class PBHelperClient {
    ...
    public static CacheDirectiveInfo convert(CacheDirectiveInfoProto proto) {
        CacheDirectiveInfo.Builder builder = ((CacheDirectiveInfo.Builder) org.zlab.ocov.tracker.Runtime.update(new CacheDirectiveInfo.Builder(), 151));
        if (proto.hasId()) {
        ...
        if (proto.hasExpiration()) {
            ...
            org.zlab.ocov.tracker.Runtime.update(builder, 152);
        }
        return builder.build();
    }
    ...
    public static QuotaUsage convert(QuotaUsageProto qu) {
        ...
        QuotaUsage.Builder builder = ((QuotaUsage.Builder) org.zlab.ocov.tracker.Runtime.update(new QuotaUsage.Builder(), 153));
    ...
    public static List<HdfsFileStatus> convertHdfsFileStatus(List<HdfsFileStatusProto> fs) {
        if (fs == null) {
            return null;
        }
