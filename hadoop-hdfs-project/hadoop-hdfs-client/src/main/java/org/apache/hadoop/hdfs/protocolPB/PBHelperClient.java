...
public class PBHelperClient {
    ...
    public static CacheDirectiveInfo convert(CacheDirectiveInfoProto proto) {
        CacheDirectiveInfo.Builder builder = ((CacheDirectiveInfo.Builder) org.zlab.ocov.tracker.Runtime.update(new CacheDirectiveInfo.Builder(), 88));
        if (proto.hasId()) {
    ...
    public static QuotaUsage convert(QuotaUsageProto qu) {
        ...
        QuotaUsage.Builder builder = ((QuotaUsage.Builder) org.zlab.ocov.tracker.Runtime.update(new QuotaUsage.Builder(), 89));
