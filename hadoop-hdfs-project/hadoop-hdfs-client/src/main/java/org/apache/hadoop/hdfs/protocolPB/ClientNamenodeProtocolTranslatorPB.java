...
public class ClientNamenodeProtocolTranslatorPB implements ProtocolMetaInterface, ClientProtocol, Closeable, ProtocolTranslator {
    ...
    private final static GetFsReplicatedBlockStatsRequestProto VOID_GET_FS_REPLICATED_BLOCK_STATS_REQUEST = GetFsReplicatedBlockStatsRequestProto.newBuilder().build();

    private final static GetFsECBlockGroupStatsRequestProto VOID_GET_FS_ECBLOCKGROUP_STATS_REQUEST = GetFsECBlockGroupStatsRequestProto.newBuilder().build();
    ...
    private final static UpgradeStatusRequestProto VOID_UPGRADE_STATUS_REQUEST = UpgradeStatusRequestProto.newBuilder().build();
    ...
    private final static GetErasureCodingPoliciesRequestProto VOID_GET_EC_POLICIES_REQUEST = GetErasureCodingPoliciesRequestProto.newBuilder().build();

    private final static GetErasureCodingCodecsRequestProto VOID_GET_EC_CODEC_REQUEST = GetErasureCodingCodecsRequestProto.newBuilder().build();
    ...
    public LocatedBlocks getBlockLocations(String src, long offset, long length) throws IOException {
        ...
        GetBlockLocationsResponseProto resp = ipc(() -> rpcProxy.getBlockLocations(null, req));
    ...
    public FsServerDefaults getServerDefaults() throws IOException {
        ...
        return PBHelperClient.convert(ipc(() -> rpcProxy.getServerDefaults(null, req).getServerDefaults()));
    }
    ...
    public LocatedBlock addBlock(String src, String clientName, ExtendedBlock previous, DatanodeInfo[] excludeNodes, long fileId, String[] favoredNodes, EnumSet<AddBlockFlag> addBlockFlags) throws IOException {
        ...
        return PBHelperClient.convertLocatedBlockProto(ipc(() -> rpcProxy.addBlock(null, req.build())).getBlock());
    }
    ...
    public LocatedBlock getAdditionalDatanode(String src, long fileId, ExtendedBlock blk, DatanodeInfo[] existings, String[] existingStorageIDs, DatanodeInfo[] excludes, int numAdditionalNodes, String clientName) throws IOException {
        ...
        return PBHelperClient.convertLocatedBlockProto(ipc(() -> rpcProxy.getAdditionalDatanode(null, req)).getBlock());
    }
    ...
    public BatchedDirectoryListing getBatchedListing(String[] srcs, byte[] startAfter, boolean needLocation) throws IOException {
        ...
        GetBatchedListingResponseProto result = ipc(() -> rpcProxy.getBatchedListing(null, req));
    ...
    public void renewLease(String clientName, List<String> namespaces) throws IOException {
        RenewLeaseRequestProto.Builder builder = RenewLeaseRequestProto.newBuilder().setClientName(clientName);
    ...
    public long[] getStats() throws IOException {
        return PBHelperClient.convert(ipc(() -> rpcProxy.getFsStats(null, VOID_GET_FSSTATUS_REQUEST)));
    }

    @Override
    public ReplicatedBlockStats getReplicatedBlockStats() throws IOException {
        return PBHelperClient.convert(ipc(() -> rpcProxy.getFsReplicatedBlockStats(null, VOID_GET_FS_REPLICATED_BLOCK_STATS_REQUEST)));
    }

    @Override
    public ECBlockGroupStats getECBlockGroupStats() throws IOException {
        return PBHelperClient.convert(ipc(() -> rpcProxy.getFsECBlockGroupStats(null, VOID_GET_FS_ECBLOCKGROUP_STATS_REQUEST)));
    }
    ...
    public DatanodeInfo[] getDatanodeReport(DatanodeReportType type) throws IOException {
        ...
        return PBHelperClient.convert(ipc(() -> rpcProxy.getDatanodeReport(null, req)).getDiList());
    }
    ...
    public DatanodeStorageReport[] getDatanodeStorageReport(DatanodeReportType type) throws IOException {
        ...
        return PBHelperClient.convertDatanodeStorageReports(ipc(() -> rpcProxy.getDatanodeStorageReport(null, req).getDatanodeStorageReportsList()));
    }
    ...
    public long rollEdits() throws IOException {
        RollEditsResponseProto resp = ipc(() -> rpcProxy.rollEdits(null, VOID_ROLLEDITS_REQUEST));
    ...
    public boolean upgradeStatus() throws IOException {
        final UpgradeStatusResponseProto proto = ipc(() -> rpcProxy.upgradeStatus(null, VOID_UPGRADE_STATUS_REQUEST));
    ...
    public RollingUpgradeInfo rollingUpgrade(RollingUpgradeAction action) throws IOException {
        ...
        final RollingUpgradeResponseProto proto = ipc(() -> rpcProxy.rollingUpgrade(null, r));
    ...
    public CorruptFileBlocks listCorruptFileBlocks(String path, String cookie) throws IOException {
        ...
        return PBHelperClient.convert(ipc(() -> rpcProxy.listCorruptFileBlocks(null, req.build())).getCorrupt());
    }
    ...
    public HdfsLocatedFileStatus getLocatedFileInfo(String src, boolean needBlockToken) throws IOException {
        ...
        GetLocatedFileInfoResponseProto res = ipc(() -> rpcProxy.getLocatedFileInfo(null, req));
    ...
    public ContentSummary getContentSummary(String path) throws IOException {
        ...
        return PBHelperClient.convert(ipc(() -> rpcProxy.getContentSummary(null, req)).getSummary());
    }
    ...
    public LocatedBlock updateBlockForPipeline(ExtendedBlock block, String clientName) throws IOException {
        ...
        return PBHelperClient.convertLocatedBlockProto(ipc(() -> rpcProxy.updateBlockForPipeline(null, req)).getBlock());
    }
    ...
    public Token<DelegationTokenIdentifier> getDelegationToken(Text renewer) throws IOException {
        ...
        GetDelegationTokenResponseProto resp = ipc(() -> rpcProxy.getDelegationToken(null, req));
    ...
    public DataEncryptionKey getDataEncryptionKey() throws IOException {
        GetDataEncryptionKeyResponseProto rsp = ipc(() -> rpcProxy.getDataEncryptionKey(null, VOID_GET_DATA_ENCRYPTIONKEY_REQUEST));
    ...
    public SnapshottableDirectoryStatus[] getSnapshottableDirListing() throws IOException {
        ...
        GetSnapshottableDirListingResponseProto result = ipc(() -> rpcProxy.getSnapshottableDirListing(null, req));
    ...
    public SnapshotStatus[] getSnapshotListing(String path) throws IOException {
        ...
        GetSnapshotListingResponseProto result = ipc(() -> rpcProxy.getSnapshotListing(null, req));
    ...
    public SnapshotDiffReport getSnapshotDiffReport(String snapshotRoot, String fromSnapshot, String toSnapshot) throws IOException {
        ...
        GetSnapshotDiffReportResponseProto result = ipc(() -> rpcProxy.getSnapshotDiffReport(null, req));
    ...
    public SnapshotDiffReportListing getSnapshotDiffReportListing(String snapshotRoot, String fromSnapshot, String toSnapshot, byte[] startPath, int index) throws IOException {
        ...
        GetSnapshotDiffReportListingResponseProto result = ipc(() -> rpcProxy.getSnapshotDiffReportListing(null, req));
        return PBHelperClient.convert(result.getDiffReport());
    }
    ...
    public void removeCacheDirective(long id) throws IOException {
        ipc(() -> rpcProxy.removeCacheDirective(null, RemoveCacheDirectiveRequestProto.newBuilder().setId(id).build()));
    }
    ...
    public BatchedEntries<CacheDirectiveEntry> listCacheDirectives(long prevId, CacheDirectiveInfo filter) throws IOException {
        ...
        return new BatchedCacheEntries(ipc(() -> rpcProxy.listCacheDirectives(null, ListCacheDirectivesRequestProto.newBuilder().setPrevId(prevId).setFilter(PBHelperClient.convert(f)).build())));
    }
    ...
    public void removeCachePool(String cachePoolName) throws IOException {
        ipc(() -> rpcProxy.removeCachePool(null, RemoveCachePoolRequestProto.newBuilder().setPoolName(cachePoolName).build()));
    }
    ...
    public BatchedEntries<CachePoolEntry> listCachePools(String prevKey) throws IOException {
        return new BatchedCachePoolEntries(ipc(() -> rpcProxy.listCachePools(null, ListCachePoolsRequestProto.newBuilder().setPrevPoolName(prevKey).build())));
    }
    ...
    public EncryptionZone getEZForPath(String src) throws IOException {
        ...
        final EncryptionZonesProtos.GetEZForPathResponseProto response = ipc(() -> rpcProxy.getEZForPath(null, req));
        if (response.hasZone()) {
    ...
    public BatchedEntries<EncryptionZone> listEncryptionZones(long id) throws IOException {
        ...
        EncryptionZonesProtos.ListEncryptionZonesResponseProto response = ipc(() -> rpcProxy.listEncryptionZones(null, req));
    ...
    @Override
    public ECTopologyVerifierResult getECTopologyResultForPolicies(final String... policyNames) throws IOException {
        ...
        GetECTopologyResultForPoliciesResponseProto response = ipc(() -> rpcProxy.getECTopologyResultForPolicies(null, req));
    ...
    @Override
    public BatchedEntries<ZoneReencryptionStatus> listReencryptionStatus(long id) throws IOException {
        final ListReencryptionStatusRequestProto req = ListReencryptionStatusRequestProto.newBuilder().setId(id).build();
        ListReencryptionStatusResponseProto response = ipc(() -> rpcProxy.listReencryptionStatus(null, req));
    ...
    public BlockStoragePolicy getStoragePolicy(String path) throws IOException {
        ...
        return PBHelperClient.convert(ipc(() -> rpcProxy.getStoragePolicy(null, request)).getStoragePolicy());
    }

    @Override
    public BlockStoragePolicy[] getStoragePolicies() throws IOException {
        GetStoragePoliciesResponseProto response = ipc(() -> rpcProxy.getStoragePolicies(null, VOID_GET_STORAGE_POLICIES_REQUEST));
    ...
    public AddErasureCodingPolicyResponse[] addErasureCodingPolicies(ErasureCodingPolicy[] policies) throws IOException {
        ...
        AddErasureCodingPoliciesResponseProto rep = ipc(() -> rpcProxy.addErasureCodingPolicies(null, req));
    ...
    public ErasureCodingPolicyInfo[] getErasureCodingPolicies() throws IOException {
        GetErasureCodingPoliciesResponseProto response = ipc(() -> rpcProxy.getErasureCodingPolicies(null, VOID_GET_EC_POLICIES_REQUEST));
    ...
    public Map<String, String> getErasureCodingCodecs() throws IOException {
        GetErasureCodingCodecsResponseProto response = ipc(() -> rpcProxy.getErasureCodingCodecs(null, VOID_GET_EC_CODEC_REQUEST));
    ...
    public ErasureCodingPolicy getErasureCodingPolicy(String src) throws IOException {
        ...
        GetErasureCodingPolicyResponseProto response = ipc(() -> rpcProxy.getErasureCodingPolicy(null, req));
    ...
    public QuotaUsage getQuotaUsage(String path) throws IOException {
        ...
        return PBHelperClient.convert(ipc(() -> rpcProxy.getQuotaUsage(null, req)).getUsage());
    }
    ...
    public BatchedEntries<OpenFileEntry> listOpenFiles(long prevId, EnumSet<OpenFilesType> openFilesTypes, String path) throws IOException {
        ...
        req.setPath(path);
        ListOpenFilesResponseProto response = ipc(() -> rpcProxy.listOpenFiles(null, req.build()));
    ...
    public DatanodeInfo[] getSlowDatanodeReport() throws IOException {
        GetSlowDatanodeReportRequestProto req = GetSlowDatanodeReportRequestProto.newBuilder().build();
        return PBHelperClient.convert(ipc(() -> rpcProxy.getSlowDatanodeReport(null, req)).getDatanodeInfoProtoList());
    }
    ...
    public HAServiceProtocol.HAServiceState getHAServiceState() throws IOException {
        ...
        HAServiceStateProto res = ipc(() -> rpcProxy.getHAServiceState(null, req)).getState();
        switch(res) {
            case ACTIVE:
    ...
    public Path getEnclosingRoot(String filename) throws IOException {
        final GetEnclosingRootRequestProto.Builder builder = GetEnclosingRootRequestProto.newBuilder();
        builder.setFilename(filename);
        final GetEnclosingRootRequestProto req = builder.build();
        try {
            final GetEnclosingRootResponseProto response = rpcProxy.getEnclosingRoot(null, req);
