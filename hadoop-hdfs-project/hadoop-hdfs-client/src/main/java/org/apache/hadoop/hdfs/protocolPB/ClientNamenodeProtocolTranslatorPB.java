...
public class ClientNamenodeProtocolTranslatorPB implements ProtocolMetaInterface, ClientProtocol, Closeable, ProtocolTranslator {
    ...
    public HdfsFileStatus create(String src, FsPermission masked, String clientName, EnumSetWritable<CreateFlag> flag, boolean createParent, short replication, long blockSize, CryptoProtocolVersion[] supportedVersions) throws IOException {
        ...
        org.zlab.ocov.tracker.Runtime.update(req, 84);
        try {
    ...
    public boolean truncate(String src, long newLength, String clientName) throws IOException {
        ...
        org.zlab.ocov.tracker.Runtime.update(req, 85);
        try {
    ...
    public LastBlockWithStatus append(String src, String clientName, EnumSetWritable<CreateFlag> flag) throws IOException {
        ...
        try {
            ...
            LocatedBlock lastBlock = res.hasBlock() ? PBHelperClient.convert(res.getBlock()) : null;
    ...
    public boolean setReplication(String src, short replication) throws IOException {
        ...
        org.zlab.ocov.tracker.Runtime.update(req, 86);
        try {
    ...
    public LocatedBlock getAdditionalDatanode(String src, long fileId, ExtendedBlock blk, DatanodeInfo[] existings, String[] existingStorageIDs, DatanodeInfo[] excludes, int numAdditionalNodes, String clientName) throws IOException {
        ...
        try {
            return PBHelperClient.convert(rpcProxy.getAdditionalDatanode(null, req).getBlock());
        } catch (ServiceException e) {
            throw ProtobufHelper.getRemoteException(e);
        }
    }
    ...
    public void reportBadBlocks(LocatedBlock[] blocks) throws IOException {
        ReportBadBlocksRequestProto req = ReportBadBlocksRequestProto.newBuilder().addAllBlocks(Arrays.asList(PBHelperClient.convertLocatedBlock(blocks))).build();
        try {
    ...
    public boolean mkdirs(String src, FsPermission masked, boolean createParent) throws IOException {
        MkdirsRequestProto req = MkdirsRequestProto.newBuilder().setSrc(src).setMasked(PBHelperClient.convert(masked)).setCreateParent(createParent).build();
        try {
    ...
    public void setTimes(String src, long mtime, long atime) throws IOException {
        ...
        org.zlab.ocov.tracker.Runtime.update(req, 87);
        try {
    ...
    public LocatedBlock updateBlockForPipeline(ExtendedBlock block, String clientName) throws IOException {
        ...
        try {
            return PBHelperClient.convert(rpcProxy.updateBlockForPipeline(null, req).getBlock());
        } catch (ServiceException e) {
            throw ProtobufHelper.getRemoteException(e);
        }
    }
    ...
    public BatchedEntries<OpenFileEntry> listOpenFiles(long prevId) throws IOException {
        ListOpenFilesRequestProto req = ListOpenFilesRequestProto.newBuilder().setId(prevId).build();
        try {
