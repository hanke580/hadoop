...
public class HttpFSParametersProvider extends ParametersProvider {
    ...
    static {
        PARAMS_DEF.put(Operation.OPEN, new Class[] { OffsetParam.class, LenParam.class, NoRedirectParam.class });
        ...
        PARAMS_DEF.put(Operation.GETFILECHECKSUM, new Class[] { NoRedirectParam.class });
        ...
        PARAMS_DEF.put(Operation.APPEND, new Class[] { DataParam.class, NoRedirectParam.class });
        ...
        PARAMS_DEF.put(Operation.CREATE, new Class[] { PermissionParam.class, OverwriteParam.class, ReplicationParam.class, BlockSizeParam.class, DataParam.class, UnmaskedPermissionParam.class, NoRedirectParam.class });
        ...
        PARAMS_DEF.put(Operation.SETOWNER, new Class[] { OwnerParam.class, GroupParam.class });
        PARAMS_DEF.put(Operation.SETPERMISSION, new Class[] { PermissionParam.class });
        PARAMS_DEF.put(Operation.SETREPLICATION, new Class[] { ReplicationParam.class });
        PARAMS_DEF.put(Operation.SETTIMES, new Class[] { ModifiedTimeParam.class, AccessTimeParam.class });
        ...
        PARAMS_DEF.put(Operation.MODIFYACLENTRIES, new Class[] { AclPermissionParam.class });
        PARAMS_DEF.put(Operation.REMOVEACLENTRIES, new Class[] { AclPermissionParam.class });
        PARAMS_DEF.put(Operation.REMOVEDEFAULTACL, new Class[] {});
        PARAMS_DEF.put(Operation.SETXATTR, new Class[] { XAttrNameParam.class, XAttrValueParam.class, XAttrSetFlagParam.class });
        PARAMS_DEF.put(Operation.REMOVEXATTR, new Class[] { XAttrNameParam.class });
        PARAMS_DEF.put(Operation.GETXATTRS, new Class[] { XAttrNameParam.class, XAttrEncodingParam.class });
        PARAMS_DEF.put(Operation.LISTXATTRS, new Class[] {});
        PARAMS_DEF.put(Operation.LISTSTATUS_BATCH, new Class[] { StartAfterParam.class });
        PARAMS_DEF.put(Operation.GETALLSTORAGEPOLICY, new Class[] {});
        PARAMS_DEF.put(Operation.GETSTORAGEPOLICY, new Class[] {});
        PARAMS_DEF.put(Operation.SETSTORAGEPOLICY, new Class[] { PolicyNameParam.class });
        ...
        PARAMS_DEF.put(Operation.CREATESNAPSHOT, new Class[] { SnapshotNameParam.class });
        PARAMS_DEF.put(Operation.DELETESNAPSHOT, new Class[] { SnapshotNameParam.class });
        PARAMS_DEF.put(Operation.RENAMESNAPSHOT, new Class[] { OldSnapshotNameParam.class, SnapshotNameParam.class });
        PARAMS_DEF.put(Operation.GETSNAPSHOTDIFF, new Class[] { OldSnapshotNameParam.class, SnapshotNameParam.class });
    ...
    public HttpFSParametersProvider() {
        super(HttpFSFileSystem.OP_PARAM, HttpFSFileSystem.Operation.class, PARAMS_DEF);
    }
    ...
    public static class OperationParam extends EnumParam<HttpFSFileSystem.Operation> {
        ...
        public OperationParam(String operation) {
            super(NAME, HttpFSFileSystem.Operation.class, HttpFSFileSystem.Operation.valueOf(StringUtils.toUpperCase(operation)));
        }
    }
    ...
    public static class UnmaskedPermissionParam extends ShortParam {
         ...
         * Parameter name.
         */
        public static final String NAME = HttpFSFileSystem.UNMASKED_PERMISSION_PARAM;
    ...
    public static class AclPermissionParam extends StringParam {
        ...
        public AclPermissionParam() {
            super(NAME, HttpFSFileSystem.ACLSPEC_DEFAULT, Pattern.compile(HttpFSServerWebApp.get().get(FileSystemAccess.class).getFileSystemConfiguration().get(HdfsClientConfigKeys.DFS_WEBHDFS_ACL_PERMISSION_PATTERN_KEY, HdfsClientConfigKeys.DFS_WEBHDFS_ACL_PERMISSION_PATTERN_DEFAULT)));
        }
    }
    ...
    public static class FsActionParam extends StringParam {
        ...
        private static final Pattern FSACTION_PATTERN = Pattern.compile(FILE_SYSTEM_ACTION);
