...
public class FileSystemAccessService extends BaseService implements FileSystemAccess {
    ...
    private ConcurrentHashMap<String, CachedFileSystem> fsCache = new ConcurrentHashMap<String, CachedFileSystem>();
    ...
    @Override
    public FileSystem createFileSystem(String user, final Configuration conf) throws IOException, FileSystemAccessException {
