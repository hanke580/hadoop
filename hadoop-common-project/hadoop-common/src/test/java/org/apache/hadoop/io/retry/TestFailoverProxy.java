...
public class TestFailoverProxy {
    ...
    private static FlipFlopProxyProvider<UnreliableInterface> newFlipFlopProxyProvider(TypeOfExceptionToFailWith t1, TypeOfExceptionToFailWith t2) {
    ...
    @Test
    public void testSuccedsOnceThenFailOver() throws UnreliableException, IOException, StandbyException {
