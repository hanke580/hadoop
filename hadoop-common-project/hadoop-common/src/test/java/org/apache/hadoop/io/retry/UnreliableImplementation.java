...
class UnreliableImplementation implements UnreliableInterface {
    ...
    private int failsOnceInvocationCount, failsOnceWithValueInvocationCount, failsOnceIOExceptionInvocationCount, failsOnceRemoteExceptionInvocationCount, failsTenTimesInvocationCount, failsWithSASLExceptionTenTimesInvocationCount, failsWithAccessControlExceptionInvocationCount, succeedsOnceThenFailsCount, succeedsOnceThenFailsIdempotentCount, succeedsTenTimesThenFailsCount;
    ...
    public enum TypeOfExceptionToFailWith {
        ...
        UNRELIABLE_EXCEPTION, STANDBY_EXCEPTION, IO_EXCEPTION, REMOTE_EXCEPTION
    }
    ...
    @Override
    public String succeedsOnceThenFailsReturningString() throws UnreliableException, IOException, StandbyException {
    ...
    @Override
    public String succeedsTenTimesThenFailsReturningString() throws UnreliableException, IOException, StandbyException {
    ...
    @Override
    public void nonIdempotentVoidFailsIfIdentifierDoesntMatch(String identifier) throws UnreliableException, StandbyException, IOException {
        if (this.identifier.equals(identifier)) {
            return;
        } else {
            String message = "expected '" + this.identifier + "' but received '" + identifier + "'";
    ...
    private static void throwAppropriateException(TypeOfExceptionToFailWith eType, String message) throws UnreliableException, StandbyException, IOException {
        switch(eType) {
