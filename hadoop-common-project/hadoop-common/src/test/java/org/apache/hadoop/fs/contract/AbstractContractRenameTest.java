...
public abstract class AbstractContractRenameTest extends AbstractFSContractTestBase {
    ...
    public void testRenameNewFileSameDir() throws Throwable {
        ...
        assertListStatusFinds(getFileSystem(), renameTarget.getParent(), renameTarget);
    ...
    public void testRenameFileUnderFile() throws Exception {
        ...
        expectRenameUnderFileFails(action, grandparent, new Path(base, "testRenameSrc"), new Path(grandparent, "testRenameTarget"));
    }
    ...
    public void testRenameFileUnderFileSubdir() throws Exception {
        ...
        expectRenameUnderFileFails(action, grandparent, new Path(base, "testRenameSrc"), new Path(parent, "testRenameTarget"));
    }
