...
public class TestBloomMapFile {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(TestBloomMapFile.class);
    ...
    private void checkMembershipVaryingSizedKeys(List<Text> keys) throws Exception {
        ...
        BloomMapFile.Reader reader = null;
        try {
            writer = new BloomMapFile.Writer(conf, fs, qualifiedDirName.toString(), Text.class, NullWritable.class);
            for (Text key : keys) {
