...
public final class FileContextTestHelper {
   ...
   */
    ...
    public static long createFile(FileContext fc, Path path, int numBlocks, int blockSize) throws IOException {
        return createFile(fc, path, numBlocks, CreateOpts.blockSize(blockSize), CreateOpts.createParent());
    }
    ...
    public long createFileNonRecursive(FileContext fc, String name) throws IOException {
        Path path = getTestRootPath(fc, name);
        return createFileNonRecursive(fc, path);
    }

    public static long createFileNonRecursive(FileContext fc, Path path) throws IOException {
