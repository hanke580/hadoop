...
public class TestFairCallQueue {
    ...
    private void checkOverflowException(Exception ex, RpcStatusProto status, boolean failOverTriggered) {
        ...
        if (failOverTriggered) {
            assertTrue(rse.getClass().getName() + " != RetriableException", rse.getCause() instanceof StandbyException);
        } else {
