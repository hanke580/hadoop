...
public class TestSSLHttpServer extends HttpServerFunctionalTest {
    ...
    public void testIncludedProtocols() throws Exception {
        ...
        HttpsURLConnection conn = getConnectionWithPreferredProtocolSSLSocketFactory(url, includedProtocols);
        assertFalse("included protocol list is empty", includedProtocols.isEmpty());
        readFromConnection(conn);
