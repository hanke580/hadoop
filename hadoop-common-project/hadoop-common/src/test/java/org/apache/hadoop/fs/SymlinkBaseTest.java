...
public abstract class SymlinkBaseTest {
     ...
     */
    void testStatRoot() throws IOException {
     ...
     */
    void testSetWDNotResolvesLinks() throws IOException {
     ...
     */
    void testCreateDanglingLink() throws IOException {
     ...
     */
    void testCreateLinkToNullEmpty() throws IOException {
        Path link = new Path(testBaseDir1() + "/link");
        try {
     ...
     */
    void testCreateLinkCanCreateParent() throws IOException {
     ...
     */
    void testMkdirExistingLink() throws IOException {
     ...
     */
    void testCreateFileViaDanglingLinkParent() throws IOException {
     ...
     */
    void testOpenResolvesLinks() throws IOException {
     ...
     */
    void testStatLinkToFile() throws IOException {
        Path file = new Path(testBaseDir1() + "/file");
     ...
     */
    void testStatRelLinkToFile() throws IOException {
     ...
     */
    void testStatLinkToDir() throws IOException {
        Path dir = new Path(testBaseDir1());
     ...
     */
    void testStatDanglingLink() throws IOException {
        Path file = new Path("/noSuchFile");
        Path link = new Path(testBaseDir1() + "/link");
        wrapper.createSymlink(file, link, false);
     ...
     */
    void testStatNonExistentFiles() throws IOException {
     ...
     */
    void testStatNonLinks() throws IOException {
        Path dir = new Path(testBaseDir1());
        Path file = new Path(testBaseDir1() + "/file");
        createAndWriteFile(file);
        try {
     ...
     */
    void testRecursiveLinks() throws IOException {
    ...
    private void checkLink(Path linkAbs, Path expectedTarget, Path targetQual) throws IOException {
        ...
        } else // FileSystem automatically adds missing authority if scheme matches default
        if (wrapper instanceof FileSystemTestWrapper) {
            failureExpected = false;
        }
        try {
     ...
     */
    void testCreateLinkUsingRelPaths() throws IOException {
     ...
     */
    void testCreateLinkUsingAbsPaths() throws IOException {
        Path fileAbs = new Path(testBaseDir1() + "/file");
        Path linkAbs = new Path(testBaseDir1() + "/linkToFile");
        Path schemeAuth = new Path(testURI().toString());
        Path fileQual = new Path(schemeAuth, testBaseDir1() + "/file");
     ...
     */
    void testCreateLinkUsingFullyQualPaths() throws IOException {
        Path fileAbs = new Path(testBaseDir1(), "file");
        Path linkAbs = new Path(testBaseDir1(), "linkToFile");
     ...
     */
    void testCreateLinkUsingPartQualPath1() throws IOException {
     ...
     */
    void testCreateLinkUsingPartQualPath2() throws IOException {
        Path link = new Path(testBaseDir1(), "linkToFile");
     ...
     */
    void testLinkStatusAndTargetWithNonLink() throws IOException {
        Path schemeAuth = new Path(testURI().toString());
        Path dir = new Path(testBaseDir1());
     ...
     */
    void testCreateLinkToDirectory() throws IOException {
        Path dir1 = new Path(testBaseDir1());
        Path file = new Path(testBaseDir1(), "file");
     ...
     */
    void testCreateFileViaSymlink() throws IOException {
        Path dir = new Path(testBaseDir1());
        Path linkToDir = new Path(testBaseDir2(), "linkToDir");
     ...
     */
    void testCreateDirViaSymlink() throws IOException {
        Path dir1 = new Path(testBaseDir1());
     ...
     */
    void testCreateLinkViaLink() throws IOException {
        Path dir1 = new Path(testBaseDir1());
        Path file = new Path(testBaseDir1(), "file");
        Path linkToDir = new Path(testBaseDir2(), "linkToDir");
        Path fileViaLink = new Path(linkToDir, "file");
     ...
     * Test create symlink to a directory
     */
    void testListStatusUsingLink() throws IOException {
        Path file = new Path(testBaseDir1(), "file");
        Path link = new Path(testBaseDir1(), "link");
        createAndWriteFile(file);
     ...
     */
    void testCreateLinkTwice() throws IOException {
        Path file = new Path(testBaseDir1(), "file");
        Path link = new Path(testBaseDir1(), "linkToFile");
        createAndWriteFile(file);
        wrapper.createSymlink(file, link, false);
     ...
     */
    void testCreateLinkToLink() throws IOException {
        Path dir1 = new Path(testBaseDir1());
        Path file = new Path(testBaseDir1(), "file");
        Path linkToDir = new Path(testBaseDir2(), "linkToDir");
     ...
     */
    void testCreateFileDirExistingLink() throws IOException {
        Path file = new Path(testBaseDir1(), "file");
        Path link = new Path(testBaseDir1(), "linkToFile");
        createAndWriteFile(file);
        wrapper.createSymlink(file, link, false);
     ...
     */
    void testUseLinkAferDeleteLink() throws IOException {
        Path file = new Path(testBaseDir1(), "file");
        Path link = new Path(testBaseDir1(), "linkToFile");
        createAndWriteFile(file);
        wrapper.createSymlink(file, link, false);
     ...
     */
    void testCreateLinkToDot() throws IOException {
        Path dir = new Path(testBaseDir1());
        Path file = new Path(testBaseDir1(), "file");
     ...
     * Test create symlink to ..
     */
    void testCreateLinkToDotDot() throws IOException {
     ...
     */
    void testCreateLinkToDotDotPrefix() throws IOException {
        Path file = new Path(testBaseDir1(), "file");
     ...
     */
    void testRenameFileViaSymlink() throws IOException {
        Path dir = new Path(testBaseDir1());
        Path file = new Path(testBaseDir1(), "file");
        Path linkToDir = new Path(testBaseDir2(), "linkToDir");
        Path fileViaLink = new Path(linkToDir, "file");
     ...
     */
    void testRenameFileToDestViaSymlink() throws IOException {
        Path dir = new Path(testBaseDir1());
        Path file = new Path(testBaseDir1(), "file");
        Path linkToDir = new Path(testBaseDir2(), "linkToDir");
     ...
     */
    void testRenameDirViaSymlink() throws IOException {
     ...
     */
    void testRenameSymlinkViaSymlink() throws IOException {
        Path baseDir = new Path(testBaseDir1());
        Path file = new Path(testBaseDir1(), "file");
        Path link = new Path(testBaseDir1(), "link");
        Path linkToDir = new Path(testBaseDir2(), "linkToDir");
     ...
     */
    void testRenameDirToSymlinkToDir() throws IOException {
        Path dir1 = new Path(testBaseDir1());
     ...
     */
    void testRenameDirToSymlinkToFile() throws IOException {
        Path dir1 = new Path(testBaseDir1());
     ...
     */
    void testRenameDirToDanglingSymlink() throws IOException {
        Path dir = new Path(testBaseDir1());
        Path link = new Path(testBaseDir2(), "linkToFile");
     ...
     */
    void testRenameFileToSymlinkToDir() throws IOException {
        Path file = new Path(testBaseDir1(), "file");
        Path subDir = new Path(testBaseDir1(), "subDir");
        Path link = new Path(testBaseDir1(), "link");
        wrapper.mkdir(subDir, FileContext.DEFAULT_PERM, false);
     ...
     */
    void testRenameFileToSymlinkToFile() throws IOException {
     ...
     */
    void testRenameFileToDanglingSymlink() throws IOException {
     ...
     */
    void testRenameSymlinkNonExistantDest() throws IOException {
        Path file = new Path(testBaseDir1(), "file");
     ...
     */
    void testRenameSymlinkToExistingFile() throws IOException {
     ...
     */
    void testRenameSymlinkToExistingDir() throws IOException {
        Path dir1 = new Path(testBaseDir1());
        Path dir2 = new Path(testBaseDir2());
        Path subDir = new Path(testBaseDir2(), "subDir");
     ...
     * Rename a symlink
     */
    void testRenameSymlink() throws IOException {
        Path file = new Path(testBaseDir1(), "file");
        Path link1 = new Path(testBaseDir1(), "linkToFile1");
        Path link2 = new Path(testBaseDir1(), "linkToFile2");
        createAndWriteFile(file);
     ...
     */
    void testRenameSymlinkToFileItLinksTo() throws IOException {
     ...
     */
    void testRenameSymlinkToDirItLinksTo() throws IOException {
     ...
     */
    void testRenameLinkTarget() throws IOException {
        Path file = new Path(testBaseDir1(), "file");
     ...
     */
    void testRenameFileWithDestParentSymlink() throws IOException {
        Path link = new Path(testBaseDir1(), "link");
        Path file1 = new Path(testBaseDir1(), "file1");
        Path file2 = new Path(testBaseDir1(), "file2");
     ...
     */
    void testAccessFileViaInterSymlinkAbsTarget() throws IOException {
        Path baseDir = new Path(testBaseDir1());
        Path file = new Path(testBaseDir1(), "file");
     ...
     */
    void testAccessFileViaInterSymlinkQualTarget() throws IOException {
        Path baseDir = new Path(testBaseDir1());
        Path file = new Path(testBaseDir1(), "file");
        Path linkToDir = new Path(testBaseDir2(), "linkToDir");
        Path fileViaLink = new Path(linkToDir, "file");
     ...
     */
    void testAccessFileViaInterSymlinkRelTarget() throws IOException {
        assumeTrue(!"file".equals(getScheme()));
        Path dir = new Path(testBaseDir1(), "dir");
     ...
     */
    void testAccessDirViaSymlink() throws IOException {
        Path baseDir = new Path(testBaseDir1());
        Path dir = new Path(testBaseDir1(), "dir");
        Path linkToDir = new Path(testBaseDir2(), "linkToDir");
        Path dirViaLink = new Path(linkToDir, "dir");
     ...
     */
    void testSetTimesSymlinkToFile() throws IOException {
        Path file = new Path(testBaseDir1(), "file");
        Path link = new Path(testBaseDir1(), "linkToFile");
        createAndWriteFile(file);
        wrapper.createSymlink(file, link, false);
     ...
     */
    void testSetTimesSymlinkToDir() throws IOException {
        Path dir = new Path(testBaseDir1(), "dir");
        Path link = new Path(testBaseDir1(), "linkToDir");
        wrapper.mkdir(dir, FileContext.DEFAULT_PERM, false);
        wrapper.createSymlink(dir, link, false);
     ...
     */
    void testSetTimesDanglingLink() throws IOException {
        Path file = new Path("/noSuchFile");
        Path link = new Path(testBaseDir1() + "/link");
        wrapper.createSymlink(file, link, false);
        long at = wrapper.getFileLinkStatus(link).getAccessTime();
