...
public class TestGSet {
    ...
    private static LightWeightGSet<Integer, Integer> createGSet(int size, boolean resizable) {
        return resizable ? new LightWeightResizableGSet<Integer, Integer>(size) : new LightWeightGSet<Integer, Integer>(size);
    }

    private static GSet<IntElement, IntElement> createGSet(final IntElement[] data, boolean resizable) {
        final GSet<IntElement, IntElement> gset = resizable ? new LightWeightResizableGSet<IntElement, IntElement>(8) : new LightWeightGSet<IntElement, IntElement>(8);
    ...
    private static void runTestGSet(final int modulus, final int offset, boolean resizable) {
     ...
     */
    private static class IntElement implements LightWeightGSet.LinkedElement, Comparable<IntElement> {
        ...
        public boolean equals(Object obj) {
            return obj instanceof IntElement && value == ((IntElement) obj).value;
        }
