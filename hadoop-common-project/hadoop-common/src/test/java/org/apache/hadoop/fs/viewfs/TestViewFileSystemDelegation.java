 ...
 */
public class //extends ViewFileSystemTestSetup {
TestViewFileSystemDelegation {
    ...
    public static void setup() throws Exception {
        ...
        fs1 = (FakeFileSystem) getChildFileSystem((ViewFileSystem) viewFs, new URI("fs1:/"));
        fs2 = (FakeFileSystem) getChildFileSystem((ViewFileSystem) viewFs, new URI("fs2:/"));
    }

    static void setupFileSystem(URI uri, Class clazz) throws Exception {
    ...
    private static void setupMockFileSystem(Configuration config, URI uri) throws Exception {
        String scheme = uri.getScheme();
