 ...
 */
public class ExceptionInExecuteLaunchableService extends AbstractLaunchableService {
    ...
    public int execute() throws Exception {
        switch(exceptionType) {
            case SLE:
                throw new ServiceLaunchException(LauncherExitCodes.EXIT_OTHER_FAILURE, SLE_TEXT);
            case IOE:
    ...
    enum ExType {
        ...
        EX, SLE, IOE, THROWABLE
    }

    public static class IOECodedException extends IOException implements ExitCodeProvider {
