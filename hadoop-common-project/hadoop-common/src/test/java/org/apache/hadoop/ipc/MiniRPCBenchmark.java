...
public class MiniRPCBenchmark {
    ...
    public static class TestDelegationTokenSelector extends AbstractDelegationTokenSelector<TestDelegationTokenIdentifier> {
    ...
    long runMiniBenchmarkWithDelegationToken(Configuration conf, int count, String keytabKey, String userNameKey) throws IOException {
        ...
        try {
            conf.setStrings(DefaultImpersonationProvider.getTestProvider().getProxySuperuserGroupConfKey(shortUserName), GROUP_NAME_1);
