...
public class TestCompositeService {
     ...
     */
    private void assertInState(STATE expected, CompositeServiceImpl[] services, int start, int finish) {
    ...
    private void assertInState(STATE expected, Service service) {
        assertEquals("Service state should have been " + expected + " in " + service, expected, service.getServiceState());
    }
