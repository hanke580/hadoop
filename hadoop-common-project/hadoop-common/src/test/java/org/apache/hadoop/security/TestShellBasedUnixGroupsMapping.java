...
public class TestShellBasedUnixGroupsMapping {
    ...
    public long getTimeoutInterval(String timeout) {
        ...
        conf.set(CommonConfigurationKeys.HADOOP_SECURITY_GROUP_SHELL_COMMAND_TIMEOUT_KEY, timeout);
