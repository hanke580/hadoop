...
public class TestDecayRpcScheduler {
    ...
    public void testParsePeriod() {
        ...
        conf.setLong("ipc.2." + DecayRpcScheduler.IPC_FCQ_DECAYSCHEDULER_PERIOD_KEY, 1058);
    ...
    public void testParseFactor() {
        ...
        // Custom
        Configuration conf = new Configuration();
        conf.set("ipc.4." + DecayRpcScheduler.IPC_FCQ_DECAYSCHEDULER_FACTOR_KEY, "0.125");
    ...
    public void testParseThresholds() {
        ...
        conf.set("ipc.9." + DecayRpcScheduler.IPC_FCQ_DECAYSCHEDULER_THRESHOLDS_KEY, "1, 10, 20, 50, 85");
    ...
    public void testPeriodic() throws InterruptedException {
        Configuration conf = new Configuration();
        conf.set("ipc.13." + DecayRpcScheduler.IPC_FCQ_DECAYSCHEDULER_PERIOD_KEY, "10");
        conf.set("ipc.13." + DecayRpcScheduler.IPC_FCQ_DECAYSCHEDULER_FACTOR_KEY, "0.5");
    ...
    private static DecayRpcScheduler getSchedulerWithWeightedTimeCostProvider(int priorityLevels, String ns) {
        Configuration conf = new Configuration();
        conf.setClass(ns + "." + CommonConfigurationKeys.IPC_COST_PROVIDER_KEY, WeightedTimeCostProvider.class, CostProvider.class);
        conf.setLong(ns + "." + DecayRpcScheduler.IPC_SCHEDULER_DECAYSCHEDULER_PERIOD_KEY, 999999);
