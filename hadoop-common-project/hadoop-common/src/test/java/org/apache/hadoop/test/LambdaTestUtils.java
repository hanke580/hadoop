...
public final class LambdaTestUtils {
    ...
    public static int await(int timeoutMillis, Callable<Boolean> check, Callable<Integer> retry, TimeoutHandler timeoutHandler) throws Exception {
        ...
        while (running) {
            ...
            try {
                ...
                ex = null;
            } catch (InterruptedException | FailFastException | VirtualMachineError e) {
                throw e;
            } catch (Throwable e) {
    ...
    public static int await(int timeoutMillis, int intervalMillis, Callable<Boolean> check) throws Exception {
        return await(timeoutMillis, check, new FixedRetryInterval(intervalMillis), new GenerateTimeout());
    }
    ...
    public static <T> T eventually(int timeoutMillis, int intervalMillis, Callable<T> eval) throws Exception {
        return eventually(timeoutMillis, eval, new FixedRetryInterval(intervalMillis));
    }
    ...
    public static void eventually(int timeoutMillis, int intervalMillis, VoidCallable eval) throws Exception {
        eventually(timeoutMillis, eval, new FixedRetryInterval(intervalMillis));
    }
    ...
    public static <T, E extends Throwable> E intercept(Class<E> clazz, Callable<T> eval) throws Exception {
        return intercept(clazz, null, "Expected a " + clazz.getName() + " to be thrown," + " but got the result: ", eval);
    }
     ...
     * @see GenericTestUtils#assertExceptionContains(String, Throwable)
     */
    public static <T, E extends Throwable> E intercept(Class<E> clazz, String contained, String message, Callable<T> eval) throws Exception {
        E ex;
        try {
            T result = eval.call();
    ...
    public static <E extends Throwable> E intercept(Class<E> clazz, String contained, VoidCallable eval) throws Exception {
        return intercept(clazz, contained, "Expecting " + clazz.getName() + (contained != null ? (" with text " + contained) : "") + " but got ", () -> {
            eval.call();
            return "void";
        });
    }
     ...
     * @throws AssertionError if the evaluation call didn't raise an exception.
     */
    public static <E extends Throwable> E intercept(Class<E> clazz, String contained, String message, VoidCallable eval) throws Exception {
     ...
     * @param <T> type
     */
    public static <T> void assertOptionalEquals(String message, T expected, Optional<T> actual) {
     ...
     * @param <T> type
     */
    public static <T> void assertOptionalUnset(String message, Optional<T> actual) {
        Assert.assertNotNull(message, actual);
        actual.ifPresent(t -> Assert.fail("Expected empty option, got " + t.toString()));
    }
     ...
     */
    public static <T> T notNull(String message, Callable<T> eval) throws Exception {
        T t = eval.call();
     ...
     */
    public static <T> T doAs(UserGroupInformation user, Callable<T> eval) throws IOException, InterruptedException {
     ...
     * @throws InterruptedException interrupted operation.
     */
    public static void doAs(UserGroupInformation user, VoidCallable eval) throws IOException, InterruptedException {
     ...
     * a text mismatch.
     */
    public static <T, E extends Throwable> E interceptFuture(Class<E> clazz, String contained, Future<T> future) throws Exception {
     ...
     * a text mismatch.
     */
    public static <T, E extends Throwable> E interceptFuture(final Class<E> clazz, final String contained, final long timeout, final TimeUnit tu, final Future<T> future) throws Exception {
        return intercept(clazz, contained, () -> {
            try {
     ...
     */
    public static <E extends Throwable> E verifyCause(Class<E> clazz, final Throwable caught) throws Throwable {
    ...
    public static class FixedRetryInterval implements Callable<Integer> {
        ...
        public String toString() {
            final StringBuilder sb = new StringBuilder("FixedRetryInterval{");
