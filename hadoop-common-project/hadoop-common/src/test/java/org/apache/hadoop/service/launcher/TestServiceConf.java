...
public class TestServiceConf extends AbstractServiceLauncherTestBase {
    ...
    public void testUnbalancedConfArg() throws Throwable {
        assertLaunchOutcome(EXIT_COMMAND_ARGUMENT_ERROR, E_PARSE_FAILED, LaunchableRunningService.NAME, ARG_CONF_PREFIXED);
    }

    @Test
    public void testConfArgMissingFile() throws Throwable {
        assertLaunchOutcome(EXIT_COMMAND_ARGUMENT_ERROR, E_PARSE_FAILED, LaunchableRunningService.NAME, ARG_CONF_PREFIXED, "no-file.xml");
    }
