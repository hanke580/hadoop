...
public class TestSysInfoLinux {
    ...
    static {
        ...
        plugin = new FakeLinuxResourceCalculatorPlugin(FAKE_MEMFILE, FAKE_CPUFILE, FAKE_STATFILE, FAKE_NETFILE, FAKE_DISKSFILE, FAKE_JIFFY_LENGTH);
    }
