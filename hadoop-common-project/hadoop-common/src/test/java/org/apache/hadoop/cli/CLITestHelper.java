...
public class CLITestHelper {
    ...
    protected void readTestConfigFile() {
        ...
        if (testsFromConfigFile == null) {
            ...
            try {
                ...
                LOG.info("Exception while reading test config file {}:", testConfigFile, e);
                success = false;
            }
   ...
   */
    ...
    private boolean compareTestOutput(ComparatorData compdata, Result cmdResult) {
        ...
        if (testMode.equals(TESTMODE_TEST)) {
            try {
                ...
                compareOutput = comp.compare(cmdResult.getCommandOutput(), expandCommand(compdata.getExpectedOutput()));
            } catch (Exception e) {
    ...
    private boolean compareTextExitCode(ComparatorData compdata, Result cmdResult) {
