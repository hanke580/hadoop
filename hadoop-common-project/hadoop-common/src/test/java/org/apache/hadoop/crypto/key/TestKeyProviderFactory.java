...
public class TestKeyProviderFactory {
    ...
    static void checkSpecificProvider(Configuration conf, String ourUrl) throws Exception {
        ...
        assertEquals("KeyVersions should have been returned for key3.", 1, kvl.size());
        assertEquals("KeyVersions should have included key3@0.", "key3@0", kvl.get(0).getVersionName());
