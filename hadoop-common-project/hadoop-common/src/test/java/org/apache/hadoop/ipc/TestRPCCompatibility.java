...
public class TestRPCCompatibility {
    ...
    public void setUp() {
        ...
        RPC.setProtocolEngine(conf, TestProtocol0.class, ProtobufRpcEngine2.class);
        RPC.setProtocolEngine(conf, TestProtocol1.class, ProtobufRpcEngine2.class);
        RPC.setProtocolEngine(conf, TestProtocol2.class, ProtobufRpcEngine2.class);
        RPC.setProtocolEngine(conf, TestProtocol3.class, ProtobufRpcEngine2.class);
        RPC.setProtocolEngine(conf, TestProtocol4.class, ProtobufRpcEngine2.class);
    }
