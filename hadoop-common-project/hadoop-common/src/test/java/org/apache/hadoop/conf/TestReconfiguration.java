...
public class TestReconfiguration {
    ...
    private ReconfigurableBase makeReconfigurable(final Configuration oldConf, final Configuration newConf, final Collection<String> reconfigurableProperties) {
