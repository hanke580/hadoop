...
public class TestServiceLauncher extends AbstractServiceLauncherTestBase {
    ...
    public void testEx() throws Throwable {
        assertLaunchOutcome(EXIT_EXCEPTION_THROWN, OTHER_EXCEPTION_TEXT, NAME);
    }
    ...
    public void testServiceLaunchException() throws Throwable {
        assertLaunchOutcome(EXIT_OTHER_FAILURE, SLE_TEXT, NAME, ARG_THROW_SLE);
    }

    @Test
    public void testIOE() throws Throwable {
        assertLaunchOutcome(IOE_EXIT_CODE, EXIT_IN_IOE_TEXT, NAME, ARG_THROW_IOE);
    }

    @Test
    public void testThrowable() throws Throwable {
        assertLaunchOutcome(EXIT_EXCEPTION_THROWN, "java.lang.OutOfMemoryError", NAME, ARG_THROWABLE);
    }
    ...
    public void testNoArgsOneArg() throws Throwable {
        assertLaunchOutcome(EXIT_COMMAND_ARGUMENT_ERROR, "1", NoArgsAllowedService.NAME, "one");
    }

    @Test
    public void testNoArgsHasConfsStripped() throws Throwable {
        assertRuns(NoArgsAllowedService.NAME, LauncherArguments.ARG_CONF_PREFIXED, configFile(newConf()));
    }
    ...
    public void testArgBinding() throws Throwable {
        assertLaunchOutcome(EXIT_OTHER_FAILURE, "", LaunchableRunningService.NAME, LaunchableRunningService.ARG_FAILING);
    }
