...
public interface ContractOptions {
     ...
     * {@value}
     */
    String RENAME_RETURNS_FALSE_IF_DEST_EXISTS = "rename-returns-false-if-dest-exists";
     ...
     * {@value}
     */
    String RENAME_RETURNS_FALSE_IF_SOURCE_MISSING = "rename-returns-false-if-source-missing";
