...
public class CommonConfigurationKeys extends CommonConfigurationKeysPublic {
     ...
     */
    public static final int IPC_MAXIMUM_RESPONSE_LENGTH_DEFAULT = 128 * 1024 * 1024;
    ...
    public static final String IPC_CALLQUEUE_SERVER_FAILOVER_ENABLE = "callqueue.overflow.trigger.failover";

    public static final boolean IPC_CALLQUEUE_SERVER_FAILOVER_ENABLE_DEFAULT = false;
    ...
    public static final String SECURITY_ROUTER_ADMIN_PROTOCOL_ACL = "security.router.admin.protocol.acl";
     ...
     */
    public static final String HA_HM_RPC_CONNECT_MAX_RETRIES_KEY = "ha.health-monitor.rpc.connect.max.retries";
   ...
   */
     ...
     */
    public static final String ZK_RETRY_INTERVAL_MS = ZK_PREFIX + "retry-interval-ms";
     ...
     */
    public static final String HADOOP_DOMAINNAME_RESOLVER_IMPL = "hadoop.domainname.resolver.impl";

    public static final Class<? extends DomainNameResolver> HADOOP_DOMAINNAME_RESOLVER_IMPL_DEFAULT = DNSDomainNameResolver.class;
   ...
   * */
    public static final String DFS_CLIENT_IGNORE_NAMENODE_DEFAULT_KMS_URI = "dfs.client.ignore.namenode.default.kms.uri";

    public static final boolean DFS_CLIENT_IGNORE_NAMENODE_DEFAULT_KMS_URI_DEFAULT = false;
     ...
     */
    public static final String HADOOP_METRICS_JVM_USE_THREAD_MXBEAN = "hadoop.metrics.jvm.use-thread-mxbean";

    public static final boolean HADOOP_METRICS_JVM_USE_THREAD_MXBEAN_DEFAULT = false;
}
