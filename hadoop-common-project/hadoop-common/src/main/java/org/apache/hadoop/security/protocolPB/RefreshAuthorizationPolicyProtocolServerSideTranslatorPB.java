...
public class RefreshAuthorizationPolicyProtocolServerSideTranslatorPB implements RefreshAuthorizationPolicyProtocolPB {
    ...
    private final static RefreshServiceAclResponseProto VOID_REFRESH_SERVICE_ACL_RESPONSE = RefreshServiceAclResponseProto.newBuilder().build();
    ...
    @Override
    public RefreshServiceAclResponseProto refreshServiceAcl(RpcController controller, RefreshServiceAclRequestProto request) throws ServiceException {
        try {
