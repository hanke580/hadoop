...
public class WritableRpcEngine implements RpcEngine {
    ...
    private static class Invocation implements Writable, Configurable {
        ...
        public String toString() {
            ...
            buffer.append(")").append(", rpc version=" + rpcVersion).append(", client version=" + clientVersion).append(", methodsFingerPrint=" + clientMethodsHash);
    ...
    private static class Invoker implements RpcInvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            try {
                value = (ObjectWritable) client.call(RPC.RpcKind.RPC_WRITABLE, new Invocation(method, args), remoteId, fallbackToSimpleAuth, alignmentContext);
            } finally {
                if (traceScope != null)
                    traceScope.close();
            }
    ...
    public <T> ProtocolProxy<T> getProxy(Class<T> protocol, long clientVersion, InetSocketAddress addr, UserGroupInformation ticket, Configuration conf, SocketFactory factory, int rpcTimeout, RetryPolicy connectionRetryPolicy, AtomicBoolean fallbackToSimpleAuth, AlignmentContext alignmentContext) throws IOException {
        ...
        T proxy = (T) Proxy.newProxyInstance(protocol.getClassLoader(), new Class[] { protocol }, new Invoker(protocol, addr, ticket, conf, factory, rpcTimeout, fallbackToSimpleAuth, alignmentContext));
   ...
   * port and address. */
    ...
    public static class Server extends RPC.Server {
        ...
        static class WritableRpcInvoker implements RpcInvoker {
            ...
            @Override
            public Writable call(org.apache.hadoop.ipc.RPC.Server server, String protocolName, Writable rpcRequest, long receivedTime) throws IOException, RPC.VersionMismatch {
