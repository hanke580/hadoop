...
abstract public class FSInputChecker extends FSInputStream {
    ...
    public synchronized int read(byte[] b, int off, int len) throws IOException {
        try {
            this.left_42 = ((off | len | (off + len) | (b.length - (off + len))));
            this.right_42 = (0);
        } catch (Exception e) {
            this.left_42 = 0L;
            this.right_42 = 0L;
   ...
   */
    ...
    private long right_48;

    private long right_47;

    private long right_46;

    private long right_45;

    private long right_44;

    private long right_43;

    private long right_42;

    private long right_41;

    private long right_49;

    private long left_49;

    private long left_48;

    private long left_45;

    private long left_44;

    private long left_47;

    private long left_46;

    private long right_40;

    private long left_41;

    private long left_40;
