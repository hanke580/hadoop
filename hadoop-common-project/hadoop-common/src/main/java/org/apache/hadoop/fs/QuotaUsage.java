...
public class QuotaUsage {
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + (int) (fileAndDirectoryCount ^ (fileAndDirectoryCount >>> 32));
    ...
    protected static final String QUOTA_HEADER = String.format(QUOTA_STRING_FORMAT + SPACE_QUOTA_STRING_FORMAT, (Object[]) QUOTA_HEADER_FIELDS);
