...
public class AclStatus {
    ...
    public String toString() {
        return new StringBuilder().append("owner: ").append(owner).append(", group: ").append(group).append(", acl: {").append("entries: ").append(entries).append(", stickyBit: ").append(stickyBit).append('}').toString();
    }
    ...
    public static class Builder {
        ...
        public Builder addEntries(Iterable<AclEntry> entries) {
            for (AclEntry e : entries) this.entries.add(e);
            return this;
        }
