...
public class RSRawEncoder extends RawErasureEncoder {
    ...
    protected void doEncode(ByteArrayEncodingState encodingState) {
        ...
        RSUtil.encodeData(gfTables, encodingState.encodeLength, encodingState.inputs, encodingState.inputOffsets, encodingState.outputs, encodingState.outputOffsets);
    }
}
