...
final class BCFile {
    ...
    static public class Reader implements Closeable {
        ...
        static private final class RBlockState {
            ...
            public RBlockState(Algorithm compressionAlgo, FSDataInputStream fsin, BlockRegion region, Configuration conf) throws IOException {
                ...
                try {
                    this.in = compressAlgo.createDecompressionStream(new BoundedRangeFileInputStream(fsin, this.region.getOffset(), this.region.getCompressedSize()), decompressor, TFile.getFSInputBufferSize(conf));
                } catch (IOException e) {
    ...
    static final class Magic {
        ...
        private final static byte[] AB_MAGIC_BCFILE = { // ... total of 16 bytes
        (byte) 0xd1, (byte) 0x11, (byte) 0xd3, (byte) 0x68, (byte) 0x91, (byte) 0xb5, (byte) 0xd7, (byte) 0xb6, (byte) 0x39, (byte) 0xdf, (byte) 0x41, (byte) 0x40, (byte) 0x92, (byte) 0xba, (byte) 0xe1, (byte) 0x50 };
