...
public class ProxyUsers {
    ...
    private static ImpersonationProvider getInstance(Configuration conf) {
        Class<? extends ImpersonationProvider> clazz = conf.getClass(CommonConfigurationKeysPublic.HADOOP_SECURITY_IMPERSONATION_PROVIDER_CLASS, DefaultImpersonationProvider.class, ImpersonationProvider.class);
    ...
    public static void refreshSuperUserGroupsConfiguration() {
        ...
        refreshSuperUserGroupsConfiguration(((Configuration) org.zlab.ocov.tracker.Runtime.update(new Configuration(), 211)));
    }
