...
public class InterruptEscalator implements IrqHandler.Interrupted {
    ...
    public String toString() {
        ...
        sb.append(", shutdownTimeMillis=").append(shutdownTimeMillis).append(", forcedShutdownTimedOut=").append(forcedShutdownTimedOut).append('}');
        return sb.toString();
    }
    ...
    public void interrupted(IrqHandler.InterruptData interruptData) {
        ...
        if (service != null) {
            ...
            ServiceForcedShutdown shutdown = new ServiceForcedShutdown(service, shutdownTimeMillis);
    ...
    protected static class ServiceForcedShutdown implements Runnable {
        ...
        public void run() {
            if (service != null) {
                service.stop();
                serviceWasShutdown.set(service.waitForServiceToStop(shutdownTimeMillis));
            } else {
