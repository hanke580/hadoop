...
public class FsLinkResolution<T> extends FSLinkResolver<T> {
    ...
    @Override
    public T next(final AbstractFileSystem fs, final Path p) throws UnresolvedLinkException, IOException {
    ...
    public interface FsLinkResolutionFunction<T> {
         ...
         */
        T apply(final AbstractFileSystem fs, final Path path) throws IOException, UnresolvedLinkException;
    }
     ...
     * @throws IOException other IO failure.
     */
    public static <T> T resolve(final FileContext fileContext, final Path path, final FsLinkResolutionFunction<T> fn) throws UnresolvedLinkException, IOException {
