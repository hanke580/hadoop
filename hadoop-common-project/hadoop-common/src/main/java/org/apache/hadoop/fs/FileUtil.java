...
public class FileUtil {
   ...
   */
        ...
        try {
            ...
            Future output = executor.submit(() -> {
                try {
                    ...
                    if (LOG.isDebugEnabled()) {
                        ...
                        org.apache.commons.io.IOUtils.copy(process.getInputStream(), new IOUtils.NullOutputStream());
                    }
                } catch (IOException e) {
            ...
            Future error = executor.submit(() -> {
                try {
                    ...
                    if (LOG.isDebugEnabled()) {
                        // Log directly to avoid out of memory errors
                        try (BufferedReader reader = new BufferedReader(new InputStreamReader(process.getErrorStream(), Charset.forName("UTF-8")))) {
                            String line;
                            while ((line = reader.readLine()) != null) {
                                LOG.debug(line);
                            }
                        ...
                        org.apache.commons.io.IOUtils.copy(process.getErrorStream(), new IOUtils.NullOutputStream());
                    }
                } catch (IOException e) {
                    LOG.debug(e.getMessage());
                }
    ...
    private static void unTarUsingTar(File inFile, File untarDir, boolean gzipped) throws IOException {
        ...
        if (gzipped) {
            untarCommand.append(" gzip -dc '").append(FileUtil.makeSecureShellPath(inFile)).append("' | (");
        }
    ...
    static void unTarUsingJava(File inFile, File untarDir, boolean gzipped) throws IOException {
        ...
        try {
            if (gzipped) {
                inputStream = new GZIPInputStream(Files.newInputStream(inFile.toPath()));
            } else {
    ...
    private static void unpackEntries(TarArchiveInputStream tis, TarArchiveEntry entry, File outputDir) throws IOException {
        ...
        if (entry.isSymbolicLink()) {
            ...
            Files.createSymbolicLink(FileSystems.getDefault().getPath(outputDir.getPath(), entry.getName()), FileSystems.getDefault().getPath(entry.getLinkName()));
            return;
        }
     ...
     */
    public static FileSystem write(final FileSystem fs, final Path path, final byte[] bytes) throws IOException {
     ...
     * @throws IOException if an I/O error occurs creating or writing to the file
     */
    public static FileContext write(final FileContext fileContext, final Path path, final byte[] bytes) throws IOException {
        Objects.requireNonNull(path);
        Objects.requireNonNull(bytes);
     ...
     * @throws IOException if an I/O error occurs creating or writing to the file
     */
    public static FileSystem write(final FileSystem fs, final Path path, final Iterable<? extends CharSequence> lines, final Charset cs) throws IOException {
        Objects.requireNonNull(path);
     ...
     * @throws IOException if an I/O error occurs creating or writing to the file
     */
    public static FileContext write(final FileContext fileContext, final Path path, final Iterable<? extends CharSequence> lines, final Charset cs) throws IOException {
        Objects.requireNonNull(path);
        Objects.requireNonNull(lines);
        Objects.requireNonNull(cs);
        CharsetEncoder encoder = cs.newEncoder();
     ...
     * @throws IOException if an I/O error occurs creating or writing to the file
     */
    public static FileSystem write(final FileSystem fs, final Path path, final CharSequence charseq, final Charset cs) throws IOException {
        Objects.requireNonNull(path);
     ...
     * @throws IOException if an I/O error occurs creating or writing to the file
     */
    public static FileContext write(final FileContext fs, final Path path, final CharSequence charseq, final Charset cs) throws IOException {
        Objects.requireNonNull(path);
        Objects.requireNonNull(charseq);
        Objects.requireNonNull(cs);
        CharsetEncoder encoder = cs.newEncoder();
     ...
     * @throws IOException if an I/O error occurs creating or writing to the file
     */
    public static FileSystem write(final FileSystem fs, final Path path, final CharSequence charseq) throws IOException {
     ...
     * @throws IOException if an I/O error occurs creating or writing to the file
     */
    public static FileContext write(final FileContext fileContext, final Path path, final CharSequence charseq) throws IOException {
