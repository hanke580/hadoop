...
public abstract class Server {
    ...
    void logSlowRpcCalls(String methodName, Call call, long processingTime) {
        ...
        if ((rpcMetrics.getProcessingSampleCount() > minSampleSize) && (processingTime > threeSigma)) {
            LOG.warn("Slow RPC : {} took {} {} to process from client {}", methodName, processingTime, RpcMetrics.TIMEUNIT, call);
   ...
   */
    ...
    public class Connection {
        ...
        private void processRpcRequest(RpcRequestHeaderProto header, RpcWritable.Buffer buffer) throws RpcServerException, InterruptedException {
            ...
            if (alignmentContext != null && call.rpcRequest != null && (call.rpcRequest instanceof ProtobufRpcEngine.RpcProtobufRequest)) {
                ...
                String methodName;
                String protoName;
                ProtobufRpcEngine.RpcProtobufRequest req = (ProtobufRpcEngine.RpcProtobufRequest) call.rpcRequest;
                try {
        ...
        public void run() {
            ...
            while (running) {
                ...
                try {
                    ...
                    if ((org.zlab.ocov.tracker.Runtime.updateBranch(alignmentContext != null && call.isCallCoordinated() && call.getClientStateId() > alignmentContext.getLastSeenStateId(), 33))) {
                        /*
