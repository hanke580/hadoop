...
public class DtUtilShell extends CommandShell {
    ...
    private static final String FORMAT_SUBSTRING = "[-format (" + DtFileOperations.FORMAT_JAVA + "|" + DtFileOperations.FORMAT_PB + ")]";

    public static final String DT_USAGE = "hadoop dtutil " + "[-keytab <keytab_file> -principal <principal_name>] " + "subcommand (help|print|get|edit|append|cancel|remove|renew) " + FORMAT_SUBSTRING + " [-alias <alias>] filename...";
    ...
    private class Get extends SubCommand {
        ...
        public static final String GET_USAGE = "dtutil get URL " + "[-service <scheme>] " + FORMAT_SUBSTRING + "[-alias <alias>] [-renewer <renewer>] filename";
        ...
        @Override
        public void execute() throws Exception {
            DtFileOperations.getTokenFile(firstFile, format, alias, service, url, renewer, getConf());
        }
    ...
    private class Edit extends SubCommand {
        ...
        public static final String EDIT_USAGE = "dtutil edit -service <service> -alias <alias> " + FORMAT_SUBSTRING + "filename...";
        ...
        public void execute() throws Exception {
            for (File tokenFile : tokenFiles) {
                DtFileOperations.aliasTokenFile(tokenFile, format, alias, service, getConf());
            }
        }
    ...
    private class Append extends SubCommand {
        ...
        public static final String APPEND_USAGE = "dtutil append " + FORMAT_SUBSTRING + "filename...";
    ...
    private class Remove extends SubCommand {
        ...
        public static final String REMOVE_USAGE = "dtutil remove -alias <alias> " + FORMAT_SUBSTRING + " filename...";

        public static final String CANCEL_USAGE = "dtutil cancel -alias <alias> " + FORMAT_SUBSTRING + " filename...";
        ...
        public void execute() throws Exception {
            for (File tokenFile : tokenFiles) {
                DtFileOperations.removeTokenFromFile(cancel, tokenFile, format, alias, getConf());
            }
        }
    ...
    private class Import extends SubCommand {
        ...
        public static final String IMPORT_USAGE = "dtutil import <base64> [-alias <alias>] " + FORMAT_SUBSTRING + " filename";
        ...
        @Override
        public void execute() throws Exception {
            DtFileOperations.importTokenFile(firstFile, format, alias, base64, getConf());
        }
