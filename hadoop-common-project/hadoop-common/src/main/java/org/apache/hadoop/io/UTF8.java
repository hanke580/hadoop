...
public class UTF8 implements WritableComparable<UTF8> {
    ...
    public void set(String string) {
        try {
            this.left_26 = (string.length());
            this.right_26 = (0xffff / 3);
        } catch (Exception e) {
            this.left_26 = 0L;
            this.right_26 = 0L;
        }
    ...
    public void readFields(DataInput in) throws IOException {
        ...
        try {
            this.left_29 = (bytes.length);
            this.right_29 = (length);
        } catch (Exception e) {
            this.left_29 = 0L;
            this.right_29 = 0L;
        }
    ...
    private long right_26;

    private long left_27;

    private long left_26;

    private long left_29;

    private long left_28;

    private long right_29;

    private long right_28;

    private long right_27;
}
