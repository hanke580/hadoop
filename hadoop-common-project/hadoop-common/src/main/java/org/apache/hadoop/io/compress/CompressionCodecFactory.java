...
public class CompressionCodecFactory {
    ...
    public static final Logger LOG = LoggerFactory.getLogger(CompressionCodecFactory.class.getName());
    ...
    public String toString() {
        ...
        if (itr.hasNext()) {
            ...
            buf.append(entry.getKey()).append(": ").append(entry.getValue().getClass().getName());
            while (itr.hasNext()) {
                entry = itr.next();
                buf.append(", ").append(entry.getKey()).append(": ").append(entry.getValue().getClass().getName());
            }
        }
        buf.append(" }");
        return buf.toString();
    ...
    public static void setCodecClasses(Configuration conf, List<Class> classes) {
        ...
        if (itr.hasNext()) {
            ...
            while (itr.hasNext()) {
                buf.append(',').append(itr.next().getName());
            }
        }
