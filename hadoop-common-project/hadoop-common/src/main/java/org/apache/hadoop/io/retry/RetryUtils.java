...
public class RetryUtils {
     ...
     */
    public static RetryPolicy getDefaultRetryPolicy(Configuration conf, String retryPolicyEnabledKey, boolean defaultRetryPolicyEnabled, String retryPolicySpecKey, String defaultRetryPolicySpec, final String remoteExceptionToRetry) {
        ...
        if (multipleLinearRandomRetry == null) {
            ...
            return new WrapperRetryPolicy((MultipleLinearRandomRetry) multipleLinearRandomRetry, remoteExceptionToRetry);
        }
    }
    ...
    private static final class WrapperRetryPolicy implements RetryPolicy {
        ...
        private WrapperRetryPolicy(final MultipleLinearRandomRetry multipleLinearRandomRetry, final String remoteExceptionToRetry) {
            this.multipleLinearRandomRetry = multipleLinearRandomRetry;
            this.remoteExceptionToRetry = remoteExceptionToRetry;
        }

        @Override
        public RetryAction shouldRetry(Exception e, int retries, int failovers, boolean isMethodIdempotent) throws Exception {
