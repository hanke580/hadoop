...
public class ProtobufWrapperLegacy extends RpcWritable {
    ...
    public ProtobufWrapperLegacy(Object message) {
        Preconditions.checkArgument(isUnshadedProtobufMessage(message), "message class is not an unshaded protobuf message %s", message.getClass());
    ...
    public void writeTo(ResponseBuffer out) throws IOException {
        ...
        length += com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(length);
    ...
    protected <T> T readFrom(ByteBuffer bb) throws IOException {
        ...
        com.google.protobuf.CodedInputStream cis = com.google.protobuf.CodedInputStream.newInstance(bb.array(), bb.position() + bb.arrayOffset(), bb.remaining());
        try {
