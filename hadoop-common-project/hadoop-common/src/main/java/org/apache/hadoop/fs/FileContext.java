...
public class FileContext {
   ...
   */
    ...
    public void mkdir(final Path dir, final FsPermission permission, final boolean createParent) throws AccessControlException, FileAlreadyExistsException, FileNotFoundException, ParentNotDirectoryException, UnsupportedFileSystemException, IOException {
        ...
        final FsPermission absFerms = (permission == null ? FsPermission.getDirDefault() : permission).applyUMask(umask);
     ...
     */
        ...
        public FileStatus[] globStatus(Path pathPattern) throws AccessControlException, UnsupportedFileSystemException, IOException {
            return ((Globber) org.zlab.ocov.tracker.Runtime.update(new Globber(FileContext.this, pathPattern, DEFAULT_FILTER), 162, pathPattern)).glob();
        }
