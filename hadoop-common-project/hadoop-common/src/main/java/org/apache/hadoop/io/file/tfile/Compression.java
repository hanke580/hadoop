    ...
    public enum Algorithm {
        ...
        LZO(TFile.COMPRESSION_LZO) {
            ...
            private String getLzoCodecClass() {
                ...
                String extClazz = (extClazzConf != null) ? extClazzConf : System.getProperty(CONF_LZO_CLASS);
            ...
            CompressionCodec getCodec() throws IOException {
                if (!isSupported()) {
                    throw new IOException(String.format("LZO codec %s=%s could not be loaded", CONF_LZO_CLASS, clazz), cnf);
                }
                return codec;
            }
