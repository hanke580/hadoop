...
public class ProcessingDetails {
    ...
    public enum Timing {
        ...
        // time for reader to insert in call queue.
        ENQUEUE,
        // time in the call queue.
        QUEUE,
        // handler overhead not spent in processing/response.
        HANDLER,
        // time handler spent processing the call. always equal to
        PROCESSING,
        // lock_free + lock_wait + lock_shared + lock_exclusive
        // processing with no lock.
        LOCKFREE,
        // processing while waiting for lock.
        LOCKWAIT,
        // processing with a read lock.
        LOCKSHARED,
        // processing with a write lock.
        LOCKEXCLUSIVE,
        // time to encode and send response.
        RESPONSE
    }
    ...
    public String toString() {
        ...
        for (Timing type : Timing.values()) {
            ...
            sb.append(type.name().toLowerCase()).append("Time=").append(get(type));
        }
        return sb.toString();
    }
}
