...
public class WeightedRoundRobinMultiplexer implements RpcMultiplexer {
    ...
    public static final Logger LOG = LoggerFactory.getLogger(WeightedRoundRobinMultiplexer.class);
    ...
    private void moveToNextQueue() {
        ...
        LOG.debug("Moving to next queue from queue index {} to index {}, " + "number of requests left for current queue: {}.", thisIdx, nextIdx, requestsLeft);
    }
