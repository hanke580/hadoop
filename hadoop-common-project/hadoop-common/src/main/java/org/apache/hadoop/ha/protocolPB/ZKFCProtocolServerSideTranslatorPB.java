...
public class ZKFCProtocolServerSideTranslatorPB implements ZKFCProtocolPB {
    ...
    @Override
    public CedeActiveResponseProto cedeActive(RpcController controller, CedeActiveRequestProto request) throws ServiceException {
        try {
    ...
    @Override
    public GracefulFailoverResponseProto gracefulFailover(RpcController controller, GracefulFailoverRequestProto request) throws ServiceException {
        try {
