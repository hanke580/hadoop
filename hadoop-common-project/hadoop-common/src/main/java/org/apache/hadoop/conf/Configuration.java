...
public class Configuration implements Iterable<Map.Entry<String, String>>, Writable {
    ...
    private void updatePropertiesWithDeprecatedKeys(DeprecationContext deprecations, String[] newNames) {
    ...
    public static class IntegerRanges implements Iterable<Integer> {
        ...
        private static class RangeNumberIterator implements Iterator<Integer> {
            ...
            private long right_67;

            private long left_67;
        }
     ...
     */
    private CredentialEntry getCredentialEntry(CredentialProvider provider, String name) throws IOException {
            ...
            if (providers != null) {
                for (CredentialProvider provider : providers) {
                    try {
                        ...
                        throw new IOException("Can't get key " + name + " from key provider" + "of type: " + provider.getClass().getName() + ".", ioe);
                    }
                }
            }
        } catch (IOException ioe) {
    ...
    protected synchronized Properties getProps() {
        if (properties == null) {
            ...
            Map<String, String[]> backup = updatingResource != null ? new ConcurrentHashMap<String, String[]>(updatingResource) : null;
    ...
    private XMLStreamReader2 getStreamReader(Resource wrapper, boolean quiet) throws XMLStreamException, IOException {
        Object resource = wrapper.getResource();
        ...
        if (resource instanceof URL) {
            ...
            if (file.exists()) {
                ...
                reader = (XMLStreamReader2) parse(new BufferedInputStream(Files.newInputStream(file.toPath())), ((Path) resource).toString(), isRestricted);
            }
    ...
    private static class ParsedItem {
        ...
        ParsedItem(String name, String key, String value, boolean isFinal, String[] sources) {
            this.name = name;
            this.key = key;
            this.value = value;
     ...
     */
    private synchronized Document asXmlDocument(@Nullable String propertyName) throws IOException, IllegalArgumentException {
        Document doc;
        try {
    ...
    public void write(DataOutput out) throws IOException {
        ...
        for (Map.Entry<Object, Object> item : props.entrySet()) {
            ...
            WritableUtils.writeCompressedStringArray(out, updatingResource != null ? updatingResource.get(item.getKey()) : null);
        }
    }
