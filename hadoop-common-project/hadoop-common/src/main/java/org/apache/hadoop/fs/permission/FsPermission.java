...
public class FsPermission implements Writable, Serializable, ObjectInputValidation {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof FsPermission) {
            ...
            return this.useraction == that.useraction && this.groupaction == that.groupaction && this.otheraction == that.otheraction && this.stickyBit.booleanValue() == that.stickyBit.booleanValue();
        }
        return false;
    }
    ...
    public static FsPermission valueOf(String unixSymbolicPermission) {
        if (unixSymbolicPermission == null) {
            ...
            throw new IllegalArgumentException(String.format("length != %d(unixSymbolicPermission=%s)", MAX_PERMISSION_LENGTH, unixSymbolicPermission));
        }
        int n = 0;
