...
public class LocalDirAllocator {
    ...
    public LocalDirAllocator(String contextCfgItemName) {
        ...
        try {
            this.diskValidator = DiskValidatorFactory.getInstance(BasicDiskValidator.NAME);
    ...
    private AllocatorPerContext obtainContext(String contextCfgItemName) {
        synchronized (contexts) {
            ...
            if (l == null) {
                contexts.put(contextCfgItemName, (l = new AllocatorPerContext(contextCfgItemName, diskValidator)));
            }
            return l;
        }
    }
