...
public class FileEncryptionInfo implements Serializable {
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("{").append("cipherSuite: " + cipherSuite).append(", cryptoProtocolVersion: " + version).append(", edek: " + Hex.encodeHexString(edek)).append(", iv: " + Hex.encodeHexString(iv)).append(", keyName: " + keyName).append(", ezKeyVersionName: " + ezKeyVersionName).append("}");
