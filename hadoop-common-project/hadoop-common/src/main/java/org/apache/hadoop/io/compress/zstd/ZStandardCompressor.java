...
public class ZStandardCompressor implements Compressor {
    ...
    @VisibleForTesting
    ZStandardCompressor() {
        this(CommonConfigurationKeys.IO_COMPRESSION_CODEC_ZSTD_LEVEL_DEFAULT, CommonConfigurationKeysPublic.IO_FILE_BUFFER_SIZE_DEFAULT);
    }
    ...
    public int compress(byte[] b, int off, int len) throws IOException {
        ...
        compressedDirectBuf.limit(directBufferSize);
        // Compress data
        n = deflateBytesDirect(uncompressedDirectBuf, uncompressedDirectBufOff, uncompressedDirectBufLen, compressedDirectBuf, directBufferSize);
    ...
    private native int deflateBytesDirect(ByteBuffer src, int srcOffset, int srcLen, ByteBuffer dst, int dstLen);
