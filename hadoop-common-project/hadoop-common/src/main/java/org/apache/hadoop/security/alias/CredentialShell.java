...
public class CredentialShell extends CommandShell {
    ...
    private class CheckCommand extends Command {
        ...
        public void execute() throws IOException, NoSuchAlgorithmException {
            ...
            warnIfTransientProvider();
            getOut().println("Checking aliases for CredentialProvider: " + provider.toString());
            try {
                ...
                getOut().println("Cannot check aliases for CredentialProvider: " + provider.toString() + ": " + e.getMessage());
                throw e;
            }
        }
    ...
    private class CreateCommand extends Command {
        ...
        public void execute() throws IOException, NoSuchAlgorithmException {
            ...
            try {
                ...
                getOut().println("Credential " + alias + " has NOT been created. " + e.getMessage());
                throw e;
            } catch (IOException e) {
                getOut().println("Credential " + alias + " has NOT been created. " + e.getMessage());
                throw e;
