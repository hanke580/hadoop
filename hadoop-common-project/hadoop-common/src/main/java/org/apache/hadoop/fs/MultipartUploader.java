...
public abstract class MultipartUploader implements Closeable {
     ...
     * @throws IOException IO failure
     */
    public abstract PartHandle putPart(Path filePath, InputStream inputStream, int partNumber, UploadHandle uploadId, long lengthInBytes) throws IOException;
     ...
     * @throws IOException IO failure
     */
    public abstract PathHandle complete(Path filePath, Map<Integer, PartHandle> handles, UploadHandle multipartUploadId) throws IOException;
     ...
     * @throws IOException IO failure
     */
    public abstract void abort(Path filePath, UploadHandle multipartUploadId) throws IOException;
