...
public abstract class AbstractFileSystem implements PathCapabilities {
    ...
    public void checkPath(Path path) {
        ...
        if (thisPort != thatPort) {
            throw new InvalidPathException("Wrong FS: " + path + " and port=" + thatPort + ", expected: " + this.getUri() + " with port=" + thisPort);
        }
    }
    ...
    public Path getHomeDirectory() {
        ...
        return new Path("/user/" + username).makeQualified(getUri(), null);
    }
     ...
     */
    public abstract void mkdir(final Path dir, final FsPermission permission, final boolean createParent) throws AccessControlException, FileAlreadyExistsException, FileNotFoundException, UnresolvedLinkException, IOException;
     ...
     * this file system.
     */
    public abstract boolean delete(final Path f, final boolean recursive) throws AccessControlException, FileNotFoundException, UnresolvedLinkException, IOException;
     ...
     * file system.
     */
    public abstract FSDataInputStream open(final Path f, int bufferSize) throws AccessControlException, FileNotFoundException, UnresolvedLinkException, IOException;
     ...
     */
    public abstract boolean setReplication(final Path f, final short replication) throws AccessControlException, FileNotFoundException, UnresolvedLinkException, IOException;
     ...
     */
    public abstract void renameInternal(final Path src, final Path dst) throws AccessControlException, FileAlreadyExistsException, FileNotFoundException, ParentNotDirectoryException, UnresolvedLinkException, IOException;
     ...
     */
    public abstract void setPermission(final Path f, final FsPermission permission) throws AccessControlException, FileNotFoundException, UnresolvedLinkException, IOException;
     ...
     */
    public abstract void setOwner(final Path f, final String username, final String groupname) throws AccessControlException, FileNotFoundException, UnresolvedLinkException, IOException;
     ...
     * for this file system.
     */
    public abstract void setTimes(final Path f, final long mtime, final long atime) throws AccessControlException, FileNotFoundException, UnresolvedLinkException, IOException;
     ...
     * this file system.
     */
    public abstract FileChecksum getFileChecksum(final Path f) throws AccessControlException, FileNotFoundException, UnresolvedLinkException, IOException;
     ...
     */
    public abstract FileStatus getFileStatus(final Path f) throws AccessControlException, FileNotFoundException, UnresolvedLinkException, IOException;
     ...
     */
    public abstract BlockLocation[] getFileBlockLocations(final Path f, final long start, final long len) throws AccessControlException, FileNotFoundException, UnresolvedLinkException, IOException;
     ...
     * for this file system.
     */
    public abstract FileStatus[] listStatus(final Path f) throws AccessControlException, FileNotFoundException, UnresolvedLinkException, IOException;
    ...
    public void satisfyStoragePolicy(final Path path) throws IOException {
        throw new UnsupportedOperationException(getClass().getSimpleName() + " doesn't support satisfyStoragePolicy");
    }
     ...
     */
    public CompletableFuture<FSDataInputStream> openFileWithOptions(Path path, final OpenFileParameters parameters) throws IOException {
