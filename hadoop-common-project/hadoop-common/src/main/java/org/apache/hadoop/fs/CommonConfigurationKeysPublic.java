...
public class CommonConfigurationKeysPublic {
     ...
     * core-default.xml</a>
     */
    public static final String FS_GETSPACEUSED_CLASSNAME = "fs.getspaceused.classname";
     ...
     * core-default.xml</a>
     */
    public static final String FS_GETSPACEUSED_JITTER_KEY = "fs.getspaceused.jitterMillis";
     ...
     * core-default.xml</a>
     */
    public static final String IPC_SERVER_REUSEADDR_KEY = "ipc.server.reuseaddr";
     ...
     * instead.
     */
    public static final String HADOOP_SECURITY_GROUP_SHELL_COMMAND_TIMEOUT_SECS = HADOOP_SECURITY_GROUP_SHELL_COMMAND_TIMEOUT_KEY;
     ...
     * instead.
     */
    public static final long HADOOP_SECURITY_GROUP_SHELL_COMMAND_TIMEOUT_SECS_DEFAULT = HADOOP_SECURITY_GROUP_SHELL_COMMAND_TIMEOUT_DEFAULT;
    ...
    public static final String HADOOP_TOKENS = "hadoop.tokens";
     ...
     * core-default.xml</a>
     */
    public static final String HADOOP_KERBEROS_KEYTAB_LOGIN_AUTORENEWAL_ENABLED = "hadoop.kerberos.keytab.login.autorenewal.enabled";

    /**
     * Default value for HADOOP_KERBEROS_KEYTAB_LOGIN_AUTORENEWAL_ENABLED.
     */
    public static final boolean HADOOP_KERBEROS_KEYTAB_LOGIN_AUTORENEWAL_ENABLED_DEFAULT = false;
    ...
    public static final String HADOOP_SECURITY_CRYPTO_CODEC_CLASSES_AES_CTR_NOPADDING_KEY = HADOOP_SECURITY_CRYPTO_CODEC_CLASSES_KEY_PREFIX + CipherSuite.AES_CTR_NOPADDING.getConfigSuffix();

    public static final String HADOOP_SECURITY_CRYPTO_CODEC_CLASSES_AES_CTR_NOPADDING_DEFAULT = OpensslAesCtrCryptoCodec.class.getName() + "," + JceAesCtrCryptoCodec.class.getName();
    ...
    public static final long HADOOP_SHELL_SAFELY_DELETE_LIMIT_NUM_FILES_DEFAULT = 100;
    ...
    public static final String HADOOP_SECURITY_SENSITIVE_CONFIG_KEYS_DEFAULT = String.join(",", "secret$", "password$", "ssl.keystore.pass$", "fs.s3.*[Ss]ecret.?[Kk]ey", "fs.s3a.*.server-side-encryption.key", "fs.azure\\.account.key.*", "credential$", "oauth.*secret", "oauth.*password", "oauth.*token", HADOOP_SECURITY_SENSITIVE_CONFIG_KEYS);
     ...
     * core-default.xml</a>
     */
    public static final String HADOOP_PROMETHEUS_ENABLED = "hadoop.prometheus.endpoint.enabled";
