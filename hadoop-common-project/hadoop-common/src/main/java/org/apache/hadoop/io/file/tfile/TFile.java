...
public class TFile {
    ...
    // 64KB
    private static final int MAX_KEY_SIZE = 64 * 1024;
    ...
    public static class Reader implements Closeable {
        ...
        public Scanner createScannerByKey(byte[] beginKey, byte[] endKey) throws IOException {
            return createScannerByKey((beginKey == null) ? null : new ByteArray(beginKey, 0, beginKey.length), (endKey == null) ? null : new ByteArray(endKey, 0, endKey.length));
        }
