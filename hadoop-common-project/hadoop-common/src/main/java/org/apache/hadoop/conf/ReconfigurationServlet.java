...
public class ReconfigurationServlet extends HttpServlet {
    ...
    private Reconfigurable getReconfigurable(HttpServletRequest req) {
        ...
        return (Reconfigurable) this.getServletContext().getAttribute(CONF_SERVLET_RECONFIGURABLE_PREFIX + req.getServletPath());
    }
     ...
     */
    private void applyChanges(PrintWriter out, Reconfigurable reconf, HttpServletRequest req) throws ReconfigurationException {
        Configuration oldConf = reconf.getConf();
        Configuration newConf = new Configuration();
        ...
        synchronized (oldConf) {
            while (params.hasMoreElements()) {
                ...
                String value = StringEscapeUtils.unescapeHtml4(req.getParameter(rawParam));
                if (value != null) {
