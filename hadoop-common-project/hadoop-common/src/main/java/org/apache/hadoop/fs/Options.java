...
public final class Options {
    ...
    public static class HandleOpt {
        ...
        public static class Data extends HandleOpt {
            ...
            public String toString() {
                ...
                sb.append("data(allowChange=").append(allowChanged).append(")");
                return sb.toString();
            }
        }
        ...
        public static class Location extends HandleOpt {
            ...
            public String toString() {
                StringBuilder sb = new StringBuilder();
                sb.append("loc(allowChange=").append(allowChanged).append(")");
                return sb.toString();
            }
        }
    }
    ...
    public enum ChecksumCombineMode {
        ...
        // MD5 of block checksums, which are MD5 over chunk CRCs
        MD5MD5CRC,
        // Block/chunk-independent composite CRC
        COMPOSITE_CRC
    }
}
