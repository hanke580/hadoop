...
public class CpuTimeTracker {
    ...
    public void updateElapsedJiffies(BigInteger elapsedJiffies, long newTime) {
        ...
        cumulativeCpuTime = newValue.compareTo(cumulativeCpuTime) >= 0 ? newValue : cumulativeCpuTime;
        sampleTime = newTime;
    }
    ...
    public String toString() {
        ...
        sb.append("SampleTime " + this.sampleTime).append(" CummulativeCpuTime " + this.cumulativeCpuTime).append(" LastSampleTime " + this.lastSampleTime).append(" LastCummulativeCpuTime " + this.lastCumulativeCpuTime).append(" CpuUsage " + this.cpuUsage).append(" JiffyLengthMillisec " + this.jiffyLengthInMillis);
        return sb.toString();
    }
}
