...
public class NfsExports {
    ...
    private static final Pattern HOSTNAME_FORMAT = Pattern.compile("^(" + LABEL_FORMAT + "\\.)*" + LABEL_FORMAT + "$");
    ...
    NfsExports(int cacheSize, long expirationPeriodNano, String matchHosts) {
        ...
        String[] matchStrings = matchHosts.split(CommonConfigurationKeys.NFS_EXPORTS_ALLOWED_HOSTS_SEPARATOR);
