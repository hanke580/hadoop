...
public interface RegistryInternalConstants {
     ...
     */
    String VALID_PATH_ENTRY_PATTERN = "([a-z0-9]|[a-z0-9][a-z0-9\\-]*[a-z0-9])";
     ...
     */
    int PERMISSIONS_REGISTRY_USER_ROOT = ZooDefs.Perms.READ | ZooDefs.Perms.WRITE | ZooDefs.Perms.CREATE | ZooDefs.Perms.DELETE;
     ...
     */
    String SASLAUTHENTICATION_PROVIDER = "org.apache.zookeeper.server.auth.SASLAuthenticationProvider";
