...
public class ApplicationServiceRecordProcessor extends BaseServiceRecordProcessor {
     ...
     */
    class TXTApplicationRecordDescriptor extends ApplicationRecordDescriptor<List<String>> {
     ...
     */
    class SRVApplicationRecordDescriptor extends ApplicationRecordDescriptor<RecordCreatorFactory.HostPortInfo> {
        ...
        protected void init(ServiceRecord serviceRecord) throws Exception {
            if (getEndpoint() != null) {
                this.setNames(new Name[] { getServiceName(), getEndpointName() });
                this.setTarget(new RecordCreatorFactory.HostPortInfo(Name.fromString(getHost(getEndpoint()) + "."), getPort(getEndpoint())));
            }
        }
    }
     ...
     */
    class CNAMEApplicationRecordDescriptor extends ApplicationRecordDescriptor<Name> {
     ...
     */
    class AApplicationRecordDescriptor extends ApplicationRecordDescriptor<InetAddress> {
        ...
        protected void init(ServiceRecord serviceRecord) throws Exception {
            ...
            this.setTarget(InetAddress.getByName(getHost(endpoints.get(0))));
        }
    }
