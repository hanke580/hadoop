...
public class RegistryAdminService extends RegistryOperationsService {
     ...
     */
    public static final int USER_HOMEDIR_ACL_PERMISSIONS = ZooDefs.Perms.READ | ZooDefs.Perms.WRITE | ZooDefs.Perms.CREATE | ZooDefs.Perms.DELETE;
    ...
    public interface NodeSelector {
        ...
        boolean shouldSelect(String path, RegistryPathStatus registryPathStatus, ServiceRecord serviceRecord);
    }
    ...
    public class AsyncPurge implements Callable<Integer> {
        ...
        public Integer call() throws Exception {
            ...
            return purge(path, selector, purgePolicy, callback);
        }

        @Override
        public String toString() {
            return String.format("Record purge under %s with selector %s", path, selector);
        }
    }
}
