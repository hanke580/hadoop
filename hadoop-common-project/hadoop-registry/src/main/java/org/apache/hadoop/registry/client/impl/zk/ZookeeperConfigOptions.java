...
public interface ZookeeperConfigOptions {
     ...
     */
    String PROP_ZK_ENABLE_SASL_CLIENT = "zookeeper.sasl.client";
     ...
     */
    String PROP_ZK_SASL_CLIENT_CONTEXT = ZKClientConfig.LOGIN_CONTEXT_NAME_KEY;
     ...
     */
    String PROP_ZK_SERVER_SASL_CONTEXT = ZooKeeperSaslServer.LOGIN_CONTEXT_NAME_KEY;

    /**
     * Should ZK Server allow failed SASL clients to downgrade to classic
     * authentication on a SASL auth failure: {@value}.
     */
    String PROP_ZK_SERVER_MAINTAIN_CONNECTION_DESPITE_SASL_FAILURE = "zookeeper.maintain_connection_despite_sasl_failure";

    /**
     * should the ZK Server Allow failed SASL clients: {@value}.
     */
    String PROP_ZK_ALLOW_FAILED_SASL_CLIENTS = "zookeeper.allowSaslFailedClients";
