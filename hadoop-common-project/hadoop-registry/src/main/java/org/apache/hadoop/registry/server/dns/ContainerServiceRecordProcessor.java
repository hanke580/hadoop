...
public class ContainerServiceRecordProcessor extends BaseServiceRecordProcessor {
     ...
     */
    class TXTContainerRecordDescriptor extends ContainerRecordDescriptor<List<String>> {
     ...
     */
    class AContainerRecordDescriptor extends ContainerRecordDescriptor<InetAddress> {
        ...
        protected void init(ServiceRecord serviceRecord) {
            ...
            try {
                ...
                this.setNames(new Name[] { getContainerName(), getContainerIDName(), getComponentName() });
            } catch (Exception e) {
