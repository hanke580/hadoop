...
public class KerberosAuthenticator implements Authenticator {
  ...
  */
    private static class KerberosConfiguration extends Configuration {
        ...
        private static final AppConfigurationEntry OS_SPECIFIC_LOGIN = new AppConfigurationEntry(OS_LOGIN_MODULE_NAME, AppConfigurationEntry.LoginModuleControlFlag.REQUIRED, new HashMap<String, String>());
        ...
        private static final AppConfigurationEntry USER_KERBEROS_LOGIN = new AppConfigurationEntry(KerberosUtil.getKrb5LoginModuleName(), AppConfigurationEntry.LoginModuleControlFlag.OPTIONAL, USER_KERBEROS_OPTIONS);
  ...
  */
    private void sendToken(HttpURLConnection conn, byte[] outToken) throws IOException {
  ...
  */
    private byte[] readToken(HttpURLConnection conn) throws IOException, AuthenticationException {
